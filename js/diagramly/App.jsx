...
/**
 */
var App = (window.App = function (editor, container, lightbox) {
  EditorUi.call(this, editor, container, lightbox != null ? lightbox : urlParams["lightbox"] == "1" || (uiTheme == "min" && urlParams["chrome"] != "0"));
  ...
  window.geOpenWindow = mxUtils.bind(this, function (url, pre, fallback) {
    if (urlParams["openInSameWin"] == "1" || navigator.standalone) {
      ...
      if (wnd == null || wnd === undefined) {
        this.showDialog(new PopupDialog(this, url, pre, fallback).container, 340, 140, true, true);
      } else if (pre != null) {
        pre();
      }
    }
    ...
    if (window.mxscript != null) {
      ...
      if (urlParams["embed"] != "1") {
        if (typeof window.DriveClient === "function") {
          if (urlParams["gapi"] != "0" && isSvgBrowser && (document.documentMode == null || document.documentMode >= 10)) {
            ...
            else if (urlParams["chrome"] == "0" && (window.location.hash == null || window.location.hash.substring(0, 45) !== "#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D")) {
        ...
        if (typeof window.DropboxClient === "function") {
          if (urlParams["db"] != "0" && isSvgBrowser && (document.documentMode == null || document.documentMode > 9)) {
            // Immediately loads client
            if (App.mode == App.MODE_DROPBOX || (window.location.hash != null && window.location.hash.substring(0, 2) == "#D")) {
        ...
        if (typeof window.OneDriveClient === "function") {
          if (urlParams["od"] != "0" && (navigator.userAgent == null || navigator.userAgent.indexOf("MSIE") < 0 || document.documentMode >= 10)) {
            // Immediately loads client
            if (App.mode == App.MODE_ONEDRIVE || (window.location.hash != null && window.location.hash.substring(0, 2) == "#W")) {
        ...
        if (typeof window.TrelloClient === "function") {
          if (urlParams["tr"] == "1" && isSvgBrowser && !mxClient.IS_IE11 && (document.documentMode == null || document.documentMode >= 10)) {
            // Immediately loads client
            if (App.mode == App.MODE_TRELLO || (window.location.hash != null && window.location.hash.substring(0, 2) == "#T")) {
...
App.main = function (callback, createUi) {
  try {
    ...
    window.onerror = function (message, url, linenumber, colno, err) {
      EditorUi.logError("Global: " + (message != null ? message : ""), url, linenumber, colno, err, null, true);
    ...
    if (
      ...
      ("import.diagrams.net" === window.location.hostname || "ac.draw.io" === window.location.hostname || "aj.draw.io" === window.location.hostname)
    ) {
    ...
    if (document.referrer != null && urlParams["libs"] == "aws3" && document.referrer.substring(0, 42) == "https://aws.amazon.com/architecture/icons/") {
      urlParams["libs"] = "aws4";
    }
    ...
    if (window.mxscript != null) {
      try {
        ...
        if (
          ...
          (urlParams["offline"] == "0" ||
            ...
            (urlParams["offline"] != "1" && urlParams["enableSW"] != "1" && urlParams["dev"] == "1"))
        ) {
          ...
          navigator.serviceWorker.getRegistration().then(function (reg) {
            ...
            else if (!Editor.isSettingsEnabled() || (mxSettings.settings != null && !mxSettings.settings.isNew) || urlParams["enableSW"] == "1") {
      ...
      if (
        ...
        (urlParams["embed"] != "1" || (urlParams["embedRT"] == "1" && urlParams["lockdown"] != "1")) &&
        urlParams["local"] != "1" &&
    ...
    function doLoad(bundle) {
      ...
      mxUtils.getAll(
        ...
        function (xhr) {
          ...
          // Configuration mode
          if (isLocalStorage && localStorage != null && window.location.hash != null && window.location.hash.substring(0, 9) == "#_CONFIG_") {
            try {
              ...
              if (value != null) {
                ...
                if (confirm(mxResources.get("configLinkWarn")) && confirm(mxResources.get("configLinkConfirm"))) {
          ...
          function realMain() {
            try {
              ...
              if (Editor.currentTheme != "kennedy" && mxUtils.indexOf(Editor.themes, Editor.currentTheme) < 0) {
              ...
              if (window.mxscript != null) {
                ...
                if (
                  ...
                  (navigator.userAgent == null || navigator.userAgent.indexOf("MSIE") < 0 || document.documentMode >= 10)
                ) {
                  //Editor.oneDriveInlinePicker can be set with configuration which is done later, so load it all time
          ...
          if (urlParams["dev"] == "1" || EditorUi.isElectronApp) //TODO check if we can remove these scripts loading from index.html
          {
            ...
            App.loadScripts(["js/shapes-14-6-5.min.js", "js/stencils.min.js", "js/extensions.min.js"], realMain, function (e) {
              document.body.innerHTML = "";
        ...
        function (xhr) {
          ...
          if (st != null) {
            ...
            st.getElementsByTagName("a")[0].onclick = function () {
              mxLanguage = "en";
              doLoad(mxResources.getDefaultBundle(RESOURCE_BASE, mxLanguage) || mxResources.getSpecialBundle(RESOURCE_BASE, mxLanguage));
            };
          }
        },
      );
          ...
          try {
            ...
            if (data != null && data.action == "configure") {
              ...
              if (data.config.darkColor != null) {
                document.body.style.setProperty("--dark-color", data.config.darkColor);
              }
...
App.prototype.init = function () {
  ...
  try {
    this.gitHub =
      (!mxClient.IS_IE || document.documentMode == 10 || mxClient.IS_IE11 || mxClient.IS_EDGE) && urlParams["gh"] != "0" && (urlParams["embed"] != "1" || urlParams["gh"] == "1")
  ...
  try {
    this.gitLab =
      (!mxClient.IS_IE || document.documentMode == 10 || mxClient.IS_IE11 || mxClient.IS_EDGE) && urlParams["gl"] != "0" && (urlParams["embed"] != "1" || urlParams["gl"] == "1")
  ...
  if (urlParams["embed"] != "1") {
    ...
    if ("serviceWorker" in navigator && !this.editor.isChromelessView() && (mxClient.IS_ANDROID || mxClient.IS_IOS)) {
  ...
  if (this.menubar != null) {
    if (Editor.currentTheme != "sketch" && (Editor.currentTheme != "simple" || urlParams["embed"] != "1")) {
    ...
    if ((Editor.currentTheme == "kennedy" && urlParams["embed"] == "1") || (Editor.currentTheme == "atlas" && urlParams["embed"] != "1")) {
      this.setCompactMode(true);
    }
...
App.blockedAncestorFrames = function () {
  try {
    if (window.location.ancestorOrigins && window.location.hostname && window.location.ancestorOrigins.length && window.location.ancestorOrigins.length > 0) {
  ...
  if (file != null && file.isModified() && file.isAutosave() && file.isOverdue()) {
    var evt = {
      ...
      action:
        ...
        (file.savingFile && file.savingFileTime != null ? "_" + Math.round((Date.now() - file.savingFileTime.getTime()) / 1000) : "") +
        ...
        "-save_" +
        (file.lastSaved != null ? Math.round((Date.now() - file.lastSaved.getTime()) / 1000) : "x") +
        "-change_" +
        (file.lastChanged != null ? Math.round((Date.now() - file.lastChanged.getTime()) / 1000) : "x") +
        "-alive_" +
...
App.prototype.searchHelp = function (prompt) {
  var link = "https://www.drawio.com/search?src=" + (EditorUi.isElectronApp ? "DESKTOP" : encodeURIComponent(location.host)) + "&search=" + encodeURIComponent(prompt);
  this.openLink(link);
...
App.prototype.showRatingBanner = function () {
  if (!this.bannerShowing && !this["hideBanner" + "ratingFooter"] && (!isLocalStorage || mxSettings.settings == null || mxSettings.settings["close" + "ratingFooter"] == null)) {
...
App.prototype.checkLicense = function () {
  ...
  if (!this.isOffline() && !this.editor.chromeless && email != null && driveUser.id != null) {
    ...
    if (domain.toLowerCase() !== "gmail.com") {
      ...
      mxUtils.post(
        "/license",
        "domain=" + encodeURIComponent(domain) + "&id=" + encodeURIComponent(userId) + "&ts=" + new Date().getTime(),
        mxUtils.bind(this, function (req) {
          try {
...
App.prototype.updateDocumentTitle = function () {
  ...
  if (file != null && (this.editor.graph.isLightboxView() || Editor.currentTheme == "simple") && this.pages != null && this.currentPage != null) {
  ...
  try {
    ...
    if (mxClient.IS_CHROMEAPP || Editor.useCanvasForExport) {
      ...
      if (bgImg != null) {
        ...
        bounds.add(new mxRectangle((t.x + bgImg.x) * s, (t.y + bgImg.y) * s, bgImg.width * s, bgImg.height * s));
      }
      ...
      if (bgImg != null) {
        ...
        ctx.drawImage(img, bgImg.x * scale, bgImg.y * scale, bgImg.width * scale, bgImg.height * scale);
      }
...
App.prototype.open = function () {
  ...
  try {
    ...
    if (window.opener != null) {
      ...
      if (value != null && value.length > 0 && value.substring(0, 7) != "http://" && value.substring(0, 8) != "https://") {
        ...
        window.opener.openFile.setConsumer(
          mxUtils.bind(this, function (xml, filename, temp) {
            ...
            this.fileLoaded(mxClient.IS_IOS ? new StorageFile(this, xml, filename) : new LocalFile(this, xml, filename, temp));
          }),
        );
      }
    }
    ...
    if (urlParams["embed"] != "1") {
      try {
        if (this.spinner.spin(document.body, mxResources.get("starting"))) {
          ...
          if ((window.location.hash == null || window.location.hash.length == 0) && this.drive != null && this.stateArg != null && this.stateArg.userId != null) {
  ...
  try {
    ...
    window.onerror = function (message, url, linenumber, colno, err) {
      ...
      if (message != "ResizeObserver loop limit exceeded") {
        EditorUi.logError("Uncaught: " + (message != null ? message : ""), url, linenumber, colno, err, null, true);
        ...
        mxUtils.bind(this, function (evt) {
          try {
            ...
            if (id != lastId) {
              ...
              if (obj != null && obj.pageId != null && this.currentPage != null && obj.pageId != this.currentPage.getId()) {
    ...
    // Redirects old url URL parameter to new #U format
      ...
      var done = mxUtils.bind(this, function () {
        ...
        if (urlParams["client"] == "1" && (window.location.hash == null || window.location.hash.length == 0 || window.location.hash.substring(0, 2) == "#P")) {
        ...
        // Checks if no earlier loading errors are showing
          ...
          if (urlParams["demo"] == "1") {
            ...
            if (waiting) {
              ...
              if (EditorUi.enableDrafts && urlParams["mode"] == null && this.getServiceName() == "draw.io" && (id == null || id.length == 0) && !this.editor.isChromelessView()) {
                this.checkDrafts();
      ...
      if (urlParams["smart-template"] != null && (window.location.hash == null || window.location.hash.length <= 1)) {
        value = JSON.stringify({
          type: "generate",
          data: decodeURIComponent(urlParams["smart-template"]),
        });
      }

      if (
        (window.location.hash == null || window.location.hash.length <= 1 || window.location.hash.substring(0, 8) == "#create=") &&
        value.length > 0 &&
        this.spinner.spin(document.body, mxResources.get("loading"))
      ) {
            ...
            var dlg = new CreateDialog(
              ...
              mxUtils.bind(this, function (filename, mode) {
                if (mode == null) {
                  this.hideDialog();
                  var prev = Editor.useLocalStorage;
                  this.createFile(filename.length > 0 ? filename : this.defaultFilename, this.getFileData(), null, null, null, true, null, true);
                  Editor.useLocalStorage = prev;
                } else {
                  this.pickFolder(
                    mode,
                    mxUtils.bind(this, function (folderId) {
                      this.createFile(filename, this.getFileData(true), null, mode, null, true, folderId);
                    }),
                  );
                }
              }),
        ...
        if (value.substring(0, 7) != "http://" && value.substring(0, 8) != "https://") {
          if (value.charAt(0) == "{") {
            ...
            var createDiagram = mxUtils.bind(this, function (xml) {
              this.spinner.stop();
              this.createFile(
                value.filename != null ? value.filename : this.defaultFilename,
                xml,
                null,
                null,
                mxUtils.bind(this, function () {
                  ...
                  window.history.replaceState(null, null, window.location.pathname + this.getSearch(["create"]));
            ...
            if (value.type == "mermaid" && this.spinner.spin(document.body, mxResources.get("loading"))) {
              if (window.isMermaidEnabled) {
                this.parseMermaidDiagram(
                  data,
                  null,
            ...
            } else if (value.type == "generate" && this.spinner.spin(document.body, mxResources.get("generate") + " '" + data + "'")) {
              this.generateOpenAiMermaidDiagram(
                data,
                function (xml) {
                  createDiagram(xml);
                },
              ...
              this.importCsv(
                ...
                mxUtils.bind(this, function () {
                  ...
                  createDiagram(mxUtils.getXml(codec.encode(graph.getModel())));
                }),
                graph,
              );
            } else {
        ...
        if ((window.location.hash == null || window.location.hash.length <= 1) && urlParams["state"] != null && this.stateArg != null && this.stateArg.action == "open") {
          if (this.stateArg.ids != null) {
            if (window.history && window.history.replaceState) {
              // Removes state URL parameter without reloading the page
              window.history.replaceState(null, null, window.location.pathname + this.getSearch(["state", "splash"]));
            }

            window.location.hash = "G" + this.stateArg.ids[0];
          }
        } else if ((window.location.hash == null || window.location.hash.length <= 1) && this.drive != null && this.stateArg != null && this.stateArg.action == "create") {
          if (window.history && window.history.replaceState) {
            // Removes state URL parameter without reloading the page
            window.history.replaceState(null, null, window.location.pathname + this.getSearch(["state"]));
          }

          this.setMode(App.MODE_GOOGLE);

          if (urlParams["splash"] == "0") {
            this.createFile(urlParams["title"] != null ? decodeURIComponent(urlParams["title"]) : this.defaultFilename);
          } else {
          ...
          if (urlParams["open"] != null && window.history && window.history.replaceState) {
            window.history.replaceState(null, null, window.location.pathname + this.getSearch(["open", "sketch"]));
    ...
    var dlg = new NewDialog(
      ...
      mxUtils.bind(this, function (xml) {
        ...
        if (xml != null) {
          ...
          graph.setSelectionCells(this.importXml(xml, Math.max(insertPoint.x, 20), Math.max(insertPoint.y, 20), true, null, null, true));
          ...
          try {
            ...
            if (key != null && key.substring(0, 7) == ".draft_") {
              ...
              if (
                ...
                obj.type == "draft" &&
                obj.aliveCheck != guid &&
                ((filePath == null && obj.fileObject == null) || (obj.fileObject != null && obj.fileObject.path == filePath))
              ) {
                obj.key = key;
                drafts.push(obj);
              }
          ...
          mxUtils.bind(this, function (drafts) {
            if (drafts.length == 1) {
              ...
              var dlg = new DraftDialog(
                this,
                drafts.length > 1 ? mxResources.get("selectDraft") : mxResources.get("draftFound", [ts.toLocaleDateString() + " " + ts.toLocaleTimeString()]),
...
App.prototype.showSplash = function (force) {
    ...
    this.showDialog(
      ...
      mxUtils.bind(this, function (cancel, isEsc) {
        ...
        if ((cancel || isEsc) && !mxClient.IS_CHROMEAPP) {
          var prev = Editor.useLocalStorage;
          this.createFile(this.defaultFilename + (EditorUi.isElectronApp ? ".drawio" : ""), null, null, null, null, null, null, urlParams["local"] != "1");
          Editor.useLocalStorage = prev;
        }
      }),
      true,
  ...
  if (this.editor.isChromelessView()) {
  ...
  } else if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && (this.mode == null || force)) {
    ...
    this.showDialog(dlg.container, rowLimit < 3 ? 200 : 300, serviceCount > 3 ? 320 : 210, true, false);
      ...
      mxUtils.bind(this, function (file) {
        ...
        reader.onload = mxUtils.bind(this, function (e) {
          ...
          if (fileHandle.queryPermission) {
            fileHandle.queryPermission({ mode: "readwrite" }).then(
              mxUtils.bind(this, function (permission) {
                doSuccess(permission !== "denied");
              }),
            );
          } else {
            fileHandle.createWritable().then(
              mxUtils.bind(this, function () {
                doSuccess(true);
              }),
              mxUtils.bind(this, function (e) {
        ...
        if ((file.type.substring(0, 5) === "image" || file.type === "application/pdf") && file.type.substring(0, 9) !== "image/svg") {
...
App.prototype.createFileSystemOptions = function (name) {
  ...
  for (var i = 0; i < this.editor.diagramFileTypes.length; i++) {
    var obj = {
      description: mxResources.get(this.editor.diagramFileTypes[i].description) + (mxClient.IS_MAC ? " (." + this.editor.diagramFileTypes[i].extension + ")" : ""),
      accept: {},
    };
      ...
      if (peer != null) {
        ...
        window.showOpenFilePicker().then(
          mxUtils.bind(this, function (fileHandles) {
            if (fileHandles != null && fileHandles.length > 0 && this.spinner.spin(document.body, mxResources.get("loading"))) {
        ...
        window.openFile.setConsumer(
          mxUtils.bind(this, function (xml, filename) {
            var doOpenFile = mxUtils.bind(this, function () {
              ...
              this.fileLoaded(mode == App.MODE_BROWSER ? new StorageFile(this, xml, filename) : new LocalFile(this, xml, filename));
            });
            ...
            if (currentFile == null || !currentFile.isModified()) {
              ...
              this.confirm(mxResources.get("allChangesLost"), null, doOpenFile, mxResources.get("cancel"), mxResources.get("discardChanges"));
            }
          }),
        );
...
App.prototype.pickLibrary = function (mode) {
  ...
  if (mode == App.MODE_GOOGLE || mode == App.MODE_DROPBOX || mode == App.MODE_ONEDRIVE || mode == App.MODE_GITHUB || mode == App.MODE_GITLAB || mode == App.MODE_TRELLO) {
    ...
    window.openFile.setConsumer(
      mxUtils.bind(this, function (xml, filename) {
        doLoadLibary(mode == App.MODE_BROWSER ? new StorageLibrary(this, xml, filename) : new LocalLibrary(this, xml, filename));
      }),
    );

    // Removes openFile if dialog is closed
    this.showDialog(new OpenDialog(this).container, Editor.useLocalStorage ? 640 : 360, Editor.useLocalStorage ? 480 : 220, true, true, function () {
      Editor.useLocalStorage = prevValue;
        ...
        mxUtils.bind(this, function (folderId) {
          if (mode == App.MODE_GOOGLE && this.drive != null && this.spinner.spin(document.body, mxResources.get("inserting"))) {
            ...
            StorageFile.doInsertFile(
              new StorageLibrary(this, xml, name),
              mxUtils.bind(this, function (file) {
                this.hideDialog(true);
          ...
          if (/(\.pdf)$/i.test(name)) {
            ...
            if (prev == null && mode == App.MODE_DEVICE) {
              ...
              var createFile = mxUtils.bind(this, function (folderId) {
                ...
                var currentFile = this.getCurrentFile();
                var replace = this.mode == null || currentFile == null || currentFile.mode == null;

                this.createFile(
                  name,
                  this.getFileData(/(\.xml)$/i.test(name) || name.indexOf(".") < 0 || /(\.drawio)$/i.test(name), /(\.svg)$/i.test(name), /(\.html)$/i.test(name)),
                  null,
                  mode,
                  done,
                  replace,
...
App.prototype.loadTemplate = function (url, onload, onerror, templateFilename, asLibrary) {
  ...
  if (!this.editor.isCorsEnabledForUrl(realUrl)) {
    ...
    realUrl = PROXY_URL + "?url=" + encodeURIComponent(url) + "&" + nocache + (base64 ? "&base64=1" : "");
  }
  ...
  this.editor.loadUrl(
    ...
    mxUtils.bind(this, function (responseData) {
      try {
        var data = !base64 ? responseData : window.atob && !mxClient.IS_IE && !mxClient.IS_IE11 ? atob(responseData) : Base64.decode(responseData);
          ...
          if (this.isExternalDataComms()) {
            ...
            this.parseFileData(
              ...
              mxUtils.bind(this, function (xhr) {
                if (xhr.readyState == 4 && xhr.status >= 200 && xhr.status <= 299 && xhr.responseText.substring(0, 13) == "<mxGraphModel") {
...
App.prototype.isModeEnabled = function (mode) {
  if (mode == App.MODE_GOOGLE) {
    ...
    return typeof window.TrelloClient === "function" && urlParams["tr"] == "1" && mxClient.IS_SVG && (document.documentMode == null || document.documentMode > 9);
  } else {
    return false;
  }
};
...
App.prototype.isModeReady = function (mode) {
  return this.getServiceForName(mode) != null && (mode != App.MODE_DROPBOX || typeof Dropbox.choose !== "undefined");
};
...
App.prototype.createFile = function (title, data, libs, mode, done, replace, folderId, tempFile, clibs, success) {
  EditorUi.debug("App.createFile", [this], "title", [title], "data", [data], "libs", [libs], "mode", [mode]);
...
App.prototype.fileCreated = function (file, libs, replace, done, clibs, success) {
  EditorUi.debug("App.fileCreated", [this], "file", [file], "libs", [libs], "replace", [replace]);
  ...
  if (this.spinner.spin(document.body, mxResources.get("inserting"))) {
    ...
    var dataNode = data.length > 0 ? this.editor.extractGraphModel(mxUtils.parseXml(data).documentElement, true) : null;
    ...
    var fn = mxUtils.bind(this, function () {
      ...
      if (replace == null && currentFile != null) {
        replace = !currentFile.isModified() && (currentFile.getMode() == null || EditorUi.isElectronApp);
      }
      ...
      var fn2 = mxUtils.bind(this, function () {
        if (replace || currentFile == null || !currentFile.isModified()) {
          ...
          this.confirm(mxResources.get("allChangesLost"), null, fn3, mxResources.get("cancel"), mxResources.get("discardChanges"));
        }
      });
...
App.prototype.loadFile = function (id, sameWindow, file, success, force) {
  ...
  var fn2 = mxUtils.bind(this, function () {
    if (id == null || id.length == 0) {
      ...
      if (id.charAt(0) == "L") {
        ...
        this.alert(
          "[Deprecation] #S is no longer supported, go to https://app.diagrams.net/?desc=" + id.substring(1).substring(0, 10),
          mxUtils.bind(this, function () {
        ...
        var tempFile = new LocalFile(this, data, urlParams["title"] != null ? decodeURIComponent(urlParams["title"]) : this.defaultFilename, true);
      ...
      } else if (id.charAt(0) == "E") // Embed file
      {
        ...
        var doFallback = mxUtils.bind(this, function () {
          ...
          if (url.substring(0, 31) == "https://drive.google.com/uc?id=" && (this.drive != null || typeof window.DriveClient === "function")) {
            this.hideDialog();
        ...
        this.loadTemplate(
            ...
            if (text != null && text.length > 0) {
              ...
              if (urlParams["title"] == null && urlParams["notitle"] != "1") {
                ...
                if (dot > slash && slash > 0) {
                  ...
                  if (ext === ".svg" || ext === ".xml" || ext === ".html" || ext === ".png" || ext === ".drawio") {
                    filename = tmp + ext;
                  }
                }
              }

              var tempFile = new LocalFile(this, text, urlParams["title"] != null ? decodeURIComponent(urlParams["title"]) : filename, true);
              tempFile.getHash = function () {
                return id;
              };
          ...
          urlParams["template-filename"] != null ? decodeURIComponent(urlParams["template-filename"]) : null,
        );
      } else {
          ...
          if (peer == null) {
            ...
            peer.getFile(
                ...
                if (currentFile == null) {
                  ...
                  this.updateStatus(
                    mxUtils.bind(this, function () {
                      ...
                      this.editor.setStatus('<div title="' + status + '" class="geStatusAlert">' + status + "</div>");
                    }),
                  );
                }
              ...
              mxUtils.bind(this, function (resp) {
                ...
                if (resp == null || resp.name != "AbortError") {
                  this.handleError(resp, resp != null ? mxResources.get("errorLoadingFile") : null, fn, null, null, "#" + peerChar + id);
                } else {
                  fn();
                }
              }),
  ...
  if (id == null || id.length == 0 || (sameWindow == null && currentFile != null && !currentFile.isModified() && this.isBlankFile())) {
    fn();
  } else if (currentFile != null && !sameWindow) {
    this.showDialog(new PopupDialog(this, this.getUrl() + "#" + id, null, fn).container, 340, 140, true, true);
  } else {
    fn();
  }
};
    ...
    if (libs != null) {
      for (var i = 0; i < libs.length; i++) {
        ...
        mxUtils.bind(this, function (id, index) {
          if (id != null && id.length > 0 && this.loadedLibraries[id] == null && this.sidebar.palettes[id] == null) {
...
App.prototype.updateButtonContainer = function () {
  if (this.buttonContainer != null) {
    ...
    if (!EditorUi.isElectronApp && !this.isOffline()) {
      ...
      } else if (urlParams["extAuth"] != "1" && Editor.currentTheme != "atlas") //Disable notification with external auth (e.g, Teams app)
      {
        this.fetchAndShowNotification("online", this.mode);
      }
    }

    if (this.isStandaloneApp() || (Editor.currentTheme == "simple" && urlParams["embed"] != "1")) {
      this.buttonContainer.style.display = "none";

      if (this.notificationBtn != null && this.notificationBtn.parentNode != this.sketchMenubarElt) {
      ...
      if (this.notificationBtn != null && this.notificationBtn.parentNode != this.buttonContainer) {
      ...
      this.shareButton.style.display = file != null && Editor.currentTheme == "kennedy" && urlParams["embed"] != "1" ? "" : "none";
      ...
      if (Editor.currentTheme != "simple") {
        ...
        if (!this.unloading) {
          ...
          this.userButton.style.display = this.getServiceName() == "draw.io" && user != null && urlParams["embed"] != "1" && !this.isStandaloneApp() && file != null ? "" : "none";
        }
      }
    }
  }
...
App.prototype.fetchAndShowNotification = function (target, subtarget) {
  ...
  var processNotif = mxUtils.bind(this, function (notifs) {
    notifs = notifs.filter(function (notif) {
      return !notif.targets || notif.targets.indexOf(target) > -1 || (subtarget != null && notif.targets.indexOf(subtarget) > -1);
    });
...
App.prototype.save = function (name, done) {
  ...
  if (file != null && this.spinner.spin(document.body, mxResources.get("saving"), error, 3 * this.timeout)) {
    try {
      this.clearStatus();
...
App.prototype.pickFolder = function (mode, fn, enabled, direct, force, returnPickerValue) {
  ...
  this.spinner = this.spinner != null ? this.spinner : this.createSpinner(null, null, 24);
...
App.prototype.exportFile = function (data, filename, mimeType, base64Encoded, mode, folderId) {
  if (mode == App.MODE_DROPBOX) {
    ...
    if (window.StorageFile != null && !base64Encoded && this.spinner.spin(document.body, mxResources.get("saving"))) {
      var file = data.substring(0, 10) == "<mxlibrary" ? new StorageLibrary(this, data, filename) : new StorageFile(this, data, filename);
...
App.prototype.descriptorChanged = function () {
  ...
  if (this.format != null && (file == null || this.fileEditable != file.isEditable()) && this.editor.graph.isSelectionEmpty()) {
    this.format.refresh();
...
App.prototype.convertFile = function (url, filename, mimeType, extension, success, error, executeRequest, headers) {
  ...
  if (/\.v(dx|sdx?)$/i.test(filename) && Graph.fileSupport && new XMLHttpRequest().upload && typeof new XMLHttpRequest().responseType === "string") {
    ...
    var binary = /\.png$/i.test(filename) || /\.jpe?g$/i.test(filename) || /\.pdf$/i.test(filename) || (mimeType != null && mimeType.substring(0, 6) == "image/");
...
App.prototype.updateHeader = function () {
  if (this.menubar != null) {
    ...
    // Format panel toggle
    var toggleFormatElement;

    render(() => {
      const [fullscreenActive, setFullscreenActive] = createSignal(that.fullscreenMode);
      const [formatActive, setFormatActive] = createSignal(that.formatWidth > 0);

      const onClickFullscreen = (evt) => {
        var value = fullscreenActive();
        if (Editor.currentTheme != "atlas" && urlParams["embed"] != "1") {
          that.setCompactMode(!value, null, Editor.transitionDelay);
        }

        that.toggleShapesPanel(value);
        that.toggleFormatPanel(value);
        setFullscreenActive(!value);
        that.fullscreenMode = !value;
        mxEvent.consume(evt);
      };
      const onClickFormat = (evt) => {
        that.actions.get("format").funct();
        mxEvent.consume(evt);
      };
      ...
      const onFormatWidthChanged = () => {
        setFormatActive(that.formatWidth > 0);
      };
      that.addListener("formatWidthChanged", onFormatWidthChanged);

      onCleanup(() => {
        that.removeListener(onFormatWidthChanged);
      });
      ...
      return (
        <>
          <a
            ...
            class="geButton"
            style={{ "background-image": "url('" + (fullscreenActive() ? Editor.fullscreenExitImage : Editor.fullscreenImage) + "')" }}
            on:click={onClickFullscreen}
            on:pointerdown={onPreventDefault}
            on:mousedown={onPreventDefault}
          ></a>
          <a
            ref={(el) => {
              toggleFormatElement = el;
            }}
            class="geButton"
            style={{ "background-image": "url('" + (formatActive() ? Editor.rightPanelCloseImage : Editor.rightPanelOpenImage) + "')" }}
            on:click={onClickFormat}
            on:pointerdown={onPreventDefault}
            on:mousedown={onPreventDefault}
          ></a>
        </>
    ...
    toggleElement.style.backgroundImage = "url('" + (this.compactMode ? Editor.chevronDownImage : Editor.chevronUpImage) + "')";
...
App.prototype.setCompactMode = function (active, remember, delay) {
  var node = mxUtils.isAncestorNode(document.body, this.container) || this.editor == null ? this.container : this.editor.graph.container;
  ...
  if (this.userPanel.parentNode != null) {
    ...
    if (this.drive != null) {
      ...
      if (driveUsers.length > 0) {
        ...
        var createUserRow = mxUtils.bind(this, function (user) {
          ...
          img.setAttribute("border", "0");
          img.setAttribute("src", user.pictureUrl != null ? user.pictureUrl : Editor.userImage);
          ...
          mxUtils.write(td, user.displayName + (user.isCurrent && driveUsers.length > 1 ? " (" + mxResources.get("default") + ")" : ""));
        ...
        mxUtils.bind(this, function () {
          ...
          if (file != null && file.constructor == DropboxFile) {
            ...
            if (!file.isModified()) {
              ...
              this.confirm(mxResources.get("allChangesLost"), null, doLogout, mxResources.get("cancel"), mxResources.get("discardChanges"));
            }
          } else {
            this.dropbox.logout();
          }
    ...
    if (uiTheme == "min") {
      ...
      if (file != null && file.isRealtimeEnabled() && file.isRealtimeSupported()) {
        ...
        if (state != 1) {
          mxUtils.write(div, mxResources.get("realtimeCollaboration") + ": " + (err != null && err.message != null ? err.message : mxResources.get("disconnected")));
          this.userPanel.appendChild(div);
        }
      }
    }
