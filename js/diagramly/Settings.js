...
window.mxSettings = {
  ...
  getGridColor: function (darkMode) {
    var result = darkMode ? mxSettings.settings.darkGridColor : mxSettings.settings.gridColor;
  ...
  parse: function (value) {
    ...
    if (config == null || config.configVersion != Editor.configVersion || (Editor.config != null && Editor.config.override)) {
