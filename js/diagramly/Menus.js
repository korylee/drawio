...
(function () {
  ...
  Menus.prototype.containsFont = function (name, url) {
    ...
    for (var i = 0; i < this.defaultFonts.length; i++) {
      ...
      if ((typeof value !== "string" && value.fontFamily == name && value.fontUrl == url) || (typeof value === "string" && value == name && url == null)) {
        return true;
      }
    }
  ...
  Menus.prototype.init = function () {
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (Editor.currentTheme == "min" || Editor.currentTheme == "simple" || Editor.currentTheme == "sketch") {
    ...
    var fullscreenAction = editorUi.actions.addAction("fullscreen", function () {
      if (urlParams["embedInline"] == "1") {
        ...
        var node = mxUtils.isAncestorNode(document.body, editorUi.container) ? editorUi.container : editorUi.editor.graph.container;
    ...
    fullscreenAction.visible = urlParams["embedInline"] == "1" || (window == window.top && document.fullscreenEnabled && document.body.requestFullscreen != null);
    fullscreenAction.setToggleAction(true);

    fullscreenAction.setSelectedCallback(function () {
      return urlParams["embedInline"] == "1" ? Editor.inlineFullscreen : document.fullscreenElement != null;
    });

    var lightModeAction = editorUi.actions.put(
      "lightMode",
      new Action("light", function (e) {
    ...
    var autoModeAction = editorUi.actions.put(
      "autoMode",
      new Action("automatic", function (e) {
    ...
    if (window.mxFreehand) {
      var freehandAction = editorUi.actions.put(
        "insertFreehand",
        new Action(
          "freehand",
          function () {
            if (graph.isEnabled()) {
              if (editorUi.freehandWindow == null) {
                editorUi.freehandWindow = new FreehandWindow(editorUi, document.body.offsetWidth - 420, 102, 180, 126, true);
              }
    ...
    editorUi.actions.put(
      ...
      new Action("formatXml" + "...", function () {
        ...
        var selection = editorUi.addCheckbox(div, mxResources.get("selectionOnly"), false, graph.isSelectionEmpty());
      ...
      editorUi.actions.put(
        ...
        new Action("url" + "...", function () {
          editorUi.showPublishLinkDialog(
            ...
            null,
            null,
            function (linkTarget, linkColor, currentPage, lightbox, editLink, layers, width, height, tags, link, transparent, darkMode, allPages) {
              var params = [];
              ...
              var dlg = new EmbedDialog(
                editorUi,
                editorUi.createLink(linkTarget, linkColor, allPages, lightbox, editLink, layers, null, true, params, null, currentPage, null, darkMode),
              );
    ...
    editorUi.actions.put(
      "exportHtml",
      new Action("formatHtmlEmbedded" + "...", function () {
        editorUi.getPublicUrl(editorUi.getCurrentFile(), function (url) {
          editorUi.showHtmlDialog(
            mxResources.get("export"),
            null,
            url,
            function (publicUrl, zoomEnabled, initialZoom, linkTarget, linkColor, fit, allPages, layers, tags, lightbox, editLink, theme) {
              editorUi.createHtml(
                publicUrl,
                zoomEnabled,
                initialZoom,
                ...
                mxUtils.bind(this, function (html, scriptTag) {
                  ...
                  var result =
                    ...
                    scriptTag +
                    "\n</body>\n</html>";
                  editorUi.saveData(basename + (basename.substring(basename.lenth - 7) == ".drawio" ? "" : ".drawio") + ".html", "html", result, "text/html");
                }),
                theme,
              );
            },
        ...
        editorUi.showPrintDialog(
          ...
          !EditorUi.isElectronApp && (editorUi.isOffline() || editorUi.printPdfExport)
            ...
            : mxUtils.bind(this, function (preview, args) {
                ...
                var pageRange =
                  !args.allPages && (args.pagesFrom != currentPage || args.pagesTo != currentPage)
                    ? { from: Math.max(0, Math.min(pageCount - 1, args.pagesFrom - 1)), to: Math.max(0, Math.min(pageCount - 1, args.pagesTo - 1)) }
                    : null;
                ...
                editorUi.downloadFile(
                  ...
                  null,
                  !args.selection,
                  noPages || (!args.allPages && args.pagesFrom == currentPage && args.pagesTo == currentPage),
                  !args.crop,
                  args.transparent,
                  args.scale,
                  null,
    ...
    editorUi.actions.addAction("close", function () {
      ...
      function fn() {
        ...
        editorUi.fileLoaded(new LocalFile(editorUi, editorUi.emptyDiagramXml, null, true));
      }

      if (currentFile != null && currentFile.isModified()) {
        editorUi.confirm(mxResources.get("allChangesLost"), null, fn, mxResources.get("cancel"), mxResources.get("discardChanges"));
      } else {
        fn();
      }
    });
      ...
      mxUtils.bind(this, function () {
        if (graph.getSelectionCount() == 1) {
          ...
          if (state != null && state.shape != null && state.shape.stencil != null) {
            ...
            editorUi.showDialog(dlg.container, 640, 480, true, false, null, null, null, new mxRectangle(0, 0, 300, 200));
            dlg.init();
          }
        }
      }),
    ...
    var action = editorUi.actions.addAction(
      ...
      null,
      null,
      Editor.altKey + "+" + Editor.shiftKey + "+S",
    );
    ...
    editorUi.actions.addAction(
      ...
      null,
      null,
      navigator.onLine && urlParams["stealth"] != "1" && urlParams["lockdown"] != "1",
    );
    ...
    var defaultAdaptiveColors = editorUi.actions.put(
      "defaultAdaptiveColors",
      new Action("defaultAdaptiveColors", function () {
        var change = new ChangePageSetup(editorUi);
        change.ignoreColor = true;
        change.ignoreImage = true;
    ...
    defaultAdaptiveColors.setSelectedCallback(function () {
      return graph.adaptiveColors == null;
    });

    var automaticAdaptiveColors = editorUi.actions.put(
      "automaticAdaptiveColors",
      new Action("automatic", function () {
        var change = new ChangePageSetup(editorUi);
        change.ignoreColor = true;
        change.ignoreImage = true;
    ...
    automaticAdaptiveColors.setSelectedCallback(function () {
      return graph.adaptiveColors == "auto";
    });

    var simpleAdaptiveColors = editorUi.actions.put(
      "simpleAdaptiveColors",
    ...
    simpleAdaptiveColors.setSelectedCallback(function () {
      return graph.adaptiveColors == "simple";
    });

    var noAdaptiveColors = editorUi.actions.put(
      "noAdaptiveColors",
      new Action("none", function () {
        var change = new ChangePageSetup(editorUi);
        change.ignoreColor = true;
        change.ignoreImage = true;
    ...
    noAdaptiveColors.setSelectedCallback(function () {
      return graph.adaptiveColors == "none";
    });
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          this.addMenuItems(menu, ["defaultAdaptiveColors", "-", "automaticAdaptiveColors", "simpleAdaptiveColors", "noAdaptiveColors"], parent);
        }),
      ),
    );
    ...
    editorUi.actions.addAction(
      ...
      null,
      null,
      Editor.ctrlKey + "+" + Editor.shiftKey + "+M",
    );
    ...
    editorUi.actions.addAction(
      ...
      function () {
        if (graph.isEnabled() && graph.getSelectionCount() == 1) {
          ...
          graph.copyCellStyles([cell], keys, values, editorUi.copiedStyle, editorUi.copiedStyle, null, null, null, true);
        }
      },
      null,
      null,
    ...
    editorUi.actions.addAction(
      ...
      function () {
        if (graph.isEnabled() && !graph.isSelectionEmpty() && editorUi.copiedStyle != null) {
          graph.pasteCellStyles(graph.includeDescendants(graph.getSelectionCells()), editorUi.copiedStyle, editorUi.copiedStyle, true);
        }
      },
      null,
      null,
    ...
    function exportImage(format, defaultEditable, done) {
      if (editorUi.editor.isExportToCanvas()) {
        editorUi.showExportDialog(
          ...
          mxUtils.bind(
            this,
            function (scale, transparentBackground, ignoreSelection, addShadow, editable, embedImages, border, cropImage, currentPage, dummy, grid, theme, exportType) {
              var val = parseInt(scale);
              ...
              if (!isNaN(val) && val > 0) {
                ...
                if (done != null) {
                  done(scale, transparentBackground, ignoreSelection, addShadow, editable, embedImages, border, cropImage, currentPage, dummy, grid, theme, exportType);
                }
              }
            },
          ),
        ...
        editorUi.showRemoteExportDialog(
          mxResources.get("export"),
          null,
          mxUtils.bind(this, function (ignoreSelection, editable, transparent, scale, border) {
            editorUi.downloadFile(editable && format == "png" ? "xmlpng" : format, null, null, ignoreSelection, null, null, transparent, scale, border);
          }),
          false,
          true,
        );
    ...
    editorUi.actions.put(
      "exportPng",
      new Action("formatPng" + "...", function () {
        exportImage("png", editorUi.lastExportPngEditable, function (scale, transparentBackground, ignoreSelection, addShadow, editable) {
    ...
    editorUi.actions.put(
      "exportWebp",
      new Action("formatWebp" + "...", function () {
        exportImage("webp");
      }),
    );
    ...
    action = editorUi.actions.addAction(
      ...
      null,
      null,
      Editor.ctrlKey + "+" + Editor.altKey + "+X",
    );
    ...
    action = editorUi.actions.addAction(
      ...
      null,
      null,
      Editor.ctrlKey + "+" + Editor.altKey + "+" + Editor.shiftKey + "+X",
    );
    ...
    editorUi.actions.put(
      ...
      new Action("v" + EditorUi.VERSION, function (arg1, evt) {
        if (mxEvent.isShiftDown(evt) && (EditorUi.isElectronApp || editorUi.isOwnGDriveDomain())) {
          if (urlParams["test"] == "1") {
    ...
    editorUi.actions.addAction("exportOptionsDisabled...", function () {
      editorUi.handleError({ message: mxResources.get("exportOptionsDisabledDetails") }, mxResources.get("exportOptionsDisabled"));
    });

    editorUi.actions.addAction("keyboardShortcuts...", function () {
      if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && !navigator.standalone) {
    ...
    if (
      ...
      var generateAction = editorUi.actions.put(
        "generate",
        new Action("generate", function () {
    ...
    if (isLocalStorage && localStorage != null && urlParams["embed"] != "1") {
      editorUi.actions.addAction("configuration...", function () {
        ...
        if (Editor.isSettingsEnabled() && (Editor.currentTheme == "sketch" || Editor.currentTheme == "simple" || Editor.currentTheme == "min")) {
        ...
        if (!editorUi.isOfflineApp() && isLocalStorage && editorUi.mode != App.MODE_ATLAS) {
          ...
          if (pluginsAction != null && (Editor.currentTheme == "sketch" || Editor.currentTheme == "simple" || Editor.currentTheme == "min")) {
            ...
            function (evt, input) {
              if (input.value.length > 0) {
                try {
                  ...
                  var url = window.location.protocol + "//" + window.location.host + "/" + editorUi.getSearch() + "#_CONFIG_" + Graph.compress(JSON.stringify(obj));
    ...
    editorUi.customLayoutConfig = [
      { layout: "mxHierarchicalLayout", config: { orientation: "west", intraCellSpacing: 30, interRankCellSpacing: 100, interHierarchySpacing: 60, parallelEdgeSpacing: 10 } },
    ];

    // Adds action for running layouts
    editorUi.actions.addAction("runLayout", function () {
      editorUi.showCustomLayoutDialog(JSON.stringify(editorUi.customLayoutConfig, null, 2));
    });

    // Adds action for removing user-defined colors
    editorUi.actions.put(
      "adaptiveColors",
      new Action("adaptiveColors", function (evt) {
        if (editorUi.adaptiveColorsWindow == null) {
          editorUi.adaptiveColorsWindow = new AdaptiveColorsWindow(editorUi, document.body.offsetWidth - 520, 80, 200, 160);
        }
                  ...
                  editorUi.tryAndHandle(
                    mxUtils.bind(this, function () {
                      ...
                      editorUi.executeLayout(function () {
                        layout.execute(graph.getDefaultParent(), !graph.isSelectionEmpty() ? graph.getSelectionCells() : null);
                      }, false);
                    }),
                  );
                }),
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (!mxClient.IS_CHROMEAPP && (editorUi.isOffline() || navigator.standalone)) {
            ...
            var item = menu.addItem(mxResources.get("search") + ":", null, null, parent, null, null, false);
            ...
            if (EditorUi.isElectronApp) {
              ...
              editorUi.actions.put(
                "desktopResetZoom",
                new Action("actualSize", function () {
                  editorUi.desktopResetZoom();
                }),
              );

              this.addMenuItems(menu, ["-", "keyboardShortcuts", "quickStart", "website", "support", "-"], parent);

              if (urlParams["disableUpdate"] != "1") {
                this.addMenuItems(menu, ["check4Updates", "-"], parent);
              }

              this.addMenuItems(menu, ["desktopResetZoom", "desktopZoomIn", "desktopZoomOut", "-", "openDevTools", "-", "about"], parent);
            } else {
              this.addMenuItems(menu, ["-", "keyboardShortcuts", "quickStart", "downloadDesktop", "support", "-", "about"], parent);
            }
          }
    ...
    if (urlParams["test"] == "1") {
        ...
        mxUtils.bind(this, function () {
          if (!graph.isSelectionEmpty()) {
            ...
            editorUi.showTextDialog(
              ...
              "this.addDataEntry('tag1 tag2', " + bbox.width + ", " + bbox.height + ", 'The Title', '" + Graph.compress(mxUtils.getXml(graph.encodeCells(cells))) + "'),",
            );
          }
        }),
      );
      ...
      editorUi.actions.addAction(
        "showBoundingBox",
        mxUtils.bind(this, function () {
          var b = graph.isSelectionEmpty() ? graph.getGraphBounds() : graph.getBoundingBox(graph.getSelectionCells());
          var tr = graph.view.translate;
          var s = graph.view.scale;
          graph.insertVertex(graph.getDefaultParent(), null, "", b.x / s - tr.x, b.y / s - tr.y, b.width / s, b.height / s, "fillColor=none;strokeColor=red;");
          ...
          function checkBounds(shape) {
            return (
              ...
              (!isNaN(shape.boundingBox.x) && !isNaN(shape.boundingBox.y) && !isNaN(shape.boundingBox.width) && !isNaN(shape.boundingBox.height))
            );
          }
      ...
      editorUi.actions.addAction(
        "testCheckFile",
        mxUtils.bind(this, function () {
          var xml = editorUi.pages != null && editorUi.getCurrentFile() != null ? editorUi.getCurrentFile().getAnonymizedXmlForPages(editorUi.pages) : "";

          var dlg = new TextareaDialog(editorUi, "Paste Data:", xml, function (newValue) {
            if (newValue.length > 0) {
              try {
                ...
                function checkModel(node) {
                  ...
                  if (keys.length > 0) {
                    var log = pageId + ": " + keys.length + " Duplicates: " + keys.join(", ");
      ...
      editorUi.actions.addAction(
        ...
        mxUtils.bind(this, function () {
          if (editorUi.pages != null) {
            var buttons = [
              [
                ...
                function (evt, input) {
                  ...
                  dlg.textarea.value = "Snapshot updated " + new Date().toLocaleString() + " Checksum " + editorUi.getHashValueForPages(snapshot);
                },
              ],
              [
                "Diff",
                function (evt, input) {
                  try {
                    dlg.textarea.value = JSON.stringify(editorUi.diffPages(snapshot, editorUi.pages), null, 2);
                  } catch (e) {
                    editorUi.handleError(e);
                  }
                },
            ...
            if (snapshot == null) {
              snapshot = editorUi.getPagesForXml(editorUi.getFileData(true));
              dlg.textarea.value = "Snapshot created " + new Date().toLocaleString() + " Checksum " + editorUi.getHashValueForPages(snapshot);
            } else {
              dlg.textarea.value = JSON.stringify(editorUi.diffPages(snapshot, editorUi.pages), null, 2);
            }
            ...
            if (editorUi.spinner.spin(document.body, mxResources.get("loading"))) {
              file.getLatestVersion(
                function (latestFile) {
                  ...
                  var remoteChecksum = editorUi.getHashValueForPages(latestFile.getShadowPages());
                  var descChecksum = latestFile.getDescriptorChecksum(latestFile.getDescriptor());
                  var remoteRev = latestFile.getCurrentRevisionId();

                  console.log("Local File", [file], "modified", file.isModified(), "checksum", localChecksum);

                  console.log("Remote File", [latestFile], "rev", remoteRev == localRev, "desc", descChecksum == remoteChecksum, "checksum", remoteChecksum);

                  editorUi.alert("Checksums " + (remoteChecksum == localChecksum ? "match" : "no not match"));
                },
                function (err) {
      ...
      editorUi.actions.addAction(
        ...
        mxUtils.bind(this, function () {
          ...
          if (file != null && file.isRealtime()) {
            console.log("Checksum ownPages", editorUi.getHashValueForPages(file.ownPages));
            console.log("Checksum theirPages", editorUi.getHashValueForPages(file.theirPages));
            console.log("diff ownPages/theirPages", editorUi.diffPages(file.ownPages, file.theirPages));

            var shadow = file.getShadowPages();

            if (shadow != null) {
              console.log("Checksum shadowPages", editorUi.getHashValueForPages(shadow));
              console.log("diff shadowPages/ownPages", editorUi.diffPages(shadow, file.ownPages));
              console.log("diff ownPages/shadowPages", editorUi.diffPages(file.ownPages, shadow));
              console.log("diff theirPages/shadowPages", editorUi.diffPages(file.theirPages, shadow));
            }

            if (file.sync != null && file.sync.snapshot != null) {
              console.log("Checksum snapshot", editorUi.getHashValueForPages(file.sync.snapshot));
              console.log("diff ownPages/snapshot", editorUi.diffPages(file.ownPages, file.sync.snapshot));
              console.log("diff theirPages/snapshot", editorUi.diffPages(file.theirPages, file.sync.snapshot));

              if (editorUi.pages != null) {
                console.log("diff snapshot/actualPages", editorUi.diffPages(file.sync.snapshot, editorUi.pages));
              }
            }

            if (editorUi.pages != null) {
              console.log("diff ownPages/actualPages", editorUi.diffPages(file.ownPages, editorUi.pages));
              console.log("diff theirPages/actualPages", editorUi.diffPages(file.theirPages, editorUi.pages));
            }
          }

          if (file != null) {
            console.log("Shadow pages", [editorUi.getXmlForPages(file.getShadowPages())]);
          }

          if (editorUi.pages != null) {
            console.log("Checksum actualPages", editorUi.getHashValueForPages(editorUi.pages));
          }
        }),
      );
      ...
      editorUi.actions.addAction(
        ...
        mxUtils.bind(this, function () {
          ...
          if (file != null && file.isRealtime() && file.shadowPages != null) {
            console.log("patching actualPages to shadowPages", file.patch([editorUi.diffPages(file.shadowPages, editorUi.pages)]));
        ...
        mxUtils.bind(this, function () {
          if (prevRevalidate != null) {
            ...
            graph.view.revalidate = function () {
              ...
              EditorUi.debug("[Performance] mxGraphView.revalidate", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevSelectPage != null) {
            ...
            editorUi.selectPage = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.selectPage", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevDiffPages != null) {
            ...
            editorUi.diffPages = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.diffPages", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevPatchPages != null) {
            ...
            editorUi.patchPages = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.patchPages", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevClonePages != null) {
            ...
            editorUi.clonePages = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.clonePages", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevGetHashValueForPages != null) {
            ...
            editorUi.getHashValueForPages = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.getHashValueForPages", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevResolveCrossReferences != null) {
            ...
            editorUi.resolveCrossReferences = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.resolveCrossReferences", [this], "time", Date.now() - t0 + " ms", "args", arguments);
          ...
          if (prevGetFileData != null) {
            ...
            editorUi.getFileData = function () {
              ...
              EditorUi.debug("[Performance] EditorUi.getFileData", [this], "time", Date.now() - t0 + " ms", "args", arguments);
    ...
    editorUi.actions.put(
      "shapes",
      new Action("moreShapes" + "...", function (evt) {
        if (mxClient.IS_CHROMEAPP || !editorUi.isOffline()) {
          editorUi.showDialog(new MoreShapesDialog(editorUi, true).container, 640, isLocalStorage ? (mxClient.IS_IOS ? 480 : 460) : 440, true, true);
        } else {
          editorUi.showDialog(new MoreShapesDialog(editorUi, false).container, 360, isLocalStorage ? (mxClient.IS_IOS ? 300 : 280) : 260, true, true);
        }
      }),
    );
          ...
          new Action("notion" + "...", function () {
            ...
            editorUi.getPublicUrl(editorUi.getCurrentFile(), function (publicUrl) {
              editorUi.showPublishLinkDialog(
                ...
                function (linkTarget, linkColor, currentPage, lightbox, editLink, layers, width, height, tags, link, transparent, darkMode) {
                  var params = ["border=0"];
                    ...
                    var dlg = new EmbedDialog(editorUi, "<!-- " + editorUi.editor.appName + " diagram -->\n" + html + "\n" + scriptTag + "\n", null, null, function () {
                      try {
                        ...
                        if (wnd != null && wnd.document != null) {
                          ...
                          doc.writeln("<html>");
                          doc.writeln("<head><title>" + encodeURIComponent(mxResources.get("preview")) + '</title><meta charset="utf-8"></head>');
                          doc.writeln("<body>");
                          doc.writeln(html);
                          ...
                          if (!direct) {
                            ...
                            img.setAttribute("src", window.location.protocol + "//" + window.location.hostname + "/" + IMAGE_PATH + "/spin.gif");
        ...
        new Action("Live image...", function () {
          ...
          if (current != null) {
            editorUi.getPublicUrl(current, function (url) {
              if (url != null) {
                var dlg = new EmbedDialog(editorUi, '<img src="' + (current.constructor != DriveFile ? url : "https://drive.google.com/uc?id=" + current.getId()) + '"/>');
                editorUi.showDialog(dlg.container, 450, 240, true, true);
                dlg.init();
              } else {
        ...
        new Action("iframe" + "...", function () {
          editorUi.getPublicUrl(editorUi.getCurrentFile(), function (publicUrl) {
            ...
            editorUi.showPublishLinkDialog(
              ...
              "100%",
              Math.ceil(Math.max(100, bounds.height / graph.view.scale)) + 2,
              null,
              null,
              null,
              publicUrl,
    ...
    action.setToggleAction(true);
    action.setSelectedCallback(function () {
      return editorUi.sidebar != null && editorUi.sidebar.isEntryVisible("search");
    });
    ...
    if (urlParams["embed"] == "1") {
      ...
      editorUi.actions.get("save").funct = function (exit) {
        ...
        var data = urlParams["pages"] != "0" || (editorUi.pages != null && editorUi.pages.length > 1) ? editorUi.getFileData(true) : mxUtils.getXml(editorUi.editor.getGraphXml());

        if (urlParams["proto"] == "json") {
          var msg = editorUi.createLoadMessage("save");
          msg.xml = data;

          if (exit === true && (urlParams["saveAndExit"] == "1" || urlParams["publishClose"] == "1")) {
            msg.exit = true;
          }
      ...
      editorUi.actions.addAction(
        ...
        function () {
          if (urlParams["embedInline"] == "1") {
            ...
            var fn = function () {
              editorUi.editor.modified = false;
              var msg = urlParams["proto"] == "json" ? JSON.stringify({ event: "exit", modified: editorUi.editor.modified }) : "";
              var parent = window.opener || window.parent;
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (editorUi.vsdxExportEnabled() && !mxClient.IS_IE && (typeof VsdxExport !== "undefined" || !editorUi.isOffline())) {
          ...
          if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && Editor.currentTheme == "min" && !editorUi.isOffline()) {
          ...
          if (
            ...
            urlParams["extAuth"] != "1" &&
            (Editor.currentTheme == "simple" || Editor.currentTheme == "sketch" || Editor.currentTheme == "min") &&
            !editorUi.isOffline()
          ) {
            menu.addSeparator(parent);
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (editorUi.isModeReady(App.MODE_DROPBOX)) {
            ...
            menu.addItem(
              mxResources.get("dropbox") + " (" + mxResources.get("loading") + "...)",
              null,
              function () {
                // do nothing
              },
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (Editor.currentTheme == "simple") {
            ...
            if (iw < 360 && urlParams["embed"] != "1" && editorUi.getServiceName() == "draw.io") {
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (editorUi.isAutoDarkModeSupported()) {
            ...
            if (item != null) {
              item.setAttribute("title", mxResources.get("automatic") + " (" + mxResources.get(Editor.isDarkMode() ? "dark" : "light") + ")");
            }
          }
          ...
          if (file.constructor == LocalFile && file.fileHandle != null) {
            ...
            var dlg = new FilenameDialog(
              ...
              mxUtils.bind(this, function (title) {
                if (title != null && title.length > 0 && file != null && title != file.getTitle() && this.editorUi.spinner.spin(document.body, mxResources.get("renaming"))) {
              ...
              file.constructor == DriveFile || file.constructor == StorageFile ? mxResources.get("diagramName") : null,
              function (name) {
    ...
    if (!EditorUi.isElectronApp && editorUi.isOwnGDriveDomain() && editorUi.getServiceName() == "draw.io" && !navigator.standalone) {
      editorUi.actions.put(
        "presentationMode",
        new Action("presentationMode" + "...", function () {
          var title = editorUi.getCurrentFile() != null ? editorUi.getCurrentFile().getTitle() : null;
          editorUi.editor.editAsNew(editorUi.getFileData(true), title, true, editorUi.currentPage != null ? editorUi.currentPage.getId() : null);
        }),
      );
    }
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (file != null && (file.getMode() == App.MODE_GOOGLE || file.getMode() == App.MODE_GITHUB) && /(\.png)$/i.test(file.getTitle())) {
    ...
    var addInsertAction = function (method) {
      ...
      editorUi.actions.put(
        method,
        new Action(title, function (evt) {
          if (method == "fromText" || method == "formatSql" || method == "plantUml" || method == "mermaid") {
            var dlg = new ParseDialog(editorUi, title, method);
            editorUi.showDialog(dlg.container, 640, 420, true, false, null, null, null, new mxRectangle(0, 0, 440, 280));
            dlg.init();
          } else {
    ...
    if (window.PLANT_URL != "https://plant-aws.diagrams.net" || (EditorUi.enablePlantUml && !editorUi.isOffline())) {
          ...
          if (graph.isEnabled() && !graph.isCellLocked(graph.getDefaultParent())) {
            graph.startEditingAtCell(
              insertVertex(
                ...
                60,
                30,
                graph.appendFontSize(Editor.defaultTextStyle, graph.vertexFontSize),
                evt != null && !mxEvent.isControlDown(evt) && !mxEvent.isMetaDown(evt) && graph.isMouseInsertPoint() ? graph.getInsertPoint() : null,
              ),
            );
          }
        },
      ...
      new Action(
        ...
        function () {
          if (editorUi.sidebarWindow != null) {
            editorUi.sidebarWindow.window.setVisible(!editorUi.sidebarWindow.window.isVisible());
          } else {
        ...
        null,
        null,
        Editor.ctrlKey + "+" + Editor.shiftKey + "+K",
      ),
    );
    ...
    toggleShapes.setSelectedCallback(
      mxUtils.bind(this, function () {
        return (editorUi.sidebarWindow != null && editorUi.sidebarWindow.window.isVisible()) || (editorUi.sidebarWindow == null && editorUi.hsplitPosition > 0);
      }),
    );
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (Editor.currentTheme == "sketch") {
            ...
            menu.addSeparator(parent);
            editorUi.menus.addMenuItems(menu, ["insertText", "insertLink", "-", "insertImage", "createShape", "-"], parent);
            ...
            this.addMenuItems(
              menu,
              ["insertRectangle", "insertEllipse", "insertRhombus", "-", "insertEdge", "insertNote", "-", "insertText", "insertLink", "-", "insertImage", "createShape", "-"],
              parent,
            );
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          this.addMenuItems(menu, ["horizontalFlow", "verticalFlow", "-", "horizontalTree", "verticalTree", "radialTree", "-", "organic", "circle"], parent);
        }),
      ),
    );
        ...
        if (recent != null) {
          for (var i = 0; i < recent.length; i++) {
            (function (entry) {
              ...
              menu.addItem(
                entry.title + " (" + mxResources.get(modeKey) + ")",
                null,
                function () {
                ...
                function (fileUrl) {
                  if (fileUrl != null && fileUrl.length > 0) {
                    if (editorUi.getCurrentFile() == null) {
                      ...
                      window.geOpenWindow(
                        (mxClient.IS_CHROMEAPP ? "https://app.diagrams.net/" : "https://" + location.host + "/") + window.location.search + "#U" + encodeURIComponent(fileUrl),
                      );
                    }
                  }
                },
                      ...
                      mxUtils.get(
                        ...
                        function (req) {
                          if (req.getStatus() >= 200 && req.getStatus() <= 299) {
                            ...
                            try {
                              editorUi.loadLibrary(new UrlLibrary(editorUi, req.getText(), fileUrl));
    ...
    viewPanelsMenu.funct = function (menu, parent) {
      var file = editorUi.getCurrentFile();
      editorUi.menus.addMenuItems(menu, ["toggleShapes", "format", "ruler", "-", "findReplace", "layers", "tags", "outline", "-"], parent);
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (Editor.currentTheme == "simple") {
            ...
            editorUi.menus.addMenuItems(menu, ["-", "findReplace", "layers", "tags", "outline", "-"], parent);
            ...
            this.addMenuItems(menu, ["format", "outline", "layers", "tags"].concat(editorUi.commentsSupported() ? ["comments", "-"] : ["-"]));
            ...
            this.addMenuItems(
              menu,
              ["ruler", "-", "tooltips", "animations", "-", "grid", "guides", "-", "connectionArrows", "connectionPoints", "-", "resetView", "zoomIn", "zoomOut"],
              parent,
            );
          ...
          if (editorUi.pages != null) {
            for (var i = 0; i < editorUi.pages.length; i++) {
              mxUtils.bind(this, function (index) {
                ...
                if (editorUi.pages[index] == page && !editorUi.editor.graph.isLightboxView() && editorUi.editor.graph.isEnabled()) {
                  item = editorUi.menus.addSubmenu("currentPage", menu, parent, editorUi.getShortPageName(page));
                } else {
                  item = menu.addItem(
                ...
                item.setAttribute("title", editorUi.pages[index].getName() + " (" + (index + 1) + "/" + editorUi.pages.length + ")" + (id != null ? " [" + id + "]" : ""));
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (Editor.currentTheme == "simple" || Editor.currentTheme == "sketch" || Editor.currentTheme == "min") {
            if (langMenu != null && (urlParams["embed"] != "1" || urlParams["lang"] == null)) {
              editorUi.menus.addSubmenu("language", menu, parent);
            }

            if ((urlParams["embed"] != "1" || urlParams["atlas"] == "1") && urlParams["extAuth"] != "1" && urlParams["embedInline"] != "1") {
            ...
            editorUi.menus.addMenuItems(menu, ["-", "copyConnect", "collapseExpand", "-", "tooltips", "animations", "-"], parent);
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (!editorUi.isStandaloneApp()) {
            var err = editorUi.isOffline(true) ? mxResources.get("offline") : editorUi.getNetworkStatus();
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          // Compatiblity code for live UI switch and static UI
          var sketchTheme = Editor.currentTheme == "simple" || Editor.currentTheme == "sketch";

          if (mxClient.IS_CHROMEAPP || EditorUi.isElectronApp) {
            editorUi.menus.addMenuItems(menu, ["new", "open"], parent);
            editorUi.menus.addSubmenu("openRecent", menu, parent);
            editorUi.menus.addMenuItems(menu, ["-", "synchronize", "properties", "-", "save", "saveAs", "-"], parent);
          } else if (editorUi.mode == App.MODE_ATLAS) {
            if (urlParams["noSaveBtn"] != "1" && urlParams["embedInline"] != "1") {
              editorUi.menus.addMenuItems(menu, ["-", "save"], parent);
            }

            if (urlParams["saveAndExit"] == "1" || (urlParams["noSaveBtn"] == "1" && urlParams["saveAndExit"] != "0") || editorUi.mode == App.MODE_ATLAS) {
            ...
            if (Editor.currentTheme == "min") {
              editorUi.menus.addMenuItems(menu, ["toggleShapes", "format", "layers", "tags", "-", "findReplace"], parent);
          ...
          if (urlParams["embed"] == "1") {
            ...
            if (urlParams["saveAndExit"] == "1" || (urlParams["noSaveBtn"] == "1" && urlParams["saveAndExit"] != "0")) {
              editorUi.menus.addMenuItems(menu, ["saveAndExit"], parent);
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          // Compatiblity code for live UI switch and static UI
          var minTheme = Editor.currentTheme == "simple" || Editor.currentTheme == "sketch" || Editor.currentTheme == "min";
          ...
          if (urlParams["embed"] == "1") {
            ...
            if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && file != null && (file.constructor != LocalFile || file.fileHandle != null)) {
            ...
            if (file != null) {
              if (Editor.currentTheme != "simple" && (file.constructor == DriveFile || file.constructor == GitHubFile || file.constructor == OneDriveFile)) {
                editorUi.menus.addMenuItems(menu, ["share"], parent);
              }

              if ((Editor.currentTheme == "sketch" || Editor.currentTheme == "min") && !mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp) {
                this.addMenuItem(menu, "publishLink", parent, null, null, mxResources.get("publish") + "...");
              }
            ...
            if (editorUi.isOfflineApp()) {
              ...
              if (file != null) {
                if (file.constructor == OneDriveFile || file.constructor == DriveFile) {
            ...
            if (file != null && editorUi.fileNode != null && urlParams["embedInline"] != "1") {
              ...
              if ((file.constructor == DriveFile && file.sync != null && file.sync.isConnected()) || !/(\.html)$/i.test(filename)) {
            ...
            if (file != null && file.constructor == DriveFile) {
              this.addMenuItems(menu, ["new", "-", "rename", "makeCopy", "openFolder", "moveToFolder"], parent);
            } else {
              if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && file != null && (file.constructor != LocalFile || file.fileHandle != null)) {
                menu.addSeparator(parent);
                var item = this.addMenuItem(menu, "synchronize", parent);
              ...
              if (!mxClient.IS_CHROMEAPP && !EditorUi.isElectronApp && editorUi.getServiceName() == "draw.io" && !editorUi.isOfflineApp() && file != null) {
        ...
        mxUtils.bind(this, function (menu, parent) {
          ...
          for (var i = 0; i < this.defaultFonts.length; i++) {
            ...
            if (typeof value === "string") {
              ...
              reserved[encodeURIComponent(value.fontFamily) + "@" + encodeURIComponent(value.fontUrl)] = true;
          ...
          function addEntry(entry) {
            var key = encodeURIComponent(entry.name) + (entry.url == null ? "" : "@" + encodeURIComponent(entry.url));
            ...
            if (!reserved[key]) {
              ...
              if (duplicates[key] == null) {
                entries.push({ name: entry.name, url: entry.url, label: label, title: entry.url });
          ...
          menu.addItem(
            ...
            mxUtils.bind(this, function () {
              ...
              var curFontName = graph.getStylesheet().getDefaultVertexStyle()[mxConstants.STYLE_FONTFAMILY];
              var curType = "s";
              var curUrl = null;
                  ...
                  if (fontName != null && fontName.length > 0) {
                    ...
                    if (graph.isEditing()) {
                      ...
                      try {
                        ...
                        graph.setCellStyles("fontSource", fontUrl != null ? encodeURIComponent(fontUrl) : null);
              ...
              this.editorUi.showDialog(dlg.container, 380, 130 + (Editor.enableWebFonts ? 70 : 0) + (urlParams["isGoogleFontsEnabled"] != "0" ? 50 : 0), true, true);
              dlg.init();
            }),
            parent,
            null,
