...
(async function () {
  await mxscript(drawDevUrl + "js/cryptojs/aes.min.js");
  await mxscript(drawDevUrl + "js/spin/spin.min.js");
  await mxscript(drawDevUrl + "js/deflate/pako.min.js");
  await mxscript(drawDevUrl + "js/deflate/base64.js");
  await mxscript(drawDevUrl + "js/sanitizer/purify.min.js");
  await mxscript(drawDevUrl + "js/rough/rough.min.js");
  await mxscript(drawDevUrl + "js/freehand/perfect-freehand.js");

  // Uses grapheditor from devhost
  await mxscript(geBasePath + "/Editor.js");
  await mxscript(geBasePath + "/EditorUi.js");
  await mxscript(geBasePath + "/Sidebar.js");
  await mxscript(geBasePath + "/Graph.js");
  await mxscript(geBasePath + "/Format.js");
  await mxscript(geBasePath + "/Shapes.js");
  await mxscript(geBasePath + "/Actions.js");
  await mxscript(geBasePath + "/Menus.js");
  ...
  await mxscript(drawDevUrl + "js/diagramly/App.js");
