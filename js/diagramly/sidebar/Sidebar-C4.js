  ...
  Sidebar.prototype.addC4Palette = function () {
    ...
    this.addPaletteFunctions("c4", "C4", false, [
      ...
      this.addEntry(dt + "software system", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.2),
      ...
      this.addEntry(dt + "external software system", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.2),
          "rounded=1;whiteSpace=wrap;html=1;labelBackgroundColor=none;fillColor=#8C8496;fontColor=#ffffff;align=center;arcSize=10;strokeColor=#736782;metaEdit=1;resizable=0;" +
            pts,
        );
        bg.vertex = true;
        bg.setValue(mxUtils.createXmlDocument().createElement("object"));
      ...
      this.addEntry(dt + "container", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.2),
          "rounded=1;whiteSpace=wrap;html=1;fontSize=11;labelBackgroundColor=none;fillColor=#23A2D9;fontColor=#ffffff;align=center;arcSize=10;strokeColor=#0E7DAD;metaEdit=1;resizable=0;" +
            pts,
        );
        bg.vertex = true;
        bg.setValue(mxUtils.createXmlDocument().createElement("object"));
        ...
        bg.setAttribute(
          "label",
          '<font style="font-size: 16px"><b>%c4Name%</b></font><div>[%c4Type%: %c4Technology%]</div><br><div><font style="font-size: 11px"><font color="#E6E6E6">%c4Description%</font></div>',
        );
      ...
      this.addEntry(dt + "data container", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.2),
          "shape=cylinder3;size=15;whiteSpace=wrap;html=1;boundedLbl=1;rounded=0;labelBackgroundColor=none;fillColor=#23A2D9;fontSize=12;fontColor=#ffffff;align=center;strokeColor=#0E7DAD;metaEdit=1;points=[[0.5,0,0],[1,0.25,0],[1,0.5,0],[1,0.75,0],[0.5,1,0],[0,0.75,0],[0,0.5,0],[0,0.25,0]];resizable=0;",
        );
        bg.vertex = true;
        bg.setValue(mxUtils.createXmlDocument().createElement("object"));
        bg.setAttribute("placeholders", "1");
      ...
      this.addEntry(dt + "message bus container", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.2),
          "shape=cylinder3;size=15;direction=south;whiteSpace=wrap;html=1;boundedLbl=1;rounded=0;labelBackgroundColor=none;fillColor=#23A2D9;fontSize=12;fontColor=#ffffff;align=center;strokeColor=#0E7DAD;metaEdit=1;points=[[0.5,0,0],[1,0.25,0],[1,0.5,0],[1,0.75,0],[0.5,1,0],[0,0.75,0],[0,0.5,0],[0,0.25,0]];resizable=0;",
        );
        bg.vertex = true;
        bg.setValue(mxUtils.createXmlDocument().createElement("object"));
        bg.setAttribute("placeholders", "1");
      ...
      this.addEntry(dt + "web browser container", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.6),
      ...
      this.addEntry(dt + "component", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.4, h * 1.2),
          "rounded=1;whiteSpace=wrap;html=1;labelBackgroundColor=none;fillColor=#63BEF2;fontColor=#ffffff;align=center;arcSize=6;strokeColor=#2086C9;metaEdit=1;resizable=0;" + pts,
        );
        bg.vertex = true;
        bg.setValue(mxUtils.createXmlDocument().createElement("object"));
        bg.setAttribute("placeholders", "1");
        ...
        bg.setAttribute(
          "label",
          '<font style="font-size: 16px"><b>%c4Name%</b></font><div>[%c4Type%: %c4Technology%]</div><br><div><font style="font-size: 11px">%c4Description%</font></div>',
        );
      ...
      this.addEntry(dt + "relationship description technology", function () {
        ...
        edge.setAttribute(
          "label",
          '<div style="text-align: left"><div style="text-align: center"><b>%c4Description%</b></div><div style="text-align: center">[%c4Technology%]</div></div>',
        );
      ...
      this.addEntry(dt + "system context diagram title", function () {
        var bg = new mxCell(
          "",
          new mxGeometry(0, 0, w * 2.6, h * 0.4),
          "text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=top;whiteSpace=wrap;rounded=0;metaEdit=1;allowArrows=0;resizable=1;rotatable=0;connectable=0;recursiveResize=0;expand=0;pointerEvents=0;" +
            pts,
        );
        bg.vertex = true;
        bg.setValue(mxUtils.createXmlDocument().createElement("object"));
