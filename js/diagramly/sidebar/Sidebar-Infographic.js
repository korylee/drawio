  ...
  Sidebar.prototype.addInfographicPalette = function () {
    ...
    this.addPaletteFunctions("infographic", "Infographic", false, [
      this.createVertexTemplateEntry(
        s4 + "pie;fillColor=#10739E;strokeColor=none;startAngle=0.2;endAngle=0.9;",
        w,
        h,
        "",
        "Pie",
        null,
        null,
        this.getTagsForStencil(gn, "pie", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s4 + "arc;strokeColor=#10739E;strokeWidth=6;startAngle=0.3;endAngle=0.1;",
        w,
        h,
        "",
        "Arc",
        null,
        null,
        this.getTagsForStencil(gn, "arc", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s4 + "partConcEllipse;fillColor=#10739E;strokeColor=none;startAngle=0.25;endAngle=0.1;arcWidth=0.5;",
        w,
        h,
        "",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "partConcEllipse", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s2 + "parallelogram;dx=15;fillColor=#10739E;strokeColor=none;",
        w,
        h * 0.7,
        "",
        "Trapezoid",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "ribbonRolled", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "ribbonDoubleFolded", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "ribbonFrontFolded", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "ribbonBackFolded", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "banner", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "bannerSingleFold", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "bannerHalfFold", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "flag", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s2 + "shadedTriangle;fillColor=#10739E;strokeColor=none;",
        w * 0.8,
        h,
        "",
        "Triangle",
        null,
        null,
        this.getTagsForStencil(gn, "shadedTriangle", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s2 + "shadedPyramid;fillColor=#10739E;strokeColor=none;",
        w * 0.6,
        h,
        "",
        "Pyramid",
      ...
      this.createVertexTemplateEntry(
        s2 + "pyramidStep;fillColor=#10739E;strokeColor=none;",
        w * 0.6,
        h,
        "",
        "Pyramid step",
        null,
        null,
        this.getTagsForStencil(gn, "pyramidStep", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s2 + "cylinder;fillColor=#10739E;strokeColor=none;",
        w * 0.6,
        h,
        "",
        "Cylinder",
        null,
        null,
        this.getTagsForStencil(gn, "cylinder", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        s2 + "shadedCube;isoAngle=15;fillColor=#10739E;strokeColor=none;",
        w,
        h,
        "",
        "Cube",
        null,
        null,
        this.getTagsForStencil(gn, "shaded cube", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "circularDial", dt).join(" "),
      ),

      this.addEntry(dt + "chevron list", function () {
        var button1 = new mxCell(
          "LABEL",
      ...
      this.addEntry(dt + "roadmap vertical", function () {
        var chevron1 = new mxCell(
          "",
          new mxGeometry(0, 0, 70, 80),
        ...
        var label1 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#10739E"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(100, 0, 200, 70),
      ...
      this.addEntry(dt + "numbered entry", function () {
        var rect1 = new mxCell(
          "Label",
          new mxGeometry(30, 10, 170, 40),
      ...
      this.createVertexTemplateEntry(
        mxConstants.STYLE_VERTICAL_LABEL_POSITION +
          ...
          "=top;html=1;shape=mxgraph.infographic.numberedEntryVert;dy=25;fillColor=#10739E;strokeColor=none;fontSize=17;fontColor=#FFFFFF;align=center;labelPosition=center;spacingTop=32;fontStyle=1;whiteSpace=wrap;",
        w * 0.8,
        h * 1.6,
        "Label",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "numberedEntryVert", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "bendingArch", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "circularCallout", dt).join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "circularCallout2", dt).join(" "),
      ),
      ...
      this.addEntry(dt + "circular dial", function () {
        ...
        part1.vertex = true;
        var part2 = new mxCell(
          "65%",
          new mxGeometry(0, 0, 100, 100),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.65;arcWidth=0.2;strokeColor=none;fillColor=#10739E;fontSize=22;fontColor=#10739E;align=center;fontStyle=1;whiteSpace=wrap;",
        );
        part2.vertex = true;
        part1.insert(part2);
      ...
      this.addEntry(dt + "chevron list", function () {
        ...
        var process2 = new mxCell(
          str1,
          new mxGeometry(0, 170, 190, 120),
          "shape=rect;fillColor=#B1DDF0;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process2.vertex = true;
        var process3 = new mxCell(
          str1,
          new mxGeometry(0, 300, 190, 120),
          "shape=rect;fillColor=#B1DDF0;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process3.vertex = true;
        var chrevron2 = new mxCell(
          "LABEL",
          new mxGeometry(200, 0, 200, 30),
        ...
        var process4 = new mxCell(
          str1,
          new mxGeometry(200, 40, 190, 120),
        ...
        var process5 = new mxCell(
          str1,
          new mxGeometry(200, 170, 190, 120),
          "shape=rect;fillColor=#FCE7CD;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process5.vertex = true;
        var process6 = new mxCell(
          str1,
          new mxGeometry(200, 300, 190, 120),
          "shape=rect;fillColor=#FCE7CD;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process6.vertex = true;
        var chrevron3 = new mxCell(
          "LABEL",
          new mxGeometry(400, 0, 200, 30),
        ...
        var process7 = new mxCell(
          str1,
          new mxGeometry(400, 40, 190, 120),
        ...
        var process8 = new mxCell(
          str1,
          new mxGeometry(400, 170, 190, 120),
          "shape=rect;fillColor=#FAD9D5;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process8.vertex = true;
        var process9 = new mxCell(
          str1,
          new mxGeometry(400, 300, 190, 120),
          "shape=rect;fillColor=#FAD9D5;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process9.vertex = true;
        var chrevron4 = new mxCell(
          "LABEL",
          new mxGeometry(600, 0, 200, 30),
        ...
        var process11 = new mxCell(
          str1,
          new mxGeometry(600, 170, 190, 120),
          "shape=rect;fillColor=#BAC8D3;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process11.vertex = true;
        var process12 = new mxCell(
          str1,
          new mxGeometry(600, 300, 190, 120),
          "shape=rect;fillColor=#BAC8D3;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process12.vertex = true;
        var chrevron5 = new mxCell(
          "LABEL",
          new mxGeometry(800, 0, 200, 30),
        ...
        var process13 = new mxCell(
          str1,
          new mxGeometry(800, 40, 190, 120),
        ...
        var process14 = new mxCell(
          str1,
          new mxGeometry(800, 170, 190, 120),
          "shape=rect;fillColor=#B0E3E6;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
        process14.vertex = true;
        var process15 = new mxCell(
          str1,
          new mxGeometry(800, 300, 190, 120),
          "shape=rect;fillColor=#B0E3E6;strokeColor=none;fontSize=12;html=1;whiteSpace=wrap;align=left;verticalAlign=top;spacing=5;rounded=0;",
        );
      ...
      this.addEntry(dt + "roadmap vertical", function () {
        ...
        var chevron2 = new mxCell(
          "",
          new mxGeometry(0, 80, 70, 80),
        ...
        var label2 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#F2931E"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(100, 80, 200, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label2.vertex = true;

        var chevron3 = new mxCell(
          "",
          new mxGeometry(0, 160, 70, 80),
        ...
        var label3 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#AE4132"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(100, 160, 200, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label3.vertex = true;

        var chevron4 = new mxCell(
          "",
          new mxGeometry(0, 240, 70, 80),
        ...
        var label4 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#23445D"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(100, 240, 200, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label4.vertex = true;

        var chevron5 = new mxCell(
          "",
          new mxGeometry(0, 320, 70, 80),
        ...
        var label5 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#12AAB5"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(100, 320, 200, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label5.vertex = true;
      ...
      this.addEntry(dt + "numbered list", function () {
        ...
        var rect2 = new mxCell(
          "Label",
          new mxGeometry(30, 75, 220, 40),
        ...
        rect2.vertex = true;
        var ellipse2 = new mxCell(
          "2",
          new mxGeometry(0, 65, 60, 60),
        ...
        var rect3 = new mxCell(
          "Label",
          new mxGeometry(30, 140, 220, 40),
        ...
        rect3.vertex = true;
        var ellipse3 = new mxCell(
          "3",
          new mxGeometry(0, 130, 60, 60),
        ...
        var rect4 = new mxCell(
          "Label",
          new mxGeometry(30, 205, 220, 40),
        ...
        rect4.vertex = true;
        var ellipse4 = new mxCell(
          "4",
          new mxGeometry(0, 195, 60, 60),
        ...
        var rect5 = new mxCell(
          "Label",
          new mxGeometry(30, 270, 220, 40),
        ...
        rect5.vertex = true;
        var ellipse5 = new mxCell(
          "5",
          new mxGeometry(0, 260, 60, 60),
      ...
      this.addEntry(dt + "list", function () {
        var st1 =
          ...
          "=middle;" +
          mxConstants.STYLE_VERTICAL_ALIGN +
          "=top;html=1;shape=mxgraph.infographic.numberedEntryVert;dy=25;strokeColor=none;fontSize=17;fontColor=#FFFFFF;align=center;labelPosition=center;spacingTop=32;fontStyle=1;whiteSpace=wrap;fillColor=#";
      ...
      this.addEntry(dt + "rodmap horizontal", function () {
        ...
        var label5 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#12AAB5"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(420, 220, 120, 80),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label5.vertex = true;

        return sb.createVertexTemplateFromCells(
          [arch1, arch2, arch3, arch4, arch5, circle1, circle2, circle3, circle4, circle5, label1, label2, label3, label4, label5],
          540,
          300,
          "Roadmap (horizontal)",
        );
      ...
      this.addEntry(dt + "roadmap diagonal", function () {
        var arch1 = new mxCell(
          "",
          new mxGeometry(190, 0, 120, 120),
          s4 + "partConcEllipse;startAngle=0.75;endAngle=0.5;arcWidth=0.25;fillColor=#10739E;strokeColor=none;shadow=0;",
        );
        arch1.vertex = true;
        var arch2 = new mxCell(
          "",
          new mxGeometry(190, 105, 120, 120),
          s4 + "partConcEllipse;startAngle=0.25;endAngle=0;arcWidth=0.25;fillColor=#F2931E;strokeColor=none;shadow=0;",
        );
        arch2.vertex = true;
        var arch3 = new mxCell(
          "",
          new mxGeometry(295, 105, 120, 120),
          s4 + "partConcEllipse;startAngle=0.75;endAngle=0.5;arcWidth=0.25;fillColor=#AE4132;strokeColor=none;shadow=0;",
        );
        arch3.vertex = true;
        var arch4 = new mxCell(
          "",
          new mxGeometry(295, 210, 120, 120),
          s4 + "partConcEllipse;startAngle=0.25;endAngle=0;arcWidth=0.25;fillColor=#23445D;strokeColor=none;shadow=0;",
        );
        arch4.vertex = true;
        var arch5 = new mxCell(
          "",
          new mxGeometry(400, 210, 120, 120),
          s4 + "partConcEllipse;startAngle=0.75;endAngle=0.5;arcWidth=0.25;fillColor=#12AAB5;strokeColor=none;shadow=0;",
        );
        arch5.vertex = true;

        var circle1 = new mxCell(
          "1",
          new mxGeometry(225, 35, 50, 50),
          "shape=ellipse;strokeWidth=6;strokeColor=#10739E;fontSize=15;html=1;whiteSpace=wrap;fontStyle=1;fontColor=#10739E;shadow=1;",
        );
        circle1.vertex = true;
        var circle2 = new mxCell(
          "2",
          new mxGeometry(225, 140, 50, 50),
          "shape=ellipse;strokeWidth=6;strokeColor=#F2931E;fontSize=15;html=1;whiteSpace=wrap;fontStyle=1;fontColor=#F2931E;shadow=1;",
        );
        circle2.vertex = true;
        var circle3 = new mxCell(
          "3",
          new mxGeometry(330, 140, 50, 50),
          "shape=ellipse;strokeWidth=6;strokeColor=#AE4132;fontSize=15;html=1;whiteSpace=wrap;fontStyle=1;fontColor=#AE4132;shadow=1;",
        );
        circle3.vertex = true;
        var circle4 = new mxCell(
          "4",
          new mxGeometry(330, 245, 50, 50),
          "shape=ellipse;strokeWidth=6;strokeColor=#23445D;fontSize=15;html=1;whiteSpace=wrap;fontStyle=1;fontColor=#23445D;shadow=1;",
        );
        circle4.vertex = true;
        var circle5 = new mxCell(
          "5",
          new mxGeometry(435, 245, 50, 50),
      ...
      this.addEntry(dt + "arrow list", function () {
        ...
        part2.vertex = true;
        var part3 = new mxCell(
          "2",
          new mxGeometry(0, 45, 40, 40),
        ...
        part3.vertex = true;
        var part4 = new mxCell(
          "Label",
          new mxGeometry(45, 45, 115, 40),
        ...
        part5.vertex = true;
        var part6 = new mxCell(
          "Label",
          new mxGeometry(45, 90, 135, 40),
        ...
        part6.vertex = true;
        var part7 = new mxCell(
          "4",
          new mxGeometry(0, 135, 40, 40),
        ...
        part7.vertex = true;
        var part8 = new mxCell(
          "Label",
          new mxGeometry(45, 135, 155, 40),
        ...
        part9.vertex = true;
        var part10 = new mxCell(
          "Label",
          new mxGeometry(45, 180, 175, 40),
      ...
      this.addEntry(dt + "angled list", function () {
        var part1 = new mxCell(
          "1",
          new mxGeometry(200, 0, 50, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#10739E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;",
        );
        part1.vertex = true;
        var part2 = new mxCell(
          "Label",
          new mxGeometry(245, 0, 145, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#64BBE2;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;",
        );
        part2.vertex = true;
        var part3 = new mxCell(
          "2",
          new mxGeometry(150, 35, 50, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#F2931E;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;",
        );
        part3.vertex = true;
        var part4 = new mxCell(
          "Label",
          new mxGeometry(195, 35, 145, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#F8C382;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;",
        );
        part4.vertex = true;
        var part5 = new mxCell(
          "3",
          new mxGeometry(100, 70, 50, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#AE4132;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;",
        );
        part5.vertex = true;
        var part6 = new mxCell(
          "Label",
          new mxGeometry(145, 70, 145, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#F08E81;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;",
        );
        part6.vertex = true;
        var part7 = new mxCell(
          "4",
          new mxGeometry(50, 105, 50, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#23445D;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;",
        );
        part7.vertex = true;
        var part8 = new mxCell(
          "Label",
          new mxGeometry(95, 105, 145, 30),
          "shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#5D7F99;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;",
        );
        part8.vertex = true;
        var part9 = new mxCell(
      ...
      this.addEntry(dt + "matrix", function () {
        ...
        var part4 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(140, 140, 100, 100),
        ...
        var part6 = new mxCell(
          "Label",
          new mxGeometry(0, 140, 30, 100),
          "html=1;fillColor=#CCCCCC;strokeColor=none;shadow=0;fontSize=14;fontColor=#FFFFFF;align=center;fontStyle=1;whiteSpace=wrap;horizontal=0;rounded=0;",
        );
        part6.vertex = true;
        var part7 = new mxCell(
          "Label",
          new mxGeometry(35, 0, 100, 30),
      ...
      this.addEntry(dt + "matrix", function () {
        ...
        var part6 = new mxCell(
          "Label",
          new mxGeometry(0, 150, 30, 80),
          "rounded=1;arcSize=50;html=1;fillColor=#CCCCCC;strokeColor=none;shadow=0;fontSize=14;fontColor=#FFFFFF;align=center;fontStyle=1;whiteSpace=wrap;horizontal=0;",
        );
        part6.vertex = true;
        var part7 = new mxCell(
          "Label",
          new mxGeometry(45, 0, 80, 30),
      ...
      this.addEntry(dt + "matrix", function () {
        var part11 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(35, 35, 100, 100),
          "html=1;fillColor=#F2931E;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;rounded=0;",
        );
        part11.vertex = true;
        var part12 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(140, 35, 100, 100),
        ...
        part12.vertex = true;
        var part13 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(245, 35, 100, 100),
        ...
        part22.vertex = true;
        var part23 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(245, 140, 100, 100),
        ...
        part23.vertex = true;
        var part31 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(35, 245, 100, 100),
          "html=1;fillColor=#23445D;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;rounded=0;",
        );
        part31.vertex = true;
        var part32 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(140, 245, 100, 100),
        ...
        part32.vertex = true;
        var part33 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(245, 245, 100, 100),
        ...
        label5.vertex = true;
        var label6 = new mxCell(
          "Label",
          new mxGeometry(245, 0, 100, 30),
          "html=1;fillColor=#CCCCCC;strokeColor=none;shadow=0;fontSize=14;fontColor=#FFFFFF;align=center;fontStyle=1;whiteSpace=wrap;rounded=0;",
        );
        label6.vertex = true;

        return sb.createVertexTemplateFromCells(
          [part11, part12, part13, part21, part22, part23, part31, part32, part33, label1, label2, label3, label4, label5, label6],
          345,
          345,
          "Matrix (3x3)",
        );
      ...
      this.addEntry(dt + "hex loop", function () {
        ...
        var part6 = new mxCell(
          "Lorem ipsum<br> dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(168, 153, 112, 102),
      ...
      this.addEntry(dt + "target", function () {
        ...
        var part5 = new mxCell(
          "",
          new mxGeometry(100, 100, 150, 150),
        ...
        var part6 = new mxCell(
          "",
          new mxGeometry(125, 125, 100, 100),
      ...
      this.addEntry(dt + "onion", function () {
        ...
        var part2 = new mxCell(
          "",
          new mxGeometry(25, 50, 300, 300),
          "ellipse;html=1;strokeWidth=4;fillColor=#F8C382;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;",
        );
        part2.vertex = true;
        var part3 = new mxCell(
          "",
          new mxGeometry(50, 100, 250, 250),
          "ellipse;html=1;strokeWidth=4;fillColor=#FCE7CD;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;",
        );
        part3.vertex = true;
        var part4 = new mxCell(
          "",
          new mxGeometry(75, 150, 200, 200),
          "ellipse;html=1;strokeWidth=4;fillColor=#BAC8D3;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;",
        );
        part4.vertex = true;
        var part5 = new mxCell(
          "",
          new mxGeometry(100, 200, 150, 150),
          "ellipse;html=1;strokeWidth=4;fillColor=#5D7F99;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;",
        );
        part5.vertex = true;
        var part6 = new mxCell(
          "",
          new mxGeometry(125, 250, 100, 100),
          "ellipse;html=1;strokeWidth=4;fillColor=#2F5B7C;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;",
        );
        part6.vertex = true;
        var part7 = new mxCell(
          "",
          new mxGeometry(150, 300, 50, 50),
          "ellipse;html=1;strokeWidth=4;fillColor=#23445D;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;",
        );
        part7.vertex = true;
      ...
      this.addEntry(dt + "arc list", function () {
        var arc1 = new mxCell(
          "",
          new mxGeometry(0, 0, 260, 260),
          s4 + "partConcEllipse;fillColor=#10739E;strokeColor=#ffffff;startAngle=0.75;endAngle=0.08;arcWidth=0.16;strokeWidth=3;",
        );
        arc1.vertex = true;
        var arc2 = new mxCell(
          "",
          new mxGeometry(20, 20, 220, 220),
          s4 + "partConcEllipse;fillColor=#F2931E;strokeColor=#ffffff;startAngle=0.91;endAngle=0.17;arcWidth=0.18;strokeWidth=3;",
        );
        arc2.vertex = true;
        var arc3 = new mxCell(
          "",
          new mxGeometry(40, 40, 180, 180),
          s4 + "partConcEllipse;fillColor=#AE4132;strokeColor=#ffffff;startAngle=0.75;endAngle=0.11;arcWidth=0.22;strokeWidth=3;",
        );
        arc3.vertex = true;
        var arc4 = new mxCell(
          "",
          new mxGeometry(60, 60, 140, 140),
          s4 + "partConcEllipse;fillColor=#12AAB5;strokeColor=#ffffff;startAngle=0.02;endAngle=0.25;arcWidth=0.29;strokeWidth=3;",
        );
        arc4.vertex = true;
        var arc5 = new mxCell(
          "",
          new mxGeometry(80, 80, 100, 100),
          s4 + "partConcEllipse;fillColor=#CCCCCC;strokeColor=#ffffff;startAngle=0.75;endAngle=0.25;arcWidth=0.4;strokeWidth=3;",
        );
        arc5.vertex = true;
        var part1 = new mxCell(
          "2018",
          new mxGeometry(100, 100, 60, 60),
      ...
      this.addEntry(dt + "change graph", function () {
        ...
        var text1 = new mxCell(
          "Label",
          new mxGeometry(0, 0, 30, 20),
          "text;html=1;align=center;verticalAlign=middle;whiteSpace=wrap;fontColor=#FFFFFF;fontSize=10;strokeColor=none;fillColor=none;",
        );
        text1.vertex = true;
        part1.insert(text1);
      ...
      this.addEntry(dt + "circular dial list horizontal", function () {
        ...
        var part2 = new mxCell(
          "65%",
          new mxGeometry(0, 0, 100, 100),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.65;arcWidth=0.2;strokeColor=none;fillColor=#10739E;fontSize=22;fontColor=#10739E;align=center;fontStyle=1",
        );
        part2.vertex = true;
        part1.insert(part2);
        ...
        var part4 = new mxCell(
          "40%",
          new mxGeometry(0, 0, 100, 100),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.2;strokeColor=none;fillColor=#F2931E;fontSize=22;fontColor=#F2931E;align=center;fontStyle=1",
        );
        part4.vertex = true;
        part3.insert(part4);
        ...
        var part6 = new mxCell(
          "25%",
          new mxGeometry(0, 0, 100, 100),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.25;arcWidth=0.2;strokeColor=none;fillColor=#AE4132;fontSize=22;fontColor=#AE4132;align=center;fontStyle=1",
        );
        part6.vertex = true;
        part5.insert(part6);
        ...
        var part8 = new mxCell(
          "60%",
          new mxGeometry(0, 0, 100, 100),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.6;arcWidth=0.2;strokeColor=none;fillColor=#23445D;fontSize=22;fontColor=#23445D;align=center;fontStyle=1",
        );
        part8.vertex = true;
        part7.insert(part8);
        ...
        var part10 = new mxCell(
          "80%",
          new mxGeometry(0, 0, 100, 100),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.8;arcWidth=0.2;strokeColor=none;fillColor=#12AAB5;fontSize=22;fontColor=#12AAB5;align=center;fontStyle=1",
        );
        part10.vertex = true;
        part9.insert(part10);
      ...
      this.addEntry(dt + "circular dial list horizontal", function () {
        ...
        return sb.createVertexTemplateFromCells(
          [part1, part2, part3, part4, part5, label1, label2, label3, label4, label5, text1, text2, text3, text4, text5],
          540,
          260,
      ...
      this.addEntry(dt + "circular dial list vertical", function () {
        ...
        var label2 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#F2931E"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</font></font>",
          new mxGeometry(110, 110, 210, 100),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=left;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;spacing=8;",
        );
        label2.vertex = true;
        ...
        var label3 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#AE4132"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</font></font>",
          new mxGeometry(110, 220, 210, 100),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=left;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;spacing=8;",
        );
        label3.vertex = true;
        ...
        var label4 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#23445D"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</font></font>",
          new mxGeometry(110, 330, 210, 100),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=left;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;spacing=8;",
        );
        label4.vertex = true;
        ...
        var label5 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#12AAB5"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</font></font>",
          new mxGeometry(110, 440, 210, 100),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=left;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;spacing=8;",
        );
        label5.vertex = true;
      ...
      this.addEntry(dt + "bar graph", function () {
        var part1 = new mxCell(
          "Label",
          new mxGeometry(0, 20, 40, 80),
          s2 + "shadedCube;isoAngle=15;fillColor=#10739E;strokeColor=none;fontStyle=1;fontColor=#10739E;fontSize=12;shadow=0;",
        );
        part1.vertex = true;

        var part2 = new mxCell(
          "Label",
          new mxGeometry(50, 0, 40, 100),
          s2 + "shadedCube;isoAngle=15;fillColor=#F2931E;strokeColor=none;fontStyle=1;fontColor=#F2931E;fontSize=12;shadow=0;",
        );
        part2.vertex = true;

        var part3 = new mxCell(
          "Label",
          new mxGeometry(100, 10, 40, 90),
          s2 + "shadedCube;isoAngle=15;fillColor=#AE4132;strokeColor=none;fontStyle=1;fontColor=#AE4132;fontSize=12;shadow=0;",
        );
        part3.vertex = true;

        var part4 = new mxCell(
          "Label",
          new mxGeometry(150, 50, 40, 50),
          s2 + "shadedCube;isoAngle=15;fillColor=#23445D;strokeColor=none;fontStyle=1;fontColor=#23445D;fontSize=12;shadow=0;",
        );
        part4.vertex = true;

        var part5 = new mxCell(
          "Label",
          new mxGeometry(200, 30, 40, 70),
          s2 + "shadedCube;isoAngle=15;fillColor=#12AAB5;strokeColor=none;fontStyle=1;fontColor=#12AAB5;fontSize=12;shadow=0;",
        );
        part5.vertex = true;
      ...
      this.addEntry(dt + "bar graph", function () {
        ...
        var part2 = new mxCell(
          "Label",
          new mxGeometry(50, 20, 40, 100),
          s2 + "shadedCube;isoAngle=15;fillColor=#F2931E;strokeColor=none;fontStyle=1;fontColor=#F2931E;fontSize=12;shadow=0;",
        );
        part2.vertex = true;
        var bg2 = new mxCell(
          "",
          new mxGeometry(50, 0, 40, 40),
        ...
        var part3 = new mxCell(
          "Label",
          new mxGeometry(100, 30, 40, 90),
          s2 + "shadedCube;isoAngle=15;fillColor=#AE4132;strokeColor=none;fontStyle=1;fontColor=#AE4132;fontSize=12;shadow=0;",
        );
        part3.vertex = true;
        var bg3 = new mxCell(
          "",
          new mxGeometry(100, 0, 40, 50),
        ...
        var part4 = new mxCell(
          "Label",
          new mxGeometry(150, 70, 40, 50),
          s2 + "shadedCube;isoAngle=15;fillColor=#23445D;strokeColor=none;fontStyle=1;fontColor=#23445D;fontSize=12;shadow=0;",
        );
        part4.vertex = true;
        var bg4 = new mxCell(
          "",
          new mxGeometry(150, 0, 40, 90),
        ...
        var part5 = new mxCell(
          "Label",
          new mxGeometry(200, 50, 40, 70),
          s2 + "shadedCube;isoAngle=15;fillColor=#12AAB5;strokeColor=none;fontStyle=1;fontColor=#12AAB5;fontSize=12;shadow=0;",
        );
        part5.vertex = true;
        var bg5 = new mxCell(
          "",
          new mxGeometry(200, 0, 40, 70),
      ...
      this.addEntry(dt + "bar graph", function () {
        var part1 = new mxCell(
          "Label",
          new mxGeometry(0, 40, 40, 80),
          s2 + "cylinder;isoAngle=15;fillColor=#10739E;strokeColor=none;fontStyle=1;fontColor=#10739E;fontSize=12;shadow=0;",
        );
        part1.vertex = true;
        var bg1 = new mxCell(
          "",
        ...
        var part2 = new mxCell(
          "Label",
          new mxGeometry(50, 20, 40, 100),
          s2 + "cylinder;isoAngle=15;fillColor=#F2931E;strokeColor=none;fontStyle=1;fontColor=#F2931E;fontSize=12;shadow=0;",
        );
        part2.vertex = true;
        var bg2 = new mxCell(
          "",
        ...
        var part3 = new mxCell(
          "Label",
          new mxGeometry(100, 30, 40, 90),
          s2 + "cylinder;isoAngle=15;fillColor=#AE4132;strokeColor=none;fontStyle=1;fontColor=#AE4132;fontSize=12;shadow=0;",
        );
        part3.vertex = true;
        var bg3 = new mxCell(
          "",
        ...
        var part4 = new mxCell(
          "Label",
          new mxGeometry(150, 70, 40, 50),
          s2 + "cylinder;isoAngle=15;fillColor=#23445D;strokeColor=none;fontStyle=1;fontColor=#23445D;fontSize=12;shadow=0;",
        );
        part4.vertex = true;
        var bg4 = new mxCell(
          "",
        ...
        var part5 = new mxCell(
          "Label",
          new mxGeometry(200, 50, 40, 70),
          s2 + "cylinder;isoAngle=15;fillColor=#12AAB5;strokeColor=none;fontStyle=1;fontColor=#12AAB5;fontSize=12;shadow=0;",
        );
        part5.vertex = true;
        var bg5 = new mxCell(
          "",
      ...
      this.addEntry(dt + "ribbon list", function () {
        var ribbon1 = new mxCell(
          "",
          new mxGeometry(0, 0, 500, 100),
        ...
        var chevron1 = new mxCell(
          "",
          new mxGeometry(0, 0.5, 30, 40),
          "shape=step;perimeter=stepPerimeter;whiteSpace=wrap;html=1;fixedSize=1;shadow=0;strokeColor=none;strokeWidth=6;fillColor=#CCCCCC;size=20;",
        );
        chevron1.vertex = true;
        ...
        var text1 = new mxCell(
          ...
          new mxGeometry(0, 0, 230, 100),
          "text;strokeColor=none;fillColor=none;spacing=5;spacingTop=0;whiteSpace=wrap;overflow=hidden;rounded=0;shadow=0;fontSize=15;fontColor=#FFFFFF;align=left;html=1;",
        );
        text1.vertex = true;
        ...
        var icon2 = new mxCell(
          "",
          new mxGeometry(50, 152, 50, 37),
          "shadow=0;dashed=0;html=1;strokeColor=none;shape=mxgraph.mscae.intune.user_group;fontSize=15;fontColor=#FFFFFF;align=left;",
        );
        icon2.vertex = true;

        var ribbon3 = new mxCell(
          "",
          new mxGeometry(0, 240, 500, 100),
        ...
        var icon3 = new mxCell(
          "",
          new mxGeometry(50, 272, 50, 37),
          "shadow=0;dashed=0;html=1;strokeColor=none;shape=mxgraph.mscae.intune.user_group;fontSize=15;fontColor=#FFFFFF;align=left;",
        );
        icon3.vertex = true;

        var ribbon4 = new mxCell(
          "",
          new mxGeometry(0, 360, 500, 100),
        ...
        var icon4 = new mxCell(
          "",
          new mxGeometry(50, 392, 50, 37),
          "shadow=0;dashed=0;html=1;strokeColor=none;shape=mxgraph.mscae.intune.user_group;fontSize=15;fontColor=#FFFFFF;align=left;",
        );
        icon4.vertex = true;

        var ribbon5 = new mxCell(
          "",
          new mxGeometry(0, 480, 500, 100),
        ...
        var icon5 = new mxCell(
          "",
          new mxGeometry(50, 512, 50, 37),
          "shadow=0;dashed=0;html=1;strokeColor=none;shape=mxgraph.mscae.intune.user_group;fontSize=15;fontColor=#FFFFFF;align=left;",
        );
        icon5.vertex = true;

        return sb.createVertexTemplateFromCells(
          [ribbon1, item1, icon1, ribbon2, item2, icon2, ribbon3, item3, icon3, ribbon4, item4, icon4, ribbon5, item5, icon5],
          550,
          590,
          "Ribbon List",
        );
      ...
      this.addEntry(dt + "bar graph", function () {
        ...
        part1.vertex = true;
        var dial1 = new mxCell(
          "12",
          new mxGeometry(40, 75, 40, 40),
        ...
        part2.vertex = true;
        var dial2 = new mxCell(
          "16",
          new mxGeometry(180, 75, 40, 40),
        ...
        part3.vertex = true;
        var dial3 = new mxCell(
          "8",
          new mxGeometry(300, 75, 40, 40),
        ...
        part4.vertex = true;
        var dial4 = new mxCell(
          "20",
          new mxGeometry(440, 75, 40, 40),
        ...
        part5.vertex = true;
        var dial5 = new mxCell(
          "14",
          new mxGeometry(610, 75, 40, 40),
      ...
      this.addEntry(dt + "arrow graph", function () {
        ...
        var part3 = new mxCell(
          "Label",
          new mxGeometry(100, 20, 90, 180),
          "html=1;shadow=0;dashed=0;align=center;verticalAlign=top;shape=mxgraph.arrows2.arrow;dy=0.4;dx=60;direction=north;notch=0;strokeColor=#FFFFFF;strokeWidth=6;fillColor=#AE4132;fontSize=14;labelPosition=center;verticalLabelPosition=bottom;fontStyle=1",
        );
        part3.vertex = true;

        var part4 = new mxCell(
          "Label",
          new mxGeometry(150, 90, 90, 110),
      ...
      this.addEntry(dt + "triangular diagram", function () {
        ...
        var part3 = new mxCell(
          "Label",
          new mxGeometry(120, 180, 240, 180),
        ...
        var part4 = new mxCell(
          "Label",
          new mxGeometry(240, 180, 240, 180),
      ...
      this.addEntry(dt + "roll", function () {
        ...
        var part5 = new mxCell(
          "",
          new mxGeometry(100, 100, 200, 200),
        ...
        var part6 = new mxCell(
          "",
          new mxGeometry(125, 125, 150, 150),
        ...
        var part7 = new mxCell(
          "Label",
          new mxGeometry(150, 150, 100, 100),
        ...
        ribbon5.vertex = true;
        var ribbon6 = new mxCell(
          "Label",
          new mxGeometry(200, 350, 500, 25),
        ...
        ribbon6.vertex = true;
        var ribbon7 = new mxCell(
          "Label",
          new mxGeometry(200, 375, 540, 25),
      ...
      this.addEntry(dt + "cylinder graph", function () {
        var part1 = new mxCell(
          "",
          new mxGeometry(315, 160, 100, 25),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#10739E;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#10739E;",
        );
        part1.vertex = true;
        var part2 = new mxCell(
          "",
          new mxGeometry(315, 180, 100, 25),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#F2931E;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#F2931E;",
        );
        part2.vertex = true;
        var part3 = new mxCell(
          "",
          new mxGeometry(315, 200, 100, 25),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#AE4132;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#AE4132;",
        );
        part3.vertex = true;
        var part4 = new mxCell(
          "",
          new mxGeometry(315, 220, 100, 25),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#23445D;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#23445D;",
        );
        part4.vertex = true;
        var part5 = new mxCell(
          "",
          new mxGeometry(315, 240, 100, 25),
          "verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#12AAB5;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#12AAB5;",
        );
        part5.vertex = true;

        var callout1 = new mxCell(
          "Label",
          new mxGeometry(175, 0, 130, 160),
        ...
        var callout2 = new mxCell(
          "Label",
          new mxGeometry(175, 80, 130, 110),
        ...
        var callout3 = new mxCell(
          "Label",
          new mxGeometry(175, 160, 130, 50),
        ...
        var callout4 = new mxCell(
          "Label",
          new mxGeometry(175, 230, 130, 50),
        ...
        var callout5 = new mxCell(
          "Label",
          new mxGeometry(175, 250, 130, 120),
        ...
        var text1 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
          new mxGeometry(0, 30, 240, 50),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=12;align=right;html=1;",
        );
        text1.vertex = true;
        var text2 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
          new mxGeometry(0, 110, 240, 50),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=12;align=right;html=1;",
        );
        text2.vertex = true;
        var text3 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
          new mxGeometry(0, 190, 240, 50),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=12;align=right;html=1;",
        );
        text3.vertex = true;
        var text4 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
          new mxGeometry(0, 290, 240, 50),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=12;align=right;html=1;",
        );
        text4.vertex = true;
        var text5 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
          new mxGeometry(0, 380, 240, 50),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=12;align=right;html=1;",
        );
        text5.vertex = true;

        return sb.createVertexTemplateFromCells(
          [part5, part4, part3, part2, part1, callout1, callout2, callout3, callout4, callout5, text1, text2, text3, text4, text5],
          415,
          430,
          "Cylinder Graph",
        );
      ...
      this.addEntry(dt + "swirl", function () {
        ...
        var text2 = new mxCell(
          '<b style="font-size: 7px">LABEL</b><br style="font-size: 7px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
          new mxGeometry(50, 79, 150, 40),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=7;fontColor=#FFFFFF;align=left;html=1;spacingLeft=5;",
        );
        text2.vertex = true;
        var text3 = new mxCell(
          '<b style="font-size: 7px">LABEL</b><br style="font-size: 7px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
          new mxGeometry(100, 158, 150, 40),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=7;fontColor=#FFFFFF;align=left;html=1;spacingLeft=5;",
        );
        text3.vertex = true;
        var text4 = new mxCell(
          '<b style="font-size: 7px">LABEL</b><br style="font-size: 7px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
          new mxGeometry(50, 237, 150, 40),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=7;fontColor=#FFFFFF;align=left;html=1;spacingLeft=5;",
        );
        text4.vertex = true;
        var text5 = new mxCell(
          '<b style="font-size: 7px">LABEL</b><br style="font-size: 7px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
          new mxGeometry(100, 316, 150, 40),
          "rounded=0;whiteSpace=wrap;shadow=0;strokeColor=none;strokeWidth=6;fillColor=none;fontSize=7;fontColor=#FFFFFF;align=left;html=1;spacingLeft=5;",
        );
        text5.vertex = true;
      ...
      this.addEntry(dt + "swirl", function () {
        ...
        var arc5 = new mxCell(
          "",
          new mxGeometry(130, 100, 100, 100),
        ...
        var marker1 = new mxCell(
          "1",
          new mxGeometry(0, 60, 30, 30),
        ...
        marker1.vertex = true;
        var marker2 = new mxCell(
          "2",
          new mxGeometry(40, 60, 30, 30),
        ...
        marker2.vertex = true;
        var marker3 = new mxCell(
          "3",
          new mxGeometry(80, 60, 30, 30),
      ...
      this.addEntry(dt + "roadmap vertical", function () {
        var startPoint = new mxCell(
          "",
          new mxGeometry(234, 0, 12, 12),
        ...
        var endPoint = new mxCell(
          "",
          new mxGeometry(234, 498, 12, 12),
          "ellipse;whiteSpace=wrap;html=1;aspect=fixed;shadow=0;fillColor=none;strokeColor=#333333;fontSize=16;align=center;strokeWidth=2;",
        );
        ...
        var label7 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#10739E"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(70, 70, 160, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label7.vertex = true;
        var label8 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#F2931E"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(250, 140, 160, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label8.vertex = true;
        var label9 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#AE4132"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(70, 210, 160, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label9.vertex = true;
        var label10 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#23445D"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(250, 280, 160, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label10.vertex = true;
        var label11 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#12AAB5"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(70, 350, 160, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label11.vertex = true;
        var label12 = new mxCell(
          '<font style="font-size: 10px"><font style="font-size: 12px" color="#56517E"><b>Label</b></font><br><br><font size="1">' +
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>",
          new mxGeometry(250, 420, 160, 70),
          "rounded=1;strokeColor=none;fillColor=#EEEEEE;align=center;arcSize=12;verticalAlign=top;whiteSpace=wrap;html=1;fontSize=12;",
        );
        label12.vertex = true;
        return sb.createVertexTemplateFromCells(
      ...
      this.addEntry(dt + "flower", function () {
        ...
        var part4 = new mxCell(
          "Lorem ipsum dolor sit amet, consectetur adipisicing elit",
          new mxGeometry(160, 160, 150, 150),
