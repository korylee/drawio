  ...
  Sidebar.prototype.addIosPalette = function () {
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        s + "iPad;direction=north;bgStyle=bgGreen;fillColor=#aaaaaa;sketch=0;",
        sizeY * 1.5625,
        sizeX * 2.425,
        "",
        "iPad (landscape)",
      ...
      this.createVertexTemplateEntry(
        s + "iBgStriped;strokeColor=#18211b;fillColor=#5D7585;strokeColor2=#657E8F;",
        sizeX * 0.875,
        sizeY * 0.7,
        "",
      ...
      this.createVertexTemplateEntry(
        s + "iBgMap;strokeColor=#18211b;strokeColor2=#008cff;fillColor2=#96D1FF;",
        sizeX * 0.875,
        sizeY * 0.7,
        "",
        "iPad background (map)",
      ...
      this.addEntry(null, function () {
        ...
        var text1 = new mxCell(
          "CARRIER",
          new mxGeometry(0, 2, 50, 13),
          s4 + "rect;align=left;fontSize=7.5;spacingLeft=18;fontColor=#cccccc;textOpacity=50;strokeColor=none;fillColor=none;",
        );
        text1.vertex = true;
        bg.insert(text1);
      ...
      this.createVertexTemplateEntry(
        s2 + "iButton;strokeColor=#444444;fontColor=#ffffff;buttonText=;fontSize=8;fillColor=#dddddd;fillColor2=#3D5565;whiteSpace=wrap;align=center;sketch=0;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "Button",
        "Button",
      ...
      this.createVertexTemplateEntry(
        s2 + "iButtonBack;strokeColor=#444444;fontColor=#ffffff;buttonText=;fontSize=8;fillColor=#dddddd;fillColor2=#3D5565;spacingLeft=10;whiteSpace=wrap;align=center;sketch=0;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "Button",
        "Back button",
      ...
      this.createVertexTemplateEntry(
        s2 + "iButtonFw;strokeColor=#444444;fontColor=#ffffff;buttonText=;fontSize=8;fillColor=#dddddd;fillColor2=#3D5565;spacingRight=10;whiteSpace=wrap;align=center;sketch=0;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "Button",
        "Forward button",
      ...
      this.createVertexTemplateEntry(
        s + "iPrevNext;strokeColor=#444444;fillColor=#dddddd;fillColor2=#3D5565;fillColor3=#ffffff;align=center;sketch=0;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "",
        "Prev/next button",
      ...
      this.createVertexTemplateEntry(
        s2 + "iTextInput;strokeColor=#444444;buttonText=;fontSize=8;whiteSpace=wrap;align=left;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "Default text",
        "Text input",
      ...
      this.createVertexTemplateEntry(
        s2 +
          "iComboBox;spacingTop=2;spacingLeft=2;align=left;strokeColor=#444444;fontColor=#666666;buttonText=;fontSize=8;fillColor=#dddddd;fillColor2=#3D5565;sketch=0;whiteSpace=wrap;",
        sizeX * 0.29,
        sizeY * 0.0375,
        "Option 1",
        "Combobox",
      ...
      this.createVertexTemplateEntry(
        s2 + "iOnOffButton;mainText=;strokeColor=#444444;fontSize=9;fontColor=#ffffff;spacingRight=14;buttonState=on;sketch=0;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "ON",
        "On-off button",
      ...
      this.createVertexTemplateEntry(
        s2 + "iTextInput;strokeColor=#444444;align=left;buttonText=;fontSize=8;whiteSpace=wrap;",
        sizeX * 0.2175,
        sizeY * 0.0375,
        "********",
        "Password field",
      ...
      this.createVertexTemplateEntry(
        s2 + "iLockButton;fontColor=#cccccc;fontSize=13;mainText=;spacingLeft=50;spacingRight=10;align=center;sketch=0;whiteSpace=wrap;",
        sizeX * 0.87,
        sizeY * 0.125,
        "slide to unlock",
        "Lock button",
      ...
      this.createVertexTemplateEntry(
        s + "iArrowIcon;fillColor=#8BbEff;fillColor2=#135Ec8;strokeColor=#ffffff;sketch=0;",
        sizeX * 0.075,
        sizeY * 0.0375,
        "",
        "Arrow",
      ...
      this.createVertexTemplateEntry(
        s + "iDeleteIcon;fillColor=#e8878E;fillColor2=#BD1421;strokeColor=#ffffff;sketch=0;",
        sizeX * 0.075,
        sizeY * 0.0375,
        "",
        "Delete",
      ...
      this.createVertexTemplateEntry(
        s + "iInfoIcon;fillColor=#8BbEff;fillColor2=#135Ec8;strokeColor=#ffffff;sketch=0;",
        sizeX * 0.075,
        sizeY * 0.0375,
        "",
        "Info",
      ...
      this.createVertexTemplateEntry(
        s + "iSortFindIcon;fillColor=#8BbEff;fillColor2=#135Ec8;strokeColor=#ffffff;sketch=0;",
        sizeX * 0.075,
        sizeY * 0.0375,
        "",
        "Sort/find",
      ...
      this.createVertexTemplateEntry(
        s + "iCheckIcon;fillColor=#e8878E;fillColor2=#BD1421;strokeColor=#ffffff;sketch=0;",
        sizeX * 0.075,
        sizeY * 0.0375,
        "",
        "Check",
      ...
      this.createVertexTemplateEntry(
        s + "iDeleteApp;fillColor=#cccccc;fillColor2=#000000;strokeColor=#ffffff;sketch=0;",
        sizeX * 0.075,
        sizeY * 0.0375,
        "",
        "Delete app",
      ...
      this.createVertexTemplateEntry(
        s2 + "iLocBar;align=left;spacingLeft=4;spacingBottom=4;fontColor=#ffffff;fontSize=10;barPos=80;pointerPos=bottom;buttonText=5th Street Music Store",
        sizeX * 0.775,
        sizeY * 0.08125,
        "",
        "Location bar",
      ...
      this.createVertexTemplateEntry(
        s2 + "iOption;barPos=80;pointerPos=bottom;buttonText=Option;fontSize=10;fontColor=#ffffff;spacingBottom=6;",
        sizeX * 0.375,
        sizeY * 0.06875,
        "",
        "Option",
      ...
      this.createVertexTemplateEntry(
        s2 + "iDownloadBar;verticalAlign=top;spacingTop=-4;fontSize=8;fontColor=#ffffff;buttonText=" + ";barPos=30;align=center;sketch=0;whiteSpace=wrap;",
        sizeX * 0.87,
        sizeY * 0.075,
        "Downloading 2 of 6",
        "Download bar",
      ...
      this.createVertexTemplateEntry(
        s2 + "iScreenNameBar;fillColor2=#000000;fillColor3=#ffffff;buttonText=;fontColor=#ffffff;fontSize=10;whiteSpace=wrap;align=center;sketch=0;",
        sizeX * 0.87,
        sizeY * 0.0625,
        "Screen Name",
        "Screen name bar",
      ...
      this.createVertexTemplateEntry(
        s2 + "iCopy;fillColor=#000000;buttonText=;fontColor=#ffffff;spacingBottom=6;fontSize=9;fillColor2=#000000;fillColor3=#ffffff;align=center;sketch=0;whiteSpace=wrap;",
        sizeX * 0.2,
        sizeY * 0.06875,
        "Copy",
        "Copy",
      ...
      this.addEntry(null, function () {
        var bg = new mxCell(
          "Copy",
          new mxGeometry(sizeX * 0.05, 0, sizeX * 0.2, sizeY * 0.06875),
          s4 + "iCopy;fillColor=#000000;buttonText=;fontColor=#ffffff;spacingBottom=6;fontSize=9;fillColor2=#000000;fillColor3=#ffffff;align=center;sketch=0;whiteSpace=wrap;",
        );
        bg.vertex = true;
      ...
      this.createVertexTemplateEntry(
        s + "iHomePageControl;fillColor=#666666;strokeColor=#cccccc;sketch=0;",
        sizeX * 0.25,
        sizeY * 0.0125,
        "",
        "Home page control",
