...
(function () {
  Sidebar.prototype.addGCP2Palette = function () {
    ...
    this.setCurrentSearchEntryLibrary("gcp2", "gcp2Icons Serverless");
    this.addGCP2IconsServerlessPalette();
    ...
    this.setCurrentSearchEntryLibrary("gcp2", "gcp2Icons Integration Services");
    this.addGCP2IconsIntegrationServicesPalette();
  ...
  Sidebar.prototype.addGCP2ZonesPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(s + "fillColor=#ffffff;", 120, 70, "User 1", "User 1 (Default)", null, null, this.getTagsForStencil(gn, "", dt + "user").join(" ")),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "infrastructure system").join(" "),
      ),
      this.createVertexTemplateEntry(
        s + "fillColor=#EFEBE9;",
        120,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "colo dc on premises").join(" "),
      ),
      this.createVertexTemplateEntry(s + "fillColor=#F1F8E9;", 120, 70, "System 1", "System 1", null, null, this.getTagsForStencil(gn, "", dt + "system").join(" ")),
      this.createVertexTemplateEntry(
        s + "fillColor=#FFEBEE;",
        120,
        70,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "external saas providers").join(" "),
      ),
      this.createVertexTemplateEntry(
        s + "fillColor=#FFF8E1;",
        120,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "external data sources").join(" "),
      ),
      this.createVertexTemplateEntry(
        s + "fillColor=#E0F2F1;",
        120,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "external infrastructure 3rd party").join(" "),
      ),
      this.createVertexTemplateEntry(
        s + "fillColor=#E1F5FE;",
        120,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "external infrastructure 1st party").join(" "),
      ),

      this.addDataEntry(
        dt + "project cloud service provider",
        530,
        490,
        "Project Zone / Cloud Service Provider",
        "",
      ),
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "title bar").join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "note").join(" "),
      ),

      this.addEntry(dt + "project", function () {
        var bg = new mxCell(
          "<b>Google </b>Cloud Platform",
          new mxGeometry(0, 0, 650, 350),
        ...
        var zone1Cell = new mxCell("", new mxGeometry(0, 0, 23, 20), "shape=mxgraph.gcp2.google_cloud_platform;fillColor=#F6F6F6;strokeColor=none;shadow=0;gradientColor=none;");
      ...
      this.addEntry(dt + "markers", function () {
        ...
        var label1 = new mxCell(
          "Markers to be used with the legend",
          new mxGeometry(0, 20, 260, 30),
      ...
      this.addEntry(dt + "markers", function () {
        ...
        var bg = new mxCell("", new mxGeometry(0, 0, 600, 70), "fillColor=#ffffff;strokeColor=#BDBDBD;strokeWidth=1;shadow=0;gradientColor=none;");
        bg.vertex = true;
  ...
  Sidebar.prototype.addGCP2GeneralIconsPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(n + "biomedical_trio", s * 100, s * 68, null, "Biomedical Trio", null, null, this.getTagsForStencil(gn, "", dt + "biomedical trio").join(" ")),
      this.createVertexTemplateEntry(
        n + "biomedical_beaker",
        s * 69,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "biomedical beaker").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "biomedical_test_tube",
        s * 31,
        s * 100,
        null,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "biomedical test tube").join(" "),
      ),
      this.createVertexTemplateEntry(n + "check_available", s * 100, s * 87, null, "Check Available", null, null, this.getTagsForStencil(gn, "", dt + "check available").join(" ")),
      this.createVertexTemplateEntry(
        n + "cloud_monitoring",
        s * 90,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud monitoring").join(" "),
      ),
      this.createVertexTemplateEntry(n + "repository", s * 60, s * 100, null, "Repository", null, null, this.getTagsForStencil(gn, "", dt + "repository").join(" ")),
      this.createVertexTemplateEntry(n + "compute_engine_2", s * 54, s * 100, null, "Compute Engine", null, null, this.getTagsForStencil(gn, "", dt + "compute engine").join(" ")),
      this.createVertexTemplateEntry(
        n + "capabilities",
        s * 100,
        s * 76,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "capabilities thumbs up gear").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "globe_world",
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "globe global world network upload anywhere").join(" "),
      ),
      this.createVertexTemplateEntry(n + "process", s * 84, s * 100, null, "Process", null, null, this.getTagsForStencil(gn, "", dt + "process").join(" ")),
      this.createVertexTemplateEntry(n + "arrow_cycle", s * 100, s * 95, null, "Arrow Cycle", null, null, this.getTagsForStencil(gn, "", dt + "arrow cycle").join(" ")),
      this.createVertexTemplateEntry(n + "arrows_system", s * 100, s * 95, null, "Arrows System", null, null, this.getTagsForStencil(gn, "", dt + "arrows system").join(" ")),
      this.createVertexTemplateEntry(n + "half_cloud", s * 100, s * 50, null, "Half Cloud", null, null, this.getTagsForStencil(gn, "", dt + "half cloud").join(" ")),
      this.createVertexTemplateEntry(n + "cloud", s * 100, s * 69, null, "Cloud", null, null, this.getTagsForStencil(gn, "", dt + "cloud").join(" ")),
      this.createVertexTemplateEntry(n + "speed", s * 100, s * 57, null, "Speed", null, null, this.getTagsForStencil(gn, "", dt + "speed").join(" ")),
      this.createVertexTemplateEntry(
        n + "time_clock",
        s * 86,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "time clock frozen cold overtime").join(" "),
      ),
      this.createVertexTemplateEntry(n + "loading", s * 100, s * 100, null, "Loading", null, null, this.getTagsForStencil(gn, "", dt + "loading").join(" ")),
      this.createVertexTemplateEntry(n + "clock", s * 100, s * 100, null, "Clock", null, null, this.getTagsForStencil(gn, "", dt + "clock").join(" ")),
      this.createVertexTemplateEntry(n + "check", s * 100, s * 80, null, "Check", null, null, this.getTagsForStencil(gn, "", dt + "check").join(" ")),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "check").join(" "),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(n + "lock", s * 78, s * 100, null, "Lock", null, null, this.getTagsForStencil(gn, "", dt + "lock").join(" ")),
      this.createVertexTemplateEntry(n + "cloud_security", s * 100, s * 70, null, "Cloud Security", null, null, this.getTagsForStencil(gn, "", dt + "cloud security").join(" ")),
      this.createVertexTemplateEntry(n + "cloud_checkmark", s * 100, s * 67, null, "Cloud Checkmark", null, null, this.getTagsForStencil(gn, "", dt + "cloud checkmark").join(" ")),
      this.createVertexTemplateEntry(n + "key", s * 100, s * 47, null, "Key", null, null, this.getTagsForStencil(gn, "", dt + "key").join(" ")),
      this.createVertexTemplateEntry(n + "aspect_ratio", s * 100, s * 92, null, "Aspect Ratio", null, null, this.getTagsForStencil(gn, "", dt + "aspect ratio").join(" ")),
      this.createVertexTemplateEntry(n + "scale", s * 100, s * 92, null, "Check", null, null, this.getTagsForStencil(gn, "", dt + "check scale aspect ratio").join(" ")),
      this.createVertexTemplateEntry(n + "big_query", s * 99, s * 100, null, "Big Query", null, null, this.getTagsForStencil(gn, "", dt + "big query").join(" ")),
      this.createVertexTemplateEntry(n + "search", s * 99, s * 100, null, "Search", null, null, this.getTagsForStencil(gn, "", dt + "search").join(" ")),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "search").join(" "),
      ),
      this.createVertexTemplateEntry(n + "solution", s * 99, s * 100, null, "Solution", null, null, this.getTagsForStencil(gn, "", dt + "solution").join(" ")),
      this.createVertexTemplateEntry(n + "visibility", s * 100, s * 94, null, "Visibility", null, null, this.getTagsForStencil(gn, "", dt + "visibility").join(" ")),
      this.createVertexTemplateEntry(
        n + "anomaly_detection",
        s * 78,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "anomaly detection").join(" "),
      ),
      this.createVertexTemplateEntry(n + "view_list", s * 81, s * 100, null, "View List", null, null, this.getTagsForStencil(gn, "", dt + "view list").join(" ")),
      this.createVertexTemplateEntry(n + "connected", s * 100, s * 72, null, "Admin", null, null, this.getTagsForStencil(gn, "", dt + "admin system connected").join(" ")),
      this.createVertexTemplateEntry(n + "cloud_server", s * 100, s * 89, null, "Cloud Server", null, null, this.getTagsForStencil(gn, "", dt + "cloud server").join(" ")),
      this.createVertexTemplateEntry(n + "primary", s * 100, s * 15, null, "Primary", null, null, this.getTagsForStencil(gn, "", dt + "primary").join(" ")),
      this.createVertexTemplateEntry(n + "monitor", s * 100, s * 85, null, "Monitor", null, null, this.getTagsForStencil(gn, "", dt + "monitor save help").join(" ")),
      this.createVertexTemplateEntry(n + "monitor_2", s * 100, s * 85, null, "Monitor", null, null, this.getTagsForStencil(gn, "", dt + "monitor").join(" ")),
      this.createVertexTemplateEntry(n + "website", s * 100, s * 97, null, "Website", null, null, this.getTagsForStencil(gn, "", dt + "website").join(" ")),
      this.createVertexTemplateEntry(n + "safety", s * 100, s * 96, null, "Safety", null, null, this.getTagsForStencil(gn, "", dt + "safety").join(" ")),
      this.createVertexTemplateEntry(n + "gear_load", s * 100, s * 92, null, "Gear Load", null, null, this.getTagsForStencil(gn, "", dt + "gear load").join(" ")),
      this.createVertexTemplateEntry(n + "files", s * 100, s * 97, null, "Files", null, null, this.getTagsForStencil(gn, "", dt + "files data sharing").join(" ")),
      this.createVertexTemplateEntry(n + "play_gear", s * 100, s * 100, null, "Play Gear", null, null, this.getTagsForStencil(gn, "", dt + "play gear").join(" ")),
      this.createVertexTemplateEntry(n + "play_start", s * 100, s * 100, null, "Play Start", null, null, this.getTagsForStencil(gn, "", dt + "play start").join(" ")),
      this.createVertexTemplateEntry(
        n + "replication_controller",
        s * 100,
        s * 91,
        null,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "replication controller").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "replication_controller_2",
        s * 100,
        s * 91,
        null,
        "Replication Controller",
      ...
      this.createVertexTemplateEntry(n + "repository_2", s * 94, s * 100, null, "Repository", null, null, this.getTagsForStencil(gn, "", dt + "repository upload swap").join(" ")),
      this.createVertexTemplateEntry(n + "repository_3", s * 100, s * 100, null, "Repository", null, null, this.getTagsForStencil(gn, "", dt + "repository").join(" ")),
      this.createVertexTemplateEntry(
        n + "repository_primary",
        s * 100,
        s * 100,
        null,
        "Repository",
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "repository primary").join(" "),
      ),
      this.createVertexTemplateEntry(n + "database_3", s * 70, s * 100, null, "Database", null, null, this.getTagsForStencil(gn, "", dt + "database db files").join(" ")),
      this.createVertexTemplateEntry(
        n + "database_uploading",
        s * 100,
        s * 84,
        null,
        "Database Uploading",
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "database db uploading").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "servers_stacked",
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "servers stacked").join(" "),
      ),
      this.createVertexTemplateEntry(n + "segments", s * 100, s * 100, null, "Segments", null, null, this.getTagsForStencil(gn, "", dt + "segments").join(" ")),
      this.createVertexTemplateEntry(n + "segments_2", s * 100, s * 92, null, "Segments", null, null, this.getTagsForStencil(gn, "", dt + "segments").join(" ")),
      this.createVertexTemplateEntry(
        n + "segments_overlap",
        s * 100,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "segments overlap").join(" "),
      ),
      this.createVertexTemplateEntry(n + "cost_savings", s * 66, s * 100, null, "Cost Savings", null, null, this.getTagsForStencil(gn, "", dt + "cost savings").join(" ")),
      this.createVertexTemplateEntry(n + "enhance_ui", s * 76, s * 100, null, "Enhance UI", null, null, this.getTagsForStencil(gn, "", dt + "enhance ui").join(" ")),
      this.createVertexTemplateEntry(n + "phone_android", s * 56, s * 100, null, "Phone", null, null, this.getTagsForStencil(gn, "", dt + "phone android").join(" ")),
      this.createVertexTemplateEntry(n + "cost_arrows", s * 76, s * 100, null, "Cost Arrows", null, null, this.getTagsForStencil(gn, "", dt + "cost arrows").join(" ")),
      this.createVertexTemplateEntry(
        n + "increase_cost_arrows",
        s * 100,
        s * 92,
        null,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "increase cost arrows").join(" "),
      ),
      this.createVertexTemplateEntry(n + "cost", s * 85, s * 100, null, "Cost File", null, null, this.getTagsForStencil(gn, "", dt + "cost file").join(" ")),
      this.createVertexTemplateEntry(n + "database_2", s * 78, s * 100, null, "Database", null, null, this.getTagsForStencil(gn, "", dt + "database db").join(" ")),
      this.createVertexTemplateEntry(n + "database_speed", s * 69, s * 100, null, "Database Speed", null, null, this.getTagsForStencil(gn, "", dt + "database db speed").join(" ")),
      this.createVertexTemplateEntry(n + "data_access", s * 93, s * 100, null, "Data Access", null, null, this.getTagsForStencil(gn, "", dt + "data access file gear").join(" ")),
      this.createVertexTemplateEntry(n + "database_cycle", s * 100, s * 98, null, "Database Cycle", null, null, this.getTagsForStencil(gn, "", dt + "database db cycle").join(" ")),
      this.createVertexTemplateEntry(n + "data_increase", s * 78, s * 100, null, "Data Increase", null, null, this.getTagsForStencil(gn, "", dt + "data increase").join(" ")),
      this.createVertexTemplateEntry(
        n + "data_storage_cost",
        s * 78,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "data storage cost").join(" "),
      ),
      this.createVertexTemplateEntry(n + "gear", s * 100, s * 100, null, "Gear", null, null, this.getTagsForStencil(gn, "", dt + "gear").join(" ")),
      this.createVertexTemplateEntry(n + "gear_chain", s * 100, s * 100, null, "Gear Chain", null, null, this.getTagsForStencil(gn, "", dt + "gear chain").join(" ")),
      this.createVertexTemplateEntry(n + "bucket_scale", s * 100, s * 81, null, "Bucket Scale", null, null, this.getTagsForStencil(gn, "", dt + "bucket scale").join(" ")),
      this.createVertexTemplateEntry(n + "a7_power", s * 100, s * 100, null, "A7 Power", null, null, this.getTagsForStencil(gn, "", dt + "a7 power").join(" ")),
      this.createVertexTemplateEntry(n + "gear_arrow", s * 100, s * 61, null, "Gear Arrow", null, null, this.getTagsForStencil(gn, "", dt + "gear arrow").join(" ")),
      this.createVertexTemplateEntry(n + "swap", s * 100, s * 51, null, "Swap", null, null, this.getTagsForStencil(gn, "", dt + "swap").join(" ")),
      this.createVertexTemplateEntry(n + "save", s * 100, s * 84, null, "Save", null, null, this.getTagsForStencil(gn, "", dt + "save").join(" ")),
      this.createVertexTemplateEntry(
        n + "social_media_time",
        s * 97,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "social media time").join(" "),
      ),
      this.createVertexTemplateEntry(n + "tape_record", s * 100, s * 71, null, "Tape Record", null, null, this.getTagsForStencil(gn, "", dt + "tape record").join(" ")),
      this.createVertexTemplateEntry(n + "folders", s * 100, s * 85, null, "Folders", null, null, this.getTagsForStencil(gn, "", dt + "folders extensible").join(" ")),
      this.createVertexTemplateEntry(
        n + "maps_api",
        s * 61,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "maps api application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "enhance_ui_2",
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "enhance ui user interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "certified_industry_standard",
        s * 100,
        s * 78,
        null,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "certified industry standard").join(" "),
      ),
      this.createVertexTemplateEntry(n + "calculator", s * 100, s * 74, null, "Calculator", null, null, this.getTagsForStencil(gn, "", dt + "calculator").join(" ")),
      this.createVertexTemplateEntry(n + "network", s * 100, s * 100, null, "Network", null, null, this.getTagsForStencil(gn, "", dt + "network").join(" ")),
      this.createVertexTemplateEntry(n + "cloud_computer", s * 100, s * 88, null, "Cloud Computer", null, null, this.getTagsForStencil(gn, "", dt + "cloud computer").join(" ")),
      this.createVertexTemplateEntry(
        n + "cloud_connected_insight",
        s * 100,
        s * 91,
        null,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud connected insight").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "cloud_information",
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud information portable").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "lifecycle",
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "lifecycle time folder loading").join(" "),
      ),
      this.createVertexTemplateEntry(n + "thumbs_up", s * 100, s * 100, null, "Thumbs Up", null, null, this.getTagsForStencil(gn, "", dt + "thumbs up").join(" ")),
      this.createVertexTemplateEntry(n + "loading_2", s * 93, s * 100, null, "Loading", null, null, this.getTagsForStencil(gn, "", dt + "loading").join(" ")),
      this.createVertexTemplateEntry(
        n + "internet_connection",
        s * 100,
        s * 83,
        null,
        "Internet Connection",
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "internet connection").join(" "),
      ),
      this.createVertexTemplateEntry(n + "check_scale", s * 100, s * 75, null, "Check Scale", null, null, this.getTagsForStencil(gn, "", dt + "check scale").join(" ")),
      this.createVertexTemplateEntry(n + "load_balancing", s * 100, s * 26, null, "Load Balancing", null, null, this.getTagsForStencil(gn, "", dt + "load balancing").join(" ")),
      this.createVertexTemplateEntry(n + "cloud_messaging", s * 100, s * 64, null, "Cloud Messaging", null, null, this.getTagsForStencil(gn, "", dt + "cloud messaging").join(" ")),
      this.createVertexTemplateEntry(n + "memory_card", s * 93, s * 100, null, "Memory Card", null, null, this.getTagsForStencil(gn, "", dt + "memory card").join(" ")),
      this.createVertexTemplateEntry(
        n + "admin_connected",
        s * 100,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "admin connected").join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "images service").join(" "),
      ),
      this.createVertexTemplateEntry(n + "task_queues_2", s * 100, s * 61, null, "Task Queues", null, null, this.getTagsForStencil(gn, "", dt + "task queues").join(" ")),
      this.createVertexTemplateEntry(n + "systems_check", s * 99, s * 100, null, "Systems Check", null, null, this.getTagsForStencil(gn, "", dt + "systems check").join(" ")),
      this.createVertexTemplateEntry(n + "google_network", s * 100, s * 100, null, "Google Network", null, null, this.getTagsForStencil(gn, "", dt + "google network").join(" ")),
      this.createVertexTemplateEntry(n + "check_2", s * 100, s * 100, null, "Check", null, null, this.getTagsForStencil(gn, "", dt + "check").join(" ")),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "people security management").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "search_api",
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "search api application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n + "management_security",
        s * 100,
        s * 100,
        null,
        "Management Security",
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "management security").join(" "),
      ),
      this.createVertexTemplateEntry(n + "loading_3", s * 100, s * 100, null, "Loading", null, null, this.getTagsForStencil(gn, "", dt + "loading").join(" ")),
      this.createVertexTemplateEntry(
        n + "stacked_ownership",
        s * 100,
        s * 100,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "stacked ownership").join(" "),
      ),
      this.createVertexTemplateEntry(n + "vpn", s * 100, s * 50, null, "VPN", null, null, this.getTagsForStencil(gn, "", dt + "vpn virtual private network").join(" ")),
      this.createVertexTemplateEntry(n + "node", s * 80, s * 100, null, "Node", null, null, this.getTagsForStencil(gn, "", dt + "node").join(" ")),
      this.createVertexTemplateEntry(n + "service", s * 70, s * 100, null, "Service", null, null, this.getTagsForStencil(gn, "", dt + "service").join(" ")),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "external data center").join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "external data resource").join(" "),
      ),
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "legacy cloud").join(" "),
      ),
      this.createVertexTemplateEntry(
      ...
      this.createVertexTemplateEntry(n + "mem_instances", s * 100, s * 87, null, "Mem Instances", null, null, this.getTagsForStencil(gn, "", dt + "mem instances").join(" ")),
    ];
  ...
  Sidebar.prototype.addGCP2ComputePalette = function () {
    ...
    this.addGCP2UserProductCardSet("Cloud\nFunctions", 130, 170, 60, 30, 24, dt + "functions", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Kubernetes\nEngine", 140, 180, 60, 26, 30, dt + "kubernetes engine gke", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Container-\nOptimized OS", 150, 210, 60, 30, 30, dt + "container optimized os operating sysyem", fns, icon);
  ...
  Sidebar.prototype.addGCP2APIManagementPalette = function () {
    ...
    this.addGCP2UserProductCardSet("Cloud\nEndpoints", 130, 160, 60, 30, 18, dt + "endpoints", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Apigee API\nPlatform", 140, 180, 60, 30, 30, dt + "apigee api platform application programming interface", fns, icon);

    icon =
      ";";
    this.addGCP2UserProductCardSet("Developer\nPortal", 130, 170, 60, 30, 21, dt + "developer portal", fns, icon);
  ...
  Sidebar.prototype.addGCP2SecurityPalette = function () {
    ...
    this.addGCP2UserProductCardSet("Key Management\nService", 170, 210, 60, 24, 30, dt + "key management service", fns, icon);

    icon =
      ";";
    this.addGCP2UserProductCardSet("Identity-Aware\nProxy", 160, 190, 60, 30, 15, dt + "identity aware proxy", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Security\nCommand Center", 170, 220, 60, 26, 30, dt + "command center", fns, icon);

    icon =
      ";";
    this.addGCP2UserProductCardSet("Security Key\nEnforcement", 140, 210, 60, 24, 30, dt + "key enforcement", fns, icon);
  ...
  Sidebar.prototype.addGCP2DataAnalyticsPalette = function () {
    ...
    this.addGCP2UserProductCardSet("Pub/Sub", 120, 120, 60, 27, 30, dt + "pub sub", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Dataprep", 130, 130, 60, 30, 28, dt + "dataprep", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nComposer", 130, 160, 60, 22, 30, dt + "composer", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Data\nCatalog", 120, 150, 60, 30, 27, dt + "data catalog", fns, icon);
  ...
  Sidebar.prototype.addGCP2CloudAIPalette = function () {
    ...
    this.addGCP2UserProductCardSet("Vision\nAPI", 110, 130, 60, 30, 24, dt + "vision api application programming interface", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Translation\nAPI", 140, 160, 60, 30, 27, dt + "translation api application programming interface", fns, icon);
    ...
    this.addGCP2UserProductCardSet("AutoML", 120, 120, 60, 30, 24.3, dt + "automl auto ml", fns, icon);
  ...
  Sidebar.prototype.addGCP2InternetOfThingsPalette = function () {
    ...
    this.addGCP2UserProductCardSet("IoT Core", 120, 120, 60, 30, 30, dt + "core", fns, icon);

    this.addPalette(
      "gcp2Internet of Things",
  ...
  Sidebar.prototype.addGCP2DatabasesPalette = function () {
    ...
    this.addGCP2UserProductCardSet("Cloud\nSpanner", 120, 160, 60, 30, 27, dt + "spanner", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Memorystore", 150, 150, 60, 30, 30, dt + "memorystore memory store", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Firestore", 120, 120, 60, 26, 30, dt + "firestore fire store", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Datastore", 130, 130, 60, 30, 21, dt + "datastore data store", fns, icon);

    icon =
      ";";
    this.addGCP2UserProductCardSet("AlloyDB", 120, 120, 60, 27.86, 30, dt + "alloydb alloy db database", fns, icon);
  ...
  Sidebar.prototype.addGCP2StoragePalette = function () {
    ...
    this.addGCP2UserProductCardSet("Filestore", 120, 120, 60, 30, 24, dt + "filestore file store", fns, icon);
  ...
  Sidebar.prototype.addGCP2ManagementToolsPalette = function () {
    var dt = "gcp google cloud platform management tools operations ";
    var fns = [];

    var icon =
      ";";
    this.addGCP2UserProductCardSet("Stackdriver", 140, 140, 60, 30, 26, dt + "stackdriver", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Debugger", 130, 130, 60, 24, 30, dt + "debugger", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nMonitoring", 130, 170, 60, 30, 21, dt + "monitoring", fns, icon);

    icon =
      ";";
    this.addGCP2UserProductCardSet("Deployment\nManager", 140, 190, 60, 30, 21, dt + "deployment manager", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nLogging", 120, 150, 60, 30, 28, dt + "logging", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nConsole", 120, 160, 60, 30, 30, dt + "console", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Error\nReporting", 130, 160, 60, 30, 30, dt + "error reporting", fns, icon);

    icon =
      ";";
    this.addGCP2UserProductCardSet("Cloud\nShell", 110, 140, 60, 30, 30, dt + "shell", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nAPI", 110, 130, 60, 30, 30, dt + "api apis application programming interface", fns, icon);

    this.addPalette(
      "gcp2Management Tools",
      "GCP / Operations",
      false,
      mxUtils.bind(this, function (content) {
        for (var i = 0; i < fns.length; i++) {
  ...
  Sidebar.prototype.addGCP2NetworkingPalette = function () {
    ...
    this.addGCP2UserProductCardSet("Virtual\nPrivate Cloud", 150, 190, 60, 30, 30, dt + "virtual private", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nInterconnect", 140, 180, 60, 30, 27, dt + "interconnect", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud Load\nBalancing", 140, 200, 60, 30, 30, dt + "load balancing", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nDNS", 110, 140, 60, 30, 30, dt + "dns domain name server", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nVPN", 110, 140, 60, 27, 30, dt + "vpn virtual private network", fns, icon);
    ...
    this.addGCP2UserProductCardSet("Cloud\nRouter", 120, 150, 60, 30, 30, dt + "router", fns, icon);
  ...
  Sidebar.prototype.addGCP2DeveloperToolsPalette = function () {
    var dt = "gcp google cloud platform dev developer tools ci cd ";
    var fns = [];

    var icon =
      ";";
    this.addGCP2UserProductCardSet("Cloud\nSDK", 110, 140, 60, 30, 30, dt + "sdk software development kit", fns, icon);
  ...
  Sidebar.prototype.addGCP2ExpandedProductCardsPalette = function () {
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards compute engine ", function () {
        var bg = new mxCell("", new mxGeometry(0, 0, 150, 70), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Compute Engine<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards compute engine ", function () {
        var bg = new mxCell("", new mxGeometry(0, 0, 158, 78), "shape=mxgraph.gcp2.doubleRect;fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Compute Engine<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards bigquery ", function () {
        var bg = new mxCell("", new mxGeometry(0, 0, 140, 70), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>BigQuery<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards bigquery ", function () {
        var bg = new mxCell("", new mxGeometry(0, 0, 148, 78), "shape=mxgraph.gcp2.doubleRect;fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>BigQuery<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards app engine ", function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>App Engine<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards dataflow ", function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Dataflow<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards kubernetes engine gke ", function () {
        var bg = new mxCell("", new mxGeometry(0, 0, 140, 70), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>GKE<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
        ...
        return sb.createVertexTemplateFromCells([bg], bg.geometry.width, bg.geometry.height, "GKE");
      }),
    );
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards cloud storage ", function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Cloud Storage<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards cloud bigtable ", function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Cloud Bigtable<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards cloud pub sub ", function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Cloud Pub/Sub<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    fns.push(
      this.addEntry("gcp google cloud platform expanded product cards cloud sql ", function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>Cloud SQL<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 42, 42),
          "sketch=0;dashed=0;connectable=0;html=1;part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;shape=image;image=data:image/svg+xml,;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
    ...
    this.addGCP2ExpandedMachineCard(
      "App Engine",
      "app_engine_icon",
      1,
      0.84,
  ...
  Sidebar.prototype.addGCP2IconsAIAndMachineLearningPalette = function () {
    ...
    var s = 1;
    var n =
      "sketch=0;html=1;verticalAlign=top;labelPosition=center;verticalLabelPosition=bottom;align=center;spacingTop=-6;fontSize=11;fontStyle=1;fontColor=#999999;shape=image;aspect=fixed;imageAspect=0;";
    ...
    var fns = [
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 37,
        s * 42,
        "Vertex AI",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "ai platform artificial intelligence").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 38,
        "AutoML",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "automl").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 34,
        "AutoML Natural\nLanguage",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "automl tables").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "automl translation").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud inference api application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud\nTalent Solutions",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud talent solution solutions").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud tpu").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud translation api application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "data labeling").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "speech to text").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 36,
        "Text-to-Speech",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "text to speech").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 29,
        "Video\nIntelligence API",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "recommendations ai").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 38,
        "Cloud AI",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "contact center ai artificial intelligence platform").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 34,
        s * 42,
        "Dialogflow\nEnterprise Edition",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "ai hub artificial intelligence").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 36,
        s * 42,
        "Advanced\nSolutions Lab",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "advanced solutions lab").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons AI and Machine Learning",
  ...
  Sidebar.prototype.addGCP2IconsComputePalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "compute engine").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud functions").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud run").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 34,
        "App Engine",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "app engine").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 37,
        s * 42,
        "Google Kubernetes\nEngine",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "google cloud vmware engine").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 40,
        s * 42,
        "Bare Metal\nSolution",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "bare metal solution").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "distributed cloud").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "container optimized os operating system").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "gke on-prem").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2IconsDataAnalyticsPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "bigquery").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 32,
        s * 42,
        "Cloud\nComposer",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud composer").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud Data\nFusion",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud data fusion").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Data\nCatalog",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "data catalog").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 31,
        s * 42,
        "Dataflow",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "dataflow").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 38,
        s * 42,
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "dataprep").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Dataproc",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "dataproc").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Life Sciences",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "genomics").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "pub sub").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 39,
        "Datastream",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "datastream").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 34,
        s * 42,
        "Healthcare API",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "healthcare api application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 26,
        s * 42,
        "Looker",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "dataplex").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 32,
        "Analytics Hub",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "analytics hub").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 28,
        s * 42,
        "Datalab",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "datalab").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons Data Analytics",
      "GCP Icons / Analytics",
      false,
      mxUtils.bind(this, function (content) {
        for (var i = 0; i < fns.length; i++) {
  ...
  Sidebar.prototype.addGCP2IconsOperationsPalette = function () {
    ...
    var n =
      "sketch=0;html=1;verticalAlign=top;labelPosition=center;verticalLabelPosition=bottom;align=center;spacingTop=-6;fontSize=11;fontStyle=1;fontColor=#999999;shape=image;aspect=fixed;imageAspect=0;";
    var dt = "gcp google cloud platform icons icon operations ";
    var gn = "mxgraph.gcp2";
    var fns = [];
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud apis application programming interfaces").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 29,
        "Cloud Billing API",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud billing api application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud Console",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud deployment manager").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Cloud\nLogging",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud logging").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "google cloud app").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 29,
        "Cloud\nMonitoring",
        null,
      ...
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Cloud\nShell",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud shell").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud\nDebugger",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud debugger").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "error reporting").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 36,
        s * 42,
        "Cloud Profiler",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud profiler").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "anthos service mesh").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 34,
        s * 42,
        "Debugger",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "debugger").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 36,
        "Stackdriver",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "stackdriver").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons Operations",
  ...
  Sidebar.prototype.addGCP2IconsNetworkingPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 36,
        s * 42,
        "Cloud\nArmor",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud armor").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud cdn content domain network").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud dns domain name server").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud External\nIP Addresses",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud external ip addresses internet protocol").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud Firewall\nRules",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud firewall rules").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 38,
        "Cloud\nInterconnect",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud interconnect").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud load balancing").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud\nNAT",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud nat").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Cloud\nNetwork",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud network").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Cloud\nRoutes",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud routes").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud router").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud\nVPN",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud vpn virtual private network").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 29,
        "Partner\nInterconnect",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "partner interconnect").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 21,
        "Premium\nNetwork Tier",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "premium network tier").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 21,
        "Standard\nNetwork Tier",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "traffic director").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "virtual private cloud").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 38,
        "Network\nIntelligence",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "network intelligence").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 25,
        "Cloud Domains",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud domains").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons Networking",
  ...
  Sidebar.prototype.addGCP2IconsCICDPalette = function () {
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud code").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud code for intellij").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud sdk software development kit").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud test lab").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "container registry").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "gradle app engine plugin").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 23,
        "IDE Plugins",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "ide plugins integrated development environment").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "maven app engine plugin").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "tools for powershell").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "artifact registry").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 39,
        s * 42,
        "Cloud Deploy",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud deploy").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2IconsIntegrationServicesPalette = function () {
    var sb = this;
    var s = 1;
    var n =
      "sketch=0;html=1;verticalAlign=top;labelPosition=center;verticalLabelPosition=bottom;align=center;spacingTop=-6;fontSize=11;fontStyle=1;fontColor=#999999;shape=image;aspect=fixed;imageAspect=0;";
    var dt = "gcp google cloud platform icons icon integration services ";
    var gn = "mxgraph.gcp2";
    var fns = [];
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud tasks").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Apigee API\nManagement",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "workflows").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Application\nIntegration",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "integration connectors").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Eventarc",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "eventarc").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons Integration Services",
  ...
  Sidebar.prototype.addGCP2IconsAPIManagementPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 19,
        "API Analytics",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "api analytics application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "API\nMonetization",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "api monetization application programming interface").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Apigee\nSense",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "apigee sense").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 25,
        "Cloud\nEndpoints",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud endpoints").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 29,
        "Developer\nPortal",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "developer portal").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons API Management",
  ...
  Sidebar.prototype.addGCP2IconsInternetOfThingsPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 42,
        "Cloud\nIoT Core",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud iot core internet of things").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons Internet of Things",
  ...
  Sidebar.prototype.addGCP2IconsDatabasesPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud bigtable").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud spanner").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud sql").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 29,
        "Datastore",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "datastore").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "firestore").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "memorystore").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 39,
        s * 42,
        "AlloyDB",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "database migration service").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2IconsStoragePalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud storage").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "filestore").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 34,
        s * 42,
        "Persistent\nDisk",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "data transfer").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2IconsSecurityPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud iam").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud resource manager").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 36,
        "Web Security\nScanner",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "web security scanner").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud key management").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 36,
        s * 42,
        "Security\nCommand Center",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "chronicle").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 32,
        "Data Loss\nPrevention API",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "security key enforcement").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 25,
        "Secret\nManager",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "secret manager").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2IconsServerlessPalette = function () {
    var sb = this;
    var s = 1;
    var n =
      "sketch=0;html=1;verticalAlign=top;labelPosition=center;verticalLabelPosition=bottom;align=center;spacingTop=-6;fontSize=11;fontStyle=1;fontColor=#999999;shape=image;aspect=fixed;imageAspect=0;";
    var dt = "gcp google cloud platform icons icon serverless ";
    var gn = "mxgraph.gcp2";
    var fns = [];
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "api gateway application programming interface").join(" "),
      ),
    ];

    this.addPalette(
      "gcp2Icons Serverless",
  ...
  Sidebar.prototype.addGCP2IconsMigrationPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 23,
        "Transfer\nAppliance",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "migrate to containers").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "storage transfer service").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "cloud data transfer").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "bigquery data transfer service").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2IconsHybridAndMultiCloudPalette = function () {
    ...
    var fns = [
      ...
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 36,
        "Anthos",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "anthos").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "imageAspect=0;image=data:image/svg+xml,;",
        s * 40,
        s * 42,
        "Anthos Clusters",
        null,
    ...
    this.addPalette(
      "gcp2Icons Hybrid and Multi Cloud",
  ...
  Sidebar.prototype.addGCP2IconsOpenSourceIconsPalette = function () {
    ...
    var fns = [
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 42,
        s * 40,
        "Kubernetes",
        null,
      ...
      this.createVertexTemplateEntry(
        ...
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "tensorflow").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 40,
        s * 42,
        "Forseti\nSecurity",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "forseti security").join(" "),
      ),
      this.createVertexTemplateEntry(
        n +
          "image=data:image/svg+xml,;",
        s * 27,
        s * 42,
        "Istio",
        null,
        null,
        null,
        this.getTagsForStencil(gn, "", dt + "istio").join(" "),
      ),
    ];
  ...
  Sidebar.prototype.addGCP2CardSet = function (label, icon, w1, w2, dt, fns) {
    ...
    fns.push(
      this.addEntry(dt, function () {
        ...
        var icon1 = new mxCell(
          label,
          new mxGeometry(0, 0.5, 44, 39),
          s + icon + ";part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;spacingLeft=5;fontColor=#999999;fontSize=12;",
        );
        icon1.geometry.relative = true;
    ...
    fns.push(
      this.addEntry(dt, function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>' + label1,
          new mxGeometry(0, 0.5, 44, 39),
          s + icon + ";part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;spacingLeft=5;fontColor=#999999;fontSize=12;",
        );
        icon1.geometry.relative = true;
  ...
  Sidebar.prototype.addGCP2ProductCardSet = function (label, icon, scaleX, scaleY, w1, w2, dt, fns) {
    ...
    fns.push(
      this.addEntry(dt, function () {
        var bg = new mxCell("", new mxGeometry(0, 0, w1, 60), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        bg.vertex = true;
        var icon1 = new mxCell(
          label,
          new mxGeometry(0, 0, 45 * scaleX, 45 * scaleY),
          s + icon + ";part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;spacingLeft=5;fontColor=#999999;fontSize=12;",
        );
        icon1.geometry.relative = true;
    ...
    fns.push(
      this.addEntry(dt, function () {
        var bg = new mxCell("", new mxGeometry(0, 0, w2, 60), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>' + label1,
          new mxGeometry(0, 0, 45 * scaleX, 45 * scaleY),
    ...
    fns.push(
      this.addEntry(dt, function () {
        var bg = new mxCell("", new mxGeometry(0, 0, w2 + 8, 68), "shape=mxgraph.gcp2.doubleRect;fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;");
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>' + label1,
          new mxGeometry(0, 0, 45 * scaleX, 45 * scaleY),
  ...
  Sidebar.prototype.addGCP2ServiceCard = function (label, icon, w, h, dt, fns) {
    ...
    fns.push(
      this.addEntry(dt, function () {
        ...
        var icon1 = new mxCell(
          label,
          new mxGeometry(0, 0.5, 32, 32),
          s + icon + ";part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;spacingLeft=5;fontSize=12;",
        );
        icon1.geometry.relative = true;
  ...
  Sidebar.prototype.addGCP2ExpandedProductCardSet = function (label, icon, w, dt, fns) {
    ...
    fns.push(
      this.addEntry(dt, function () {
        ...
        bg.vertex = true;
        var icon1 = new mxCell(
          '<font color="#000000">Name</font><br>' + label1 + '<hr><font style="font-size: 11px">Attribute Name</font>',
          new mxGeometry(0, 0, 44, 39),
          s + icon + ";part=1;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=top;spacingLeft=5;fontColor=#999999;fontSize=12;spacingTop=-8;",
        );
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(5, 7);
        icon1.vertex = true;
  ...
  Sidebar.prototype.addGCP2ExpandedMachineCard = function (
    label,
    mainIcon,
    aspectX,
    aspectY,
    ...
    fns.push(
      this.addEntry(dt, function () {
        var bg = new mxCell("", new mxGeometry(0, 0, w, 95), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        bg.vertex = true;

        var mainTitleCell = new mxCell(
          '<font color="#000000">' + label1 + "</font><hr>" + capacityLabel,
          new mxGeometry(0, 0, w, 50),
          "text;part=1;html=1;align=left;verticalAlign=top;spacingLeft=35;fontColor=#999999;fontSize=11;resizeWidth=1;",
        );
        mainTitleCell.geometry.relative = true;
        mainTitleCell.vertex = true;
        bg.insert(mainTitleCell);

        var mainIconCell = new mxCell("", new mxGeometry(0, 0, 25 * aspectX, 25 * aspectY), s + mainIcon + ";part=1;");
        ...
        var machineCell = new mxCell("", new mxGeometry(0, 0, 20, 20), s + machineIcon + ";part=1;");
        ...
        var machineNum1Cell = new mxCell(
          machineNum1,
          new mxGeometry(0, 0, 18, 18),
          "sketch=0;rounded=1;arcSize=50;part=1;fillColor=#3B8CF0;strokeColor=none;html=1;fontColor=#ffffff;spacingTop=-2;",
        );
        ...
        var machineNum2Cell = new mxCell(
          machineNum2,
          new mxGeometry(0, 0, 18, 18),
          "sketch=0;rounded=1;arcSize=50;part=1;fillColor=#3B8CF0;strokeColor=none;html=1;fontColor=#ffffff;spacingTop=-2;",
        );
        ...
        var storageCell = new mxCell("", new mxGeometry(0, 0, 20, 18), s + storageIcon + ";part=1;");
        ...
        var additionalModifierCell = new mxCell("", new mxGeometry(0, 0, 20, 20), s + additionalModifierIcon + ";part=1;");
    ...
    fns.push(
      this.addEntry(dt, function () {
        ...
        var mainTitleCell = new mxCell(
          '<font color="#000000">' + label1 + "</font><hr>" + capacityLabel,
          new mxGeometry(0, 0, w, 50),
          "text;connectable=0;part=1;html=1;align=left;verticalAlign=top;spacingLeft=35;fontColor=#999999;fontSize=11;resizeWidth=1;",
        );
        mainTitleCell.geometry.relative = true;
        mainTitleCell.vertex = true;
        bg.insert(mainTitleCell);
        ...
        var machineNum1Cell = new mxCell(
          machineNum1,
          new mxGeometry(0, 0, 18, 18),
          "sketch=0;connectable=0;rounded=1;arcSize=50;part=1;fillColor=#3B8CF0;strokeColor=none;html=1;fontColor=#ffffff;spacingTop=-2;",
        );
        machineNum1Cell.geometry.relative = true;
        machineNum1Cell.geometry.offset = new mxPoint(24, 69);
        machineNum1Cell.vertex = true;
  ...
  Sidebar.prototype.addGCP2UserProductCardSet = function (label, w1, w2, h, iw, ih, dt, fns, icon) {
    var offX = 30 - iw * 0.5;
    var offY = (h - ih) * 0.5;
    this.addGCP2UserProductCard(label, w1, h, iw, ih, offX, offY, dt, fns, icon, false, false);
    this.addGCP2UserProductCard(label, w2, h, iw, ih, offX, offY, dt, fns, icon, true, false);
    this.addGCP2UserProductCard(label, w2 + 8, h + 8, iw, ih, offX, offY, dt, fns, icon, true, true);
  };

  Sidebar.prototype.addGCP2UserProductCard = function (label, w, h, iw, ih, offX, offY, dt, fns, icon, funcName, expanded) {
    var sb = this;
    var s =
      "editableCssRules=.*;html=1;fontColor=#999999;shape=image;verticalLabelPosition=middle;verticalAlign=middle;labelPosition=right;align=left;spacingLeft=20;part=1;points=[];imageAspect=0;image=data:image/svg+xml,";
    var label1 = label.replace("\n", " ");
    var label1 = label1.replace("- ", "-");
    ...
    fns.push(
      this.addEntry(dt, function () {
        ...
        if (funcName) {
          label2 = '<font color="#000000">Name</font><br>' + label1;
        }
        ...
        if (expanded) {
          ...
          bg = new mxCell("", new mxGeometry(0, 0, w, h), "fillColor=#ffffff;strokeColor=#dddddd;shadow=1;strokeWidth=1;rounded=1;absoluteArcSize=1;arcSize=2;");
        }

        bg.vertex = true;

        var icon1 = new mxCell(label2, new mxGeometry(0, 0, iw, ih), s + icon);
        icon1.geometry.relative = true;
        icon1.geometry.offset = new mxPoint(offX, offY);
        icon1.vertex = true;
        bg.insert(icon1);
