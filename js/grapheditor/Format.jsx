 ...
 */
window.Format = function (editorUi, container) {
...
Format.classicFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 10 2 L 5 8 L 10 14 Z M 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.classicThinFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 4 L 3 8 L 8 12 Z M 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.openFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 8 0 L 0 8 L 8 16 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.openThinFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 8 4 L 0 8 L 8 12 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.openAsyncFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 8 4 L 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.blockFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 2 L 8 14 Z M 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.blockThinFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 4 L 8 12 Z M 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.asyncFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 6 8 L 6 4 L 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.ovalFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 A 5 5 0 0 1 5 3 A 5 5 0 0 1 11 8 A 5 5 0 0 1 5 13 A 5 5 0 0 1 0 8 Z M 10 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.diamondFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 6 2 L 12 8 L 6 14 Z M 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.diamondThinFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 3 L 16 8 L 8 13 Z M 0 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.classicMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 10 2 L 5 8 L 10 14 Z M 5 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.classicThinMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 4 L 5 8 L 8 12 Z M 5 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.blockMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 2 L 8 14 Z M 8 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.blockThinMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 4 L 8 12 Z M 8 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.asyncMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 6 8 L 6 4 L 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.ovalMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 A 5 5 0 0 1 5 3 A 5 5 0 0 1 11 8 A 5 5 0 0 1 5 13 A 5 5 0 0 1 0 8 Z M 10 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.diamondMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 6 2 L 12 8 L 6 14 Z M 12 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.diamondThinMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 3 L 16 8 L 8 13 Z M 16 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.boxMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 3 L 10 3 L 10 13 L 0 13 Z M 10 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.halfCircleMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 3 A 5 5 0 0 1 5 8 A 5 5 0 0 1 0 13 M 5 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.dashMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 2 L 12 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.crossMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 2 L 12 14 M 12 2 L 0 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.circlePlusMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 A 6 6 0 0 1 6 2 A 6 6 0 0 1 12 8 A 6 6 0 0 1 6 14 A 6 6 0 0 1 0 8 Z M 6 2 L 6 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.circleMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 A 6 6 0 0 1 6 2 A 6 6 0 0 1 12 8 A 6 6 0 0 1 6 14 A 6 6 0 0 1 0 8 Z M 12 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.ERmandOneMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 6 2 L 6 14 M 9 2 L 9 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.ERmanyMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 2 L 12 8 L 0 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.ERoneToManyMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 2 L 12 8 L 0 14 M 15 2 L 15 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.ERzeroToOneMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 8 8 A 5 5 0 0 1 13 3 A 5 5 0 0 1 18 8 A 5 5 0 0 1 13 13 A 5 5 0 0 1 8 8 Z M 0 8 L 8 8 M 18 8 L 24 8 M 4 3 L 4 13" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.ERzeroToManyMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 8 8 A 5 5 0 0 1 13 3 A 5 5 0 0 1 18 8 A 5 5 0 0 1 13 13 A 5 5 0 0 1 8 8 Z M 0 8 L 8 8 M 18 8 L 24 8 M 0 3 L 8 8 L 0 13" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.EROneMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 5 2 L 5 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.baseDashMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 2 L 0 14 M 0 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.doubleBlockMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 2 L 8 14 Z M 8 8 L 16 2 L 16 14 Z M 16 8 L 24 8" stroke="black" fill="transparent"/>',
  32,
  20,
);
Format.doubleBlockFilledMarkerImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,2)" stroke-width="2.5" d="M 0 8 L 8 2 L 8 14 Z M 8 8 L 16 2 L 16 14 Z M 16 8 L 24 8" stroke="black" fill="black"/>',
  32,
  20,
);
Format.connectionImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,3)" stroke-width="2.5" d="M 0 8 L 26 8 L 26 4 L 32 8 L 26 12 L 26 8 Z" stroke="black" fill="black"/>',
  42,
  20,
);
...
Format.pipeEdgeImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,0)" stroke-width="10.5" d="M 0 10 L 34 10" stroke="black" fill="black"/>' +
    '<path transform="translate(4,0)" stroke-width="4.5" d="M 0 10 L 34 10" stroke="lightblue" fill="black"/>',
  42,
  20,
);
Format.filledEdgeImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,0)" stroke-width="8.5" d="M 0 10 L 34 10" stroke="black" fill="black"/>' +
    '<path transform="translate(4,0)" stroke-width="4.5" d="M 0 10 L 34 10" stroke="white" fill="black"/>',
  42,
  20,
);
Format.wireEdgeImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,0)" stroke-dasharray="8 8" stroke-width="3.5" d="M 0 10 L 34 10" stroke="red" fill="black"/>' +
    '<path transform="translate(4,0)" stroke-dashoffset="8" stroke-dasharray="8 8" stroke-width="3.5" d="M 0 10 L 34 10" stroke="green" fill="black"/>',
  42,
  20,
);
Format.arrowImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,3)" stroke-width="2.5" d="M 0 6 L 24 6 L 24 2 L 32 8 L 24 14 L 24 10 L 0 10 Z" stroke="black" fill="none"/>',
  42,
  20,
);
Format.simpleArrowImage = Graph.createSvgImage(
  20,
  22,
  '<path transform="translate(4,3)" stroke-width="2.5" d="M 0 6 L 4 6 L 4 10 L 0 10 Z M 7 6 L 18 6 L 18 2 L 25 8 L 18 14 L 18 10 L 7 10 Z M 28 6 L 28 6 L 32 6 L 32 10 L 28 10 Z" stroke="black" fill="none"/>',
  42,
  20,
);
Format.straightImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,4)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 4 26 L 26 4 M 26 0 L 30 0 L 30 4 L 26 4 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.orthogonalImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,4)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 2 26 L 2 14 L 28 14 L 28 4 M 26 0 L 30 0 L 30 4 L 26 4 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.horizontalElbowImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,3)rotate(270,0,0)scale(-1,1)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 2 26 L 2 14 L 28 14 L 28 4 M 26 0 L 30 0 L 30 4 L 26 4 Z M 14 11 L 14 5 M 14 3 L 16 5 L 12 5 Z M 14 17 L 14 23 M 14 25 L 16 23 L 12 23 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.verticalElbowImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,4)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 2 26 L 2 14 L 28 14 L 28 4 M 26 0 L 30 0 L 30 4 L 26 4 Z M 14 11 L 14 5 M 14 3 L 16 5 L 12 5 Z M 14 17 L 14 23 M 14 25 L 16 23 L 12 23 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.horizontalIsometricImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,4)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 4 26 L 19 17 L 10 12 L 26 4 M 26 0 L 30 0 L 30 4 L 26 4 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.verticalIsometricImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(32,4)scale(-1,1)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 4 26 L 19 17 L 10 12 L 26 4 M 26 0 L 30 0 L 30 4 L 26 4 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.curvedImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,4)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 2 26 Q 2 14 14 14 Q 28 14 28 4 M 26 0 L 30 0 L 30 4 L 26 4 Z" stroke="black" fill="none"/>',
  36,
  36,
);
Format.entityImage = Graph.createSvgImage(
  16,
  18,
  '<path transform="translate(3,4)" stroke-width="2.5" d="M 0 26 L 4 26 L 4 30 L 0 30 Z M 4 28 L 10 28 L 20 2 L 26 2 M 26 0 L 30 0 L 30 4 L 26 4 Z" stroke="black" fill="none"/>',
  36,
  36,
);
...
Format.prototype.immediateRefresh = function () {
  ...
  var addClickHandler = mxUtils.bind(this, function (elt, panel, index, lastEntry) {
    ...
    var currentIndex = containsLabel ? this.labelIndex : graph.isSelectionEmpty() ? this.diagramIndex : this.currentIndex;

    if ((lastEntry && currentLabel == null) || index == currentIndex) {
 ...
 */
window.BaseFormatPanel = function (format, editorUi, container) {
  this.format = format;
  this.editorUi = editorUi;
  this.container = container;
  this.listeners = [];
    ...
    function (checked) {
      ...
      if (action != null) {
        ...
        try {
          ...
          ui.fireEvent(new mxEventObject("styleChanged", "keys", [key], "values", [value], "cells", temp));
        } finally {
          graph.getModel().endUpdate();
        }
      }
...
BaseFormatPanel.prototype.createColorOption = function (
  ...
  var apply = function (color, disableUpdate) {
    if (!applying) {
      ...
      value = getColorFn();
      var cssColor = mxUtils.getLightDarkColor(value != "default" ? value : defaultColorValue);
      ...
      if (!singleColorMode && mxUtils.isLightDarkColor(value) && cssColor.light != cssColor.dark) {
        div.style.background = "linear-gradient(to right bottom, " + cssColor.cssText + " 50%, " + mxUtils.invertLightDarkColor(cssColor).cssText + " 50.3%)";
      } else if (singleColorMode && darkModeOverridden) {
        // Handles special case of fixed color
        div.style.backgroundColor = isDarkModeFn() ? cssColor.dark : cssColor.light;
      }
      ...
      if (value != null && value != mxConstants.NONE && value.length > 1 && typeof value === "string") {
        var clr = value.charAt(0) == "#" ? value.substring(1).toUpperCase() : value;
  ...
  btn = mxUtils.button(
    ...
    mxUtils.bind(this, function (evt) {
      ...
      if (singleColorMode && isDarkModeFn() && mxUtils.isLightDarkColor(actualDefaultValue)) {
        actualDefaultValue = mxUtils.getLightDarkColor(defaultColorValue).dark;
      }

      this.editorUi.pickColor(
        getActualColorValue(value, true),
        function (newColor) {
          apply(newColor);
        },
 ...
 *
 */
BaseFormatPanel.prototype.createArrayCellColorOption = function (label, colorKey, defaultColor, callbackFn, setStyleFn, defaultColorValue, undefinedValue) {
  var ui = this.editorUi;
  var editor = ui.editor;
  var graph = editor.graph;
  var style = graph.getCellStyle(graph.getSelectionCell(), false);
  var value = style != null ? (style[colorKey] != null ? style[colorKey] : undefinedValue) : null;
        ...
        this.createColorOption(
          ...
          function (color) {
            ...
            try {
              ...
              ui.fireEvent(new mxEventObject("styleChanged", "keys", [colorKey], "values", [temp], "cells", cells));
            } finally {
              graph.getModel().endUpdate();
            }
          },
          defaultColor || mxConstants.NONE,
          {
            install: function (apply) {
              this.listener = function () {
                ...
                if (style != null) {
                  var value = style != null ? (style[colorKey] != null ? style[colorKey] : undefinedValue) : null;
                  values = value != null ? mxUtils.parseColorList(value) : [];
                  apply(values[i], true);
                }
              };
 ...
 *
 */
BaseFormatPanel.prototype.createCellColorOption = function (label, colorKey, defaultColor, callbackFn, setStyleFn, defaultColorValue, undefinedValue, allowArrays) {
  var ui = this.editorUi;
  var editor = ui.editor;
  var graph = editor.graph;
  ...
  function getValue() {
    ...
    return style != null ? (style[colorKey] != null ? style[colorKey] : undefinedValue) : null;
  }

  var value = getValue();

  if (value != null && allowArrays && mxUtils.parseColorList(value).length > 1) {
    return this.createArrayCellColorOption(label, colorKey, defaultColor, callbackFn, setStyleFn, defaultColorValue, undefinedValue);
  } else {
    return this.createColorOption(
      ...
      function (color) {
        ...
        try {
          ...
          ui.fireEvent(new mxEventObject("styleChanged", "keys", [colorKey], "values", [color], "cells", cells));
        } finally {
          graph.getModel().endUpdate();
        }
      },
      defaultColor || mxConstants.NONE,
      {
        install: function (apply) {
          this.listener = function () {
            ...
            if (style != null) {
              apply(style[colorKey] != null ? style[colorKey] : undefinedValue, true);
            }
          };
...
BaseFormatPanel.prototype.createRelativeOption = function (label, key, width, handler, init) {
  ...
  var input = this.addUnitInput(div, "%", 16, width, update, 10, 0, handler != null);
 ...
 * Adds the label menu items to the given menu and parent.
 */
window.ArrangePanel = function (format, editorUi, container) {
...
ArrangePanel.prototype.addGroupOps = function (div) {
  ...
  var count = this.addActions(div, ["group", "ungroup"]) + this.addActions(div, ["removeFromGroup"]);
  ...
  var ops = [
    { label: mxResources.get("reset") + "...", action: "reset" },
  ...
  for (var i = 0; i < ops.length; i++) {
    ...
    if (action == null || action.enabled) {
      ...
      option.setAttribute("title", ops[i].label + (action != null && action.shortcut != null ? " (" + action.shortcut + ")" : ""));
  ...
  if (ss.vertices.length == 1 && ss.edges.length == 0) {
    if (graph.getOpposites(graph.getEdges(ss.vertices[0]), ss.vertices[0]).length > 0) {
...
ArrangePanel.prototype.addAlign = function (div) {
  ...
  if (ss.vertices.length > 1) {
    ...
    ui.addButton(
      Editor.alignHorizontalLeftImage,
    ...
    ui.addButton(
      Editor.alignHorizontalCenterImage,
    ...
    ui.addButton(
      Editor.alignHorizontalRightImage,
    ...
    ui.addButton(
      Editor.alignVerticalMiddleImage,
    ...
    ui.addButton(
      Editor.alignVerticalBottomImage,
...
ArrangePanel.prototype.addDistribute = function (div) {
  ...
  render(() => {
    ...
    const onClickVertical = (evt) => {
      graph.distributeCells(false, null, value());
    };
    const onClickHorizontal = (evt) => {
      graph.distributeCells(true, null, value());
    };

    return (
      <>
        <div class="geFormatSectionTitle">{mxResources.get("distribute")}</div>
        <button style="width: 104px;margin-right: 2px;" title={mxResources.get("horizontal")} on:click={onClickHorizontal}>
          {mxResources.get("horizontal")}
        </button>
        <button style="width: 104px;" title={mxResources.get("vertical")} on:click={onClickVertical}>
          {mxResources.get("vertical")}
        </button>
        <br />
        <div style="margin: 6px 0 0 0; display: flex; justify-content: center; align-items: center;">
          <input value={value()} type="checkbox" id="spacingCheckbox" on:change={(e) => setValue(e.target.checked)} />
          <label for="spacingCheckbox" style="vertical-align: top; user-select: none;">
...
ArrangePanel.prototype.addGeometry = function (container) {
  ...
  var listener = mxUtils.bind(this, function (sender, evt, force) {
    ...
    if (rect.vertices.length == graph.getSelectionCount() && rect.vertices.length > 0 && rect.x != null && rect.y != null) {
      var geo = graph.getCellGeometry(rect.vertices[0]);
      div2.style.display = "";
  ...
  if (rect.movable) {
    if (rect.edges.length == 0 && rect.vertices.length == 1 && model.isEdge(model.getParent(rect.vertices[0]))) {
      var geo = graph.getCellGeometry(rect.vertices[0]);
...
ArrangePanel.prototype.addEdgeGeometry = function (container) {
  ...
  var widthUpdate = mxUtils.bind(this, function (evt) {
    ...
    if (value != mxUtils.getValue(rect.style, "width", mxCellRenderer.defaultShapes["flexArrow"].prototype.defaultWidth)) {
      ...
      ui.fireEvent(new mxEventObject("styleChanged", "keys", ["width"], "values", [value], "cells", cells));
    }
  ...
  var listener = mxUtils.bind(this, function (sender, evt, force) {
    ...
    if (rect.style.shape == "link" || rect.style.shape == "flexArrow") {
      ...
      if (force || document.activeElement != width) {
        var value = mxUtils.getValue(rect.style, "width", mxCellRenderer.defaultShapes["flexArrow"].prototype.defaultWidth);
        width.value = value + " pt";
      }
    } else {
      div.style.display = "none";
 ...
 * Adds the label menu items to the given menu and parent.
 */
window.TextFormatPanel = function (format, editorUi, container) {
  BaseFormatPanel.call(this, format, editorUi, container);
  this.init();
};
...
TextFormatPanel.prototype.addFont = function (container) {
  ...
  if (graph.cellEditor.isContentEditing()) {
    ...
    var cssMenu = ui.toolbar.addMenu(ui.menus.get("formatBlock"), mxResources.get("style"), null, cssPanel);
  ...
  var fontMenu = ui.toolbar.addMenu(ui.menus.get("fontFamily"), "Helvetica", null, fontFamilyPanel);
  ...
  var fontStyleItems = ui.toolbar.addItems(["bold", "italic", "underline"], stylePanel2, true, [Editor.boldImage, Editor.italicImage, Editor.underlineImage]);
  ...
  var left = ui.addButton(
    Editor.alignLeftImage,
    mxResources.get("left"),
    graph.cellEditor.isContentEditing()
      ? function (evt) {
          graph.cellEditor.alignText(mxConstants.ALIGN_LEFT, evt);
          ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_ALIGN], "values", [mxConstants.ALIGN_LEFT], "cells", ss.cells));
        }
      : callFn(ui.menus.createStyleChangeFunction([mxConstants.STYLE_ALIGN], [mxConstants.ALIGN_LEFT])),
    stylePanel3,
  );
  var center = ui.addButton(
    Editor.alignCenterImage,
    mxResources.get("center"),
    graph.cellEditor.isContentEditing()
      ? function (evt) {
          graph.cellEditor.alignText(mxConstants.ALIGN_CENTER, evt);
          ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_ALIGN], "values", [mxConstants.ALIGN_CENTER], "cells", ss.cells));
        }
      : callFn(ui.menus.createStyleChangeFunction([mxConstants.STYLE_ALIGN], [mxConstants.ALIGN_CENTER])),
    stylePanel3,
  );
  var right = ui.addButton(
    Editor.alignRightImage,
    mxResources.get("right"),
    graph.cellEditor.isContentEditing()
      ? function (evt) {
          graph.cellEditor.alignText(mxConstants.ALIGN_RIGHT, evt);
          ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_ALIGN], "values", [mxConstants.ALIGN_RIGHT], "cells", ss.cells));
        }
      : callFn(ui.menus.createStyleChangeFunction([mxConstants.STYLE_ALIGN], [mxConstants.ALIGN_RIGHT])),
    stylePanel3,
  );
  ...
  var top = ui.addButton(
    Editor.alignTopImage,
    mxResources.get("top"),
    callFn(ui.menus.createStyleChangeFunction([mxConstants.STYLE_VERTICAL_ALIGN], [mxConstants.ALIGN_TOP])),
    stylePanel3,
  );
  var middle = ui.addButton(
    Editor.alignMiddleImage,
    mxResources.get("middle"),
    callFn(ui.menus.createStyleChangeFunction([mxConstants.STYLE_VERTICAL_ALIGN], [mxConstants.ALIGN_MIDDLE])),
    stylePanel3,
  );
  var bottom = ui.addButton(
    Editor.alignBottomImage,
    mxResources.get("bottom"),
    callFn(ui.menus.createStyleChangeFunction([mxConstants.STYLE_VERTICAL_ALIGN], [mxConstants.ALIGN_BOTTOM])),
    stylePanel3,
  );
  ...
  for (var i = 0; i < dirs.length; i++) {
    ...
    if (dirs[i].substring(0, 9) == "vertical-") {
      mxUtils.write(dirOption, mxResources.get("vertical") + " (" + mxResources.get(dirs[i].substring(9)) + ")");
    } else {
  ...
  var rgbBgColor = "light-dark(" + mxUtils.hex2rgb(temp.light) + ", " + mxUtils.hex2rgb(temp.dark) + ")";
  ...
  var bgPanel = graph.cellEditor.isContentEditing()
    ? // Font background color option for selection text
      this.createColorOption(
        ...
        function () {
          return currentBgColor == graph.shapeBackgroundColor || currentBgColor == rgbBgColor ? "default" : currentBgColor;
        },
        function (color) {
  ...
  var borderPanel = this.createCellColorOption(mxResources.get("borderColor"), mxConstants.STYLE_LABEL_BORDERCOLOR, "default", null, null, graph.shapeForegroundColor);
  ...
  var panel = graph.cellEditor.isContentEditing()
    ? // Font color option for selection text
      this.createColorOption(
        ...
        null,
        true,
        defs[mxConstants.STYLE_FONTCOLOR] != null && defs[mxConstants.STYLE_FONTCOLOR] != "default" ? defs[mxConstants.STYLE_FONTCOLOR] : graph.shapeForegroundColor,
      )
  ...
  var textShadow = this.createCellOption(mxResources.get("shadow"), mxConstants.STYLE_TEXT_SHADOW, 0);
  ...
  var wwCells = graph.filterSelectionCells(
    mxUtils.bind(this, function (cell) {
      var state = graph.view.getState(cell);

      return state == null || graph.getModel().isEdge(cell) || graph.isAutoSizeState(state);
    }),
  );

  var wwOpt = this.createCellOption(mxResources.get("wordWrap"), mxConstants.STYLE_WHITE_SPACE, null, "wrap", "null", null, null, true, wwCells);
  ...
  if (
    ...
    ((graph.getSelectionCount() > 1 && ss.style["convertToSvg"] == "1") ||
      (graph.getSelectionCount() == 1 && state != null && state.text != null && state.text.node != null && state.text.node.getElementsByTagName("foreignObject").length == 0))
  ) {
  ...
  if (!ui.isOffline() || mxClient.IS_CHROMEAPP || EditorUi.isElectronApp) {
    ...
    convertToSvg.appendChild(ui.menus.createHelpLink("https://github.com/jgraph/drawio/discussions/5165"));
  }
  ...
  var topSpacing = this.addUnitInput(
    spacingPanel,
    this.getUnit(),
    87,
    52,
  ...
  var leftSpacing = this.addUnitInput(
    spacingPanel,
    this.getUnit(),
    158,
    52,
  ...
  var rightSpacing = this.addUnitInput(
    spacingPanel,
    this.getUnit(),
    16,
    52,
  ...
  var listener = mxUtils.bind(this, function (sender, evt, force) {
    ...
    ui.toolbar.setMenuText(fontMenu, mxUtils.getValue(ss.style, mxConstants.STYLE_FONTFAMILY, Menus.prototype.defaultFont));
  ...
  globalUpdate = this.installInputHandler(globalSpacing, mxConstants.STYLE_SPACING, 2, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  topUpdate = this.installInputHandler(topSpacing, mxConstants.STYLE_SPACING_TOP, 0, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  rightUpdate = this.installInputHandler(rightSpacing, mxConstants.STYLE_SPACING_RIGHT, 0, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  bottomUpdate = this.installInputHandler(bottomSpacing, mxConstants.STYLE_SPACING_BOTTOM, 0, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  leftUpdate = this.installInputHandler(leftSpacing, mxConstants.STYLE_SPACING_LEFT, 0, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
        ...
        window.setTimeout(
          mxUtils.bind(this, function () {
            ...
            if (node != null && graph.cellEditor.textarea != null) {
              ...
              var lineHeight = node == graph.cellEditor.textarea || node.style.lineHeight == "" ? null : node.style.lineHeight;
              var fontSize = node == graph.cellEditor.textarea || node.style.fontSize == "" ? null : getAbsoluteFontSize(css);
              ...
              if (window.getSelection) {
                ...
                for (var i = 0; i < elts.length; i++) {
                  if (selection.containsNode(elts[i], true) && elts[i].style != null) {
              ...
              if (css != null) {
                ...
                setSelected(fontStyleItems[2], css.textDecorationLine == "underline" || hasParentOrOnlyChild("U"));
                setSelected(strike, css.textDecorationLine == "line-through" || hasParentOrOnlyChild("STRIKE"));
                ...
                ui.toolbar.setMenuText(fontMenu, mxUtils.getCssFontFamily(css.fontFamily));
              }
            }
 ...
 * Adds the label menu items to the given menu and parent.
 */
window.StyleFormatPanel = function (format, editorUi, container) {
  BaseFormatPanel.call(this, format, editorUi, container);
  this.init();
};
...
StyleFormatPanel.prototype.init = function () {
  ...
  if (!ss.containsLabel && ss.cells.length > 0) {
    if (ss.containsImage && ss.vertices.length == 1 && ss.style.shape == "image" && ss.style.image != null && String(ss.style.image).substring(0, 19) == "data:image/svg+xml;") {
...
StyleFormatPanel.prototype.addSvgStyles = function (container) {
  ...
  try {
    ...
    if (exp != null) {
      ...
      var xml = window.atob ? decodeURIComponent(escape(atob(data))) : Base64.decode(data, true);
      var svg = mxUtils.parseXml(xml);

      if (svg != null) {
        var singleColorMode = svg.documentElement.style.colorScheme == "light" || mxUtils.getValue(ss.style, "darkMode", null) == "0";
        ...
        for (var i = 0; i < styles.length; i++) {
          ...
          for (var j = 0; j < rules.length; j++) {
            this.addSvgRule(container, rules[j], svg, styles[i], rules, j, regex, singleColorMode, setColorScheme);
          }
        }
      }
    }
 ...
 * Adds the label menu items to the given menu and parent.
 */
StyleFormatPanel.prototype.addSvgRule = function (container, rule, svg, styleElem, rules, ruleIndex, regex, singleColorMode, setColorScheme) {
  var ui = this.editorUi;
  var graph = ui.editor.graph;
      ...
      if (value != "" && value.substring(0, 4) != "url(") {
        ...
        if (colorValue == "transparent") {
          ...
          if (lightDark && tempSingleColorMode) {
            ...
            colorValue = "light-dark(" + colorValue + ", " + colorValue + ")";
          }
        }
        ...
        var option = this.createColorOption(
          ...
          mxUtils.bind(this, function (color) {
            rules[ruleIndex].style.setProperty(key, color == mxConstants.NONE ? "transparent" : mxUtils.getLightDarkColor(color).cssText);
            var cssTxt = "";
            ...
            graph.setCellStyles(
              ...
              "data:image/svg+xml," + (window.btoa ? btoa(unescape(encodeURIComponent(xml))) : Base64.encode(xml, true)),
...
StyleFormatPanel.prototype.addEditOps = function (div) {
  ...
  if (ss.cells.length == 1) {
    ...
    var ops = ["edit", "copyAsText", "editLink", "editShape", "editImage", "editData", "copyData", "pasteData", "editConnectionPoints", "editGeometry", "editTooltip", "editStyle"];
    var libs = null;
    ...
    if (this.editorUi.sidebar != null) {
      ...
      if (libs == null && !this.editorUi.sidebar.isSearchIndexLoaded() && ss.style.shape != null && String(ss.style.shape).substring(0, 8) == "mxgraph.") {
        libs = [];
      }
    }
...
StyleFormatPanel.prototype.addFill = function (container) {
  ...
  var directions = [mxConstants.DIRECTION_NORTH, mxConstants.DIRECTION_EAST, mxConstants.DIRECTION_SOUTH, mxConstants.DIRECTION_WEST, mxConstants.DIRECTION_RADIAL];
  ...
  var listener = mxUtils.bind(this, function () {
    ...
    if (!ss.fill || fillColor == null || fillColor == mxConstants.NONE || ss.style.shape == "filledEdge") {
      ...
      gradientPanel.style.display = ss.gradient && !ss.containsImage && (ss.style.sketch != "1" || fillStyle == "solid" || fillStyle == "auto") ? "" : "none";
    }
  });
  ...
  mxEvent.addListener(gradientSelect, "change", function (evt) {
    ...
    ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_GRADIENT_DIRECTION], "values", [gradientSelect.value], "cells", ss.cells));
    mxEvent.consume(evt);
  });

  mxEvent.addListener(fillStyleSelect, "change", function (evt) {
    graph.setCellStyles("fillStyle", fillStyleSelect.value, ss.cells);
    ui.fireEvent(new mxEventObject("styleChanged", "keys", ["fillStyle"], "values", [fillStyleSelect.value], "cells", ss.cells));
    mxEvent.consume(evt);
  });
  ...
  for (var i = 0; i < custom.length; i++) {
    if (!ignoredColors[custom[i].key]) {
      ...
      container.appendChild(
        this.createCellColorOption(custom[i].title, custom[i].key, custom[i].defaultValue, null, null, custom[i].defaultColorValue, custom[i].undefinedColor, true),
      );
    }
  }
  ...
  var addColorStyles = mxUtils.bind(this, function (colorStyles, defaultValues, defaultColor) {
    if (colorStyles != null) {
      ...
      var defaultTokens = defaultValues != null ? defaultValues.split(",") : null;

      for (var i = 0; i < tokens.length; i++) {
        if (!ignoredColors[tokens[i]]) {
          ignoredColors[tokens[i]] = true;
          var defaultValue = defaultTokens != null ? defaultTokens[mxUtils.mod(i, defaultTokens.length)] : null;
          var actualDefault = defaultValue != null ? defaultValue : "default";
          container.appendChild(this.createCellColorOption(Editor.getLabelForStylename(tokens[i]), tokens[i], actualDefault, null, null, defaultColor, defaultValue, true));
        }
      }
    }
  });

  addColorStyles(ss.style.fillColorStyles, ss.style.defaultFillColors, graph.shapeBackgroundColor);
  addColorStyles(ss.style.strokeColorStyles, ss.style.defaultStrokeColors, graph.shapeForegroundColor);
...
StyleFormatPanel.prototype.getCustomColors = function () {
  ...
  if (ss.customProperties != null) {
    for (var key in ss.customProperties) {
      ...
      if (prop != null && prop.primary && (prop.type == "color" || prop.subType == "color") && (typeof prop.isVisible !== "function" || prop.isVisible(ss, this))) {
        var defaultColor = prop.subType == "color" ? prop.subDefVal : prop.defVal;
        defaultColor = defaultColor != null ? defaultColor : graph.shapeBackgroundColor;
        result.push({
          title: prop.dispName,
          defaultValue: defaultColor,
          defaultColorValue: prop.defaultColor != null ? prop.defaultColor : defaultColor,
  ...
  if (ss.swimlane) {
    var graph = this.editorUi.editor.graph;
    result.push({ title: mxResources.get("laneColor"), key: "swimlaneFillColor", defaultValue: "default", defaultColorValue: graph.shapeBackgroundColor });
  }
...
StyleFormatPanel.prototype.addDashPattern = function (elt, pattern) {
  ...
  if (tokens.length >= 2) {
    ...
    var img = Graph.createSvgImage(
      sum,
      1,
      '<line transform="translate(0,1)" x1="0" y1="0" x2="' + sum + '" y2="0" stroke-dasharray="' + pattern + '" stroke-width="2" stroke="black"/>',
      sum,
      1,
    );
...
StyleFormatPanel.prototype.addStroke = function (container) {
  ...
  var pattern = ui.toolbar.addMenu(
    new Menu(
      mxUtils.bind(this, function (menu) {
          ...
          .addItem(
            ...
            mxUtils.bind(this, function () {
              ui.prompt(
                ...
                mxUtils.getValue(ss.style, mxConstants.STYLE_DASH_PATTERN, "8 4 1 4"),
                mxUtils.bind(this, function (newValue) {
  ...
  var edgeShape = ui.toolbar.addMenu(
    new Menu(
      mxUtils.bind(this, function (menu) {
        var keys = [mxConstants.STYLE_SHAPE, mxConstants.STYLE_STARTSIZE, mxConstants.STYLE_ENDSIZE, mxConstants.STYLE_DASHED, "width"];
        Format.processMenuIcon(
          this.editorUi.menus.styleChange(menu, "", keys, [null, null, null, null, null], "", null, null, null, true, Format.connectionImage.src),
        ).setAttribute("title", mxResources.get("line"));
        Format.processMenuIcon(
          this.editorUi.menus.styleChange(menu, "", keys, ["link", null, null, null, null], "", null, null, null, true, Format.linkEdgeImage.src),
        ).setAttribute("title", mxResources.get("link"));
        Format.processMenuIcon(
          this.editorUi.menus.styleChange(menu, "", keys, ["flexArrow", null, null, null, null], "", null, null, null, true, Format.arrowImage.src),
        ).setAttribute("title", mxResources.get("arrow"));
        Format.processMenuIcon(
          this.editorUi.menus.styleChange(menu, "", keys, ["arrow", null, null, null, null], "", null, null, null, true, Format.simpleArrowImage.src),
        ).setAttribute("title", mxResources.get("simpleArrow"));
        Format.processMenuIcon(
          this.editorUi.menus.styleChange(menu, "", keys, ["filledEdge", null, null, null, null], "", null, null, null, true, Format.filledEdgeImage.src),
        ).setAttribute("title", "Filled Edge");
        Format.processMenuIcon(
          this.editorUi.menus.styleChange(menu, "", keys, ["pipe", null, null, null, null], "", null, null, null, true, Format.pipeEdgeImage.src),
        ).setAttribute("title", "Pipe");
        Format.processMenuIcon(this.editorUi.menus.styleChange(menu, "", keys, ["wire", null, null, "1", null], "", null, null, null, true, Format.wireEdgeImage.src)).setAttribute(
          "title",
          "Wire",
        );
      }),
  ...
  var altPattern = ui.toolbar.addMenu(
    new Menu(
      mxUtils.bind(this, function (menu) {
  ...
  function update(evt) {
    ...
    if (value != mxUtils.getValue(ss.style, mxConstants.STYLE_STROKEWIDTH, 1)) {
      ...
      ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_STROKEWIDTH], "values", [value], "cells", ss.cells));
    }
  ...
  var edgeStyle = ui.toolbar.addMenu(
    new Menu(
      mxUtils.bind(this, function (menu) {
        if (ss.style.shape != "arrow") {
          ...
          ).setAttribute("title", mxResources.get("vertical"));
          Format.processMenuIcon(
            this.editorUi.menus.edgeStyleChange(
              menu,
              "",
          ...
          ).setAttribute("title", mxResources.get("horizontal"));
          Format.processMenuIcon(
            this.editorUi.menus.edgeStyleChange(
              menu,
              "",
  ...
  var lineStart = ui.toolbar.addMenu(
    new Menu(
      mxUtils.bind(this, function (menu) {
        if (ss.style.shape == "connector" || ss.style.shape == "flexArrow" || ss.style.shape == "filledEdge" || ss.style.shape == "wire" || ss.style.shape == "pipe") {
          // Copies other marker
          ...
          if (
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                ...
                [otherMarker, otherFill, mxUtils.getValue(ss.style, "endSize")],
                null,
                null,
                false,
          ...
          Format.processMenuIcon(
            this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], [mxConstants.NONE, 0], null, null, false, Format.noMarkerImage.src),
          ).setAttribute("title", mxResources.get("none"));

          if (ss.style.shape == "connector" || ss.style.shape == "filledEdge" || ss.style.shape == "wire" || ss.style.shape == "pipe") {
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                menu,
                "",
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                ...
                null,
                false,
                Format.classicThinFilledMarkerImage.src,
              ),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                ...
                null,
                false,
                Format.openFilledMarkerImage.src,
              ),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                ...
                null,
                false,
                Format.openAsyncFilledMarkerImage.src,
              ),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["async", 1], null, null, false, Format.asyncFilledMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                menu,
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["async", 0], null, null, false, Format.asyncMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                menu,
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["box", 0], null, null, false, Format.boxMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["halfCircle", 0], null, null, false, Format.halfCircleMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["dash", 0], null, null, false, Format.dashMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["cross", 0], null, null, false, Format.crossMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["circlePlus", 0], null, null, false, Format.circlePlusMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["circle", 1], null, null, false, Format.circleMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["baseDash", 0], null, null, false, Format.baseDashMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["ERone", 0], null, null, false, Format.EROneMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["ERmandOne", 0], null, null, false, Format.ERmandOneMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["ERmany", 0], null, null, false, Format.ERmanyMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["ERoneToMany", 0], null, null, false, Format.ERoneToManyMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["ERzeroToOne", 0], null, null, false, Format.ERzeroToOneMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                menu,
                ...
                null,
                false,
                Format.ERzeroToManyMarkerImage.src,
              ),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW, "startFill"], ["doubleBlock", 0], null, null, false, Format.doubleBlockMarkerImage.src),
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                menu,
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_STARTARROW], [mxConstants.ARROW_BLOCK], null, null, false, Format.blockMarkerImage.src),
  ...
  var lineEnd = ui.toolbar.addMenu(
    new Menu(
      mxUtils.bind(this, function (menu) {
        if (ss.style.shape == "connector" || ss.style.shape == "flexArrow" || ss.style.shape == "filledEdge" || ss.style.shape == "wire" || ss.style.shape == "pipe") {
          // Copies other marker
          ...
          if (
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
                ...
                [otherMarker, otherFill, mxUtils.getValue(ss.style, "startSize")],
                null,
                null,
                false,
                ui.getImageForMarker(otherMarker, otherFill, ss.style.shape, ss.style.shape),
          ...
          Format.processMenuIcon(
            this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], [mxConstants.NONE, 0], null, null, false, Format.noMarkerImage.src),
          ).setAttribute("title", mxResources.get("none"));
          ...
          if (ss.style.shape == "connector" || ss.style.shape == "filledEdge" || ss.style.shape == "wire" || ss.style.shape == "pipe") {
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["openAsync", 0], null, null, false, Format.openAsyncFilledMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["async", 1], null, null, false, Format.asyncFilledMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], [mxConstants.ARROW_BLOCK, 0], null, null, false, Format.blockMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["async", 0], null, null, false, Format.asyncMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], [mxConstants.ARROW_OVAL, 0], null, null, false, Format.ovalMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["box", 0], null, null, false, Format.boxMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["halfCircle", 0], null, null, false, Format.halfCircleMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["dash", 0], null, null, false, Format.dashMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["cross", 0], null, null, false, Format.crossMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["circlePlus", 0], null, null, false, Format.circlePlusMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["circle", 0], null, null, false, Format.circleMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["baseDash", 0], null, null, false, Format.baseDashMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["ERone", 0], null, null, false, Format.EROneMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["ERmandOne", 0], null, null, false, Format.ERmandOneMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["ERmany", 0], null, null, false, Format.ERmanyMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["ERoneToMany", 0], null, null, false, Format.ERoneToManyMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["ERzeroToOne", 0], null, null, false, Format.ERzeroToOneMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["ERzeroToMany", 0], null, null, false, Format.ERzeroToManyMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW, "endFill"], ["doubleBlock", 0], null, null, false, Format.doubleBlockMarkerImage.src),
              "scaleX(-1)",
            );
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(
            ...
            Format.processMenuIcon(
              this.editorUi.menus.edgeStyleChange(menu, "", [mxConstants.STYLE_ENDARROW], [mxConstants.ARROW_BLOCK], null, null, false, Format.blockMarkerImage.src),
              "scaleX(-1)",
            ).setAttribute("title", mxResources.get("block"));
          }
  ...
  var startSize = this.addUnitInput(
    arrowPanel,
    this.getUnit(),
    82,
    52,
  ...
  var startSpacing = this.addUnitInput(
    arrowPanel,
    this.getUnit(),
    82,
    52,
  ...
  var endSpacing = this.addUnitInput(
    arrowPanel,
    this.getUnit(),
    16,
    52,
  ...
  var listener = mxUtils.bind(this, function (sender, evt, force) {
    ...
    styleSelect.style.visibility = ss.style.shape == "connector" || ss.style.shape == "filledEdge" || ss.style.shape == "wire" || ss.style.shape == "pipe" ? "" : "hidden";
    ...
    updateArrow(mxUtils.getValue(ss.style, mxConstants.STYLE_STARTARROW, null), mxUtils.getValue(ss.style, "startFill", "1"), lineStart, "start");
    updateArrow(mxUtils.getValue(ss.style, mxConstants.STYLE_ENDARROW, null), mxUtils.getValue(ss.style, "endFill", "1"), lineEnd, "end");
  ...
  startSizeUpdate = this.installInputHandler(startSize, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_MARKERSIZE, 0, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  startSpacingUpdate = this.installInputHandler(startSpacing, mxConstants.STYLE_SOURCE_PERIMETER_SPACING, 0, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  endSizeUpdate = this.installInputHandler(endSize, mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE, 0, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  endSpacingUpdate = this.installInputHandler(endSpacing, mxConstants.STYLE_TARGET_PERIMETER_SPACING, 0, -999, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  perimeterUpdate = this.installInputHandler(perimeterSpacing, mxConstants.STYLE_PERIMETER_SPACING, 0, 0, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  ...
  if (Graph.lineJumpsEnabled && ss.edges.length > 0 && ss.vertices.length == 0 && ss.lineJumps) {
    ...
    mxEvent.addListener(styleSelect, "change", function (evt) {
      ...
      try {
        ...
        ui.fireEvent(new mxEventObject("styleChanged", "keys", ["jumpStyle"], "values", [styleSelect.value], "cells", ss.cells));
      } finally {
        graph.getModel().endUpdate();
      }
    ...
    var jumpSize = this.addUnitInput(
      container,
      this.getUnit(),
      16,
      52,
    ...
    jumpSizeUpdate = this.installInputHandler(jumpSize, "jumpSize", Graph.defaultJumpSize, 0, 999, this.getUnit(" "), null, this.isFloatUnit(), true);
  ...
  var listener = mxUtils.bind(this, function (sender, evt, force) {
    ...
    addOption(mxResources.get("sketch"), "sketch", 0, function (cells, enabled) {
      graph.updateCellStyles(
        { sketch: enabled ? "1" : null, curveFitting: enabled ? Editor.sketchDefaultCurveFitting : null, jiggle: enabled ? Editor.sketchDefaultJiggle : null },
        cells,
      );
    });
    ...
    if (ss.customProperties != null) {
      for (var key in ss.customProperties) {
        ...
        if (prop != null && prop.type == "bool" && prop.primary && (typeof prop.isVisible !== "function" || prop.isVisible(ss, this))) {
 ...
 * Adds the label menu items to the given menu and parent.
 */
window.DiagramStylePanel = function (format, editorUi, container) {
  BaseFormatPanel.call(this, format, editorUi, container);
  this.init();
};
...
DiagramStylePanel.prototype.getGlobalStyleButtons = function () {
  ...
  mxEvent.addListener(sketchDiv, "click", function (evt) {
    if (graph.isEnabled()) {
      ...
      graph.updateCellStyles(
        { sketch: value ? "1" : null, curveFitting: value ? Editor.sketchDefaultCurveFitting : null, jiggle: value ? Editor.sketchDefaultJiggle : null },
...
DiagramStylePanel.prototype.addGraphStyles = function (div) {
    ...
    if (style != null) {
      ...
      for (var key in style) {
        if (cell == null || (result[key] != null && result[key] != mxConstants.NONE) || (key != mxConstants.STYLE_FILLCOLOR && key != mxConstants.STYLE_STROKECOLOR)) {
          if (ignoreGraphStyle && model.isEdge(cell) && key == mxConstants.STYLE_FONTCOLOR) {
            result[key] = "default";
          } else {
        ...
        mxUtils.bind(this, function (evt) {
          ...
          try {
            ...
            if (!ignoreGraphStyle) {
              ...
              model.execute(new ChangeGridColor(ui, graphStyle != null && graphStyle.gridColor != null ? graphStyle.gridColor : gridColor));
            }
          } finally {
            model.endUpdate();
          }
        ...
        mxEvent.addListener(
          ...
          mxUtils.bind(this, function (evt) {
            ...
            if (!ignoreGraphStyle) {
              ...
              graph.view.gridColor = graphStyle != null && graphStyle.gridColor != null ? graphStyle.gridColor : gridColor;
            }
  ...
  var addEntries = mxUtils.bind(this, function () {
    ...
    for (var i = this.format.currentStylePage * maxEntries; i < Math.min((this.format.currentStylePage + 1) * maxEntries, Editor.styles.length); i++) {
 ...
 * Adds the label menu items to the given menu and parent.
 */
window.DiagramFormatPanel = function (format, editorUi, container) {
  BaseFormatPanel.call(this, format, editorUi, container);
  this.init();
};
  ...
  if (graph.isEnabled()) {
    if (this.showBackgroundImageOption) {
      ...
      var btn = mxUtils.button(mxResources.get("change") + "...", function (evt) {
        ui.showBackgroundImageDialog(null, ui.editor.graph.backgroundImage, ui.editor.graph.background);
        mxEvent.consume(evt);
      });
    ...
    var bgColor = this.createColorOption(
      mxResources.get("backgroundColor"),
      function () {
...
DiagramFormatPanel.prototype.addGridOption = function (container) {
  ...
  var isDarkModeFn = function () {
    return graph.getAdaptiveColors() != "none" && Editor.isDarkMode();
  };

  var defaultGridColor = "light-dark(" + mxGraphView.prototype.defaultGridColor + "," + mxGraphView.prototype.defaultDarkGridColor + ")";
  ...
  var panel = this.createColorOption(
    ...
    graph.view.gridColor,
    {
      install: function (apply) {
        this.listener = function () {
          apply(graph.isGridEnabled() ? graph.view.gridColor : mxConstants.NONE);
        };
