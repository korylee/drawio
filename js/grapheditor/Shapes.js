...
(function () {
  ...
  TableLineShape.prototype.updateBoundsFromLine = function () {
    ...
    if (this.line != null) {
      for (var i = 0; i < this.line.length; i++) {
        ...
        if (curr != null) {
          var temp = new mxRectangle(curr.x, curr.y, this.strokewidth, this.strokewidth);
  ...
  TableShape.prototype.paintVertexShape = function (c, x, y, w, h) {
    ...
    var collapsed = this.state != null ? this.state.view.graph.isCellCollapsed(this.state.cell) : false;
  ...
  TableShape.prototype.paintTableForeground = function (c, x, y, w, h) {
    var lines = this.state.view.graph.getTableLines(
      this.state.cell,
  ...
  CurlyBracketShape.prototype.redrawPath = function (c, x, y, w, h) {
    ...
    this.addPoints(
      c,
      [new mxPoint(w, 0), new mxPoint(s, 0), new mxPoint(s, h / 2), new mxPoint(0, h / 2), new mxPoint(s, h / 2), new mxPoint(s, h), new mxPoint(w, h)],
      this.isRounded,
      arcSize,
      false,
    );
  ...
  mxRectangleShape.prototype.isHtmlAllowed = function () {
    return (
      !this.outline &&
      (this.style == null || (mxUtils.getValue(this.style, "comic", "0") == "0" && mxUtils.getValue(this.style, "sketch", urlParams["rough"] == "1" ? "1" : "0") == "0")) &&
  ...
  ProcessShape.prototype.getLabelBounds = function (rect) {
    if (
      ...
      (this.direction == null || this.direction == mxConstants.DIRECTION_EAST || this.direction == mxConstants.DIRECTION_WEST)
    ) {
      var w = rect.width;
      var h = rect.height;
  ...
  StepShape.prototype.redrawPath = function (c, x, y, w, h) {
    ...
    this.addPoints(
      c,
      [new mxPoint(0, 0), new mxPoint(w - s, 0), new mxPoint(w, h / 2), new mxPoint(w - s, h), new mxPoint(0, h), new mxPoint(s, h / 2)],
      this.isRounded,
      arcSize,
      true,
    );
  ...
  HexagonShape.prototype.redrawPath = function (c, x, y, w, h) {
    ...
    this.addPoints(
      c,
      [new mxPoint(s, 0), new mxPoint(w - s, 0), new mxPoint(w, 0.5 * h), new mxPoint(w - s, h), new mxPoint(s, h), new mxPoint(0, 0.5 * h)],
      this.isRounded,
      arcSize,
      true,
    );
  ...
  UmlFrame.prototype.configurePointerEvents = function (c) {
    ...
    if (
      this.style != null &&
      (bg == null || bg == mxConstants.NONE || this.opacity == 0 || this.fillOpacity == 0) &&
  ...
  mxPerimeter.CalloutPerimeter = function (bounds, vertex, next, orthogonal) {
    return mxPerimeter.RectanglePerimeter(
      mxUtils.getDirectedBounds(
        bounds,
        new mxRectangle(0, 0, 0, Math.max(0, Math.min(bounds.height, parseFloat(mxUtils.getValue(vertex.style, "size", CalloutShape.prototype.size)) * vertex.view.scale))),
        vertex.style,
      ),
      vertex,
      next,
  ...
  SingleArrowShape.prototype.redrawPath = function (c, x, y, w, h) {
    ...
    this.addPoints(
      c,
      [new mxPoint(0, at), new mxPoint(w - as, at), new mxPoint(w - as, 0), new mxPoint(w, h / 2), new mxPoint(w - as, h), new mxPoint(w - as, ab), new mxPoint(0, ab)],
      this.isRounded,
      arcSize,
      true,
    );
  ...
  LoopLimitShape.prototype.redrawPath = function (c, x, y, w, h) {
    ...
    this.addPoints(
      c,
      [new mxPoint(s, 0), new mxPoint(w - s, 0), new mxPoint(w, s * 0.8), new mxPoint(w, h), new mxPoint(0, h), new mxPoint(0, s * 0.8)],
      this.isRounded,
      arcSize,
      true,
    );
  ...
  mxShapeBasicRect2.prototype.paintNW = function (c, x, y, w, h, rectStyle, topLeftStyle, size, left) {
    if (!left) {
      ...
      topLeftStyle == "rounded" ||
      (topLeftStyle == "default" && rectStyle == "rounded") ||
      topLeftStyle == "invRound" ||
      (topLeftStyle == "default" && rectStyle == "invRound")
    ) {
      var inv = 0;
    ...
    } else if (topLeftStyle == "snip" || (topLeftStyle == "default" && rectStyle == "snip") || topLeftStyle == "fold" || (topLeftStyle == "default" && rectStyle == "fold")) {
      c.lineTo(size, 0);
    }
  };
  ...
  mxShapeBasicRect2.prototype.paintNE = function (c, x, y, w, h, rectStyle, topRightStyle, size, top) {
    if (!top) {
      ...
      topRightStyle == "rounded" ||
      (topRightStyle == "default" && rectStyle == "rounded") ||
      topRightStyle == "invRound" ||
      (topRightStyle == "default" && rectStyle == "invRound")
    ) {
      var inv = 0;
    ...
    } else if (topRightStyle == "snip" || (topRightStyle == "default" && rectStyle == "snip") || topRightStyle == "fold" || (topRightStyle == "default" && rectStyle == "fold")) {
      c.lineTo(w, size);
    }
  };
  ...
  mxShapeBasicRect2.prototype.paintSE = function (c, x, y, w, h, rectStyle, bottomRightStyle, size, right) {
    if (!right) {
      ...
      bottomRightStyle == "rounded" ||
      (bottomRightStyle == "default" && rectStyle == "rounded") ||
      bottomRightStyle == "invRound" ||
      (bottomRightStyle == "default" && rectStyle == "invRound")
    ) {
      var inv = 0;
      ...
      bottomRightStyle == "snip" ||
      (bottomRightStyle == "default" && rectStyle == "snip") ||
      bottomRightStyle == "fold" ||
      (bottomRightStyle == "default" && rectStyle == "fold")
    ) {
      c.lineTo(w - size, h);
    }
  };
  ...
  mxShapeBasicRect2.prototype.paintSW = function (c, x, y, w, h, rectStyle, bottomLeftStyle, size, bottom) {
    if (!bottom) {
      ...
      bottomLeftStyle == "rounded" ||
      (bottomLeftStyle == "default" && rectStyle == "rounded") ||
      bottomLeftStyle == "invRound" ||
      (bottomLeftStyle == "default" && rectStyle == "invRound")
    ) {
      var inv = 0;
      ...
      bottomLeftStyle == "snip" ||
      (bottomLeftStyle == "default" && rectStyle == "snip") ||
      bottomLeftStyle == "fold" ||
      (bottomLeftStyle == "default" && rectStyle == "fold")
    ) {
      c.lineTo(0, h - size);
    }
  };
  ...
  mxShapeBasicRect2.prototype.paintTopInner = function (c, x, y, w, h, rectStyle, topLeftStyle, size, indent, left, top) {
    ...
    } else if (topLeftStyle == "rounded" || (topLeftStyle == "default" && rectStyle == "rounded") || topLeftStyle == "snip" || (topLeftStyle == "default" && rectStyle == "snip")) {
  ...
  mxShapeBasicRect2.prototype.paintRightInner = function (c, x, y, w, h, rectStyle, topRightStyle, size, indent, top, right) {
    if (!top && !right) {
      ...
      (topRightStyle == "default" && rectStyle == "rounded") ||
      topRightStyle == "snip" ||
      (topRightStyle == "default" && rectStyle == "snip")
    ) {
  ...
  mxShapeBasicRect2.prototype.moveNEInner = function (c, x, y, w, h, rectStyle, topRightStyle, size, indent, right) {
    if (!right) {
      ...
      (topRightStyle == "default" && rectStyle == "invRound") ||
      topRightStyle == "fold" ||
      (topRightStyle == "default" && rectStyle == "fold")
    ) {
  ...
  mxShapeBasicRect2.prototype.moveNWInner = function (c, x, y, w, h, rectStyle, topLeftStyle, size, indent, top, left) {
    if (!top && !left) {
      ...
      (topLeftStyle == "default" && rectStyle == "invRound") ||
      topLeftStyle == "fold" ||
      (topLeftStyle == "default" && rectStyle == "fold")
    ) {
        ...
        handles.push(
          createHandle(
            ...
            function (me) {
              ...
              if (!mxEvent.isShiftDown(me.getEvent()) && !mxEvent.isControlDown(me.getEvent()) && (graph.isTableRow(state.cell) || graph.isTableCell(state.cell))) {
                ...
                for (var i = 0; i < cells.length; i++) {
                  ...
                  if (cells[i] != state.cell && graph.isSwimlane(cells[i]) && graph.getSwimlaneDirection(graph.getCurrentCellStyle(cells[i])) == dir) {
                    temp.push(cells[i]);
                  }
                }
      ...
      note2: function (state) {
        return [
          createHandle(
            ...
            ["size"],
            function (bounds) {
              var size = Math.max(0, Math.min(bounds.width, Math.min(bounds.height, parseFloat(mxUtils.getValue(this.state.style, "size", NoteShape2.prototype.size)))));
