...
Actions.prototype.init = function () {
  ...
  this.addAction("editDiagram...", function () {
    ...
    ui.showDialog(dlg.container, 620, 420, true, false, null, null, null, new mxRectangle(0, 0, 440, 280));
    dlg.init();
  }).isEnabled = isGraphEnabled;
  ...
  this.addAction(
    ...
    null,
    "",
    !mxClient.IS_WIN ? Editor.ctrlKey + "+" + Editor.shiftKey + "+Z" : Editor.ctrlKey + "+Y",
  );
  this.addAction(
    "cut",
    function () {
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+F",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+V",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+B",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+E",
  );
  ...
  this.put(
    "selectConnections",
    new Action("selectEdges", function (evt) {
      var cell = graph.getSelectionCell();
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+I",
  );
  this.addAction(
    "selectEdges",
    function () {
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+E",
  );
  this.addAction(
    "selectAll",
    function () {
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+A",
  );
  this.addAction(
    "lockUnlock",
    function () {
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+Home",
  );
  this.addAction(
    "enterGroup",
    function () {
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+End",
  );
  this.addAction(
    "collapse",
    function () {
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+F",
  );
  this.addAction(
    "toBack",
    function () {
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+B",
  );
  this.addAction(
    "bringForward",
    function (evt) {
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+U",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+T",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+L",
  );
  this.put(
    "insertImage",
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+Y",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+H",
  );
  this.addAction(
    "fitPage",
    mxUtils.bind(this, function () {
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+J",
  );
  this.addAction(
    "fitPageWidth",
    mxUtils.bind(this, function () {
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+G",
  );
  ...
  action.setToggleAction(true);
  action.setSelectedCallback(function () {
    return Editor.enableAnimations;
  });
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+A",
  );
  action.setToggleAction(true);
  action.setSelectedCallback(function () {
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+O",
  );
  action.setToggleAction(true);
  action.setSelectedCallback(function () {
  ...
  this.addAction("solid", function () {
    ...
    try {
      ...
      ui.fireEvent(
        new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_DASHED, mxConstants.STYLE_DASH_PATTERN], "values", [null, null], "cells", graph.getSelectionCells()),
      );
    } finally {
      graph.getModel().endUpdate();
    }
  ...
  this.addAction("dashed", function () {
    ...
    try {
      ...
      graph.setCellStyles(mxConstants.STYLE_DASH_PATTERN, null);
      ui.fireEvent(
        new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_DASHED, mxConstants.STYLE_DASH_PATTERN], "values", ["1", null], "cells", graph.getSelectionCells()),
      );
    } finally {
      graph.getModel().endUpdate();
    }
  ...
  this.addAction("dotted", function () {
    ...
    try {
      ...
      ui.fireEvent(
        new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_DASHED, mxConstants.STYLE_DASH_PATTERN], "values", ["1", "1 4"], "cells", graph.getSelectionCells()),
      );
    } finally {
      graph.getModel().endUpdate();
    }
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+D",
  );
  this.addAction(
    "clearDefaultStyle",
    function () {
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+R",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+R",
  );
  action = this.addAction(
    "subscript",
    mxUtils.bind(this, function () {
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + " + (Numpad)",
  );
  action = this.addAction(
    "increaseFontSize",
    mxUtils.bind(this, function () {
          ...
          if (graph.cellEditor.isContentEditing()) {
            ...
            if (newValue != null && (newValue.length > 0 || cells.length > 0)) {
              ...
              try {
                ...
                if (cells.length == 0) {
                  cells = [
                    graph.insertVertex(graph.getDefaultParent(), null, "", 0, 0, w, h, "shape=image;imageAspect=0;aspect=fixed;verticalLabelPosition=bottom;verticalAlign=top;"),
                  ];
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+L",
  );
  action.setToggleAction(true);
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+P",
  );
  action.setToggleAction(true);
  action.setSelectedCallback(
    mxUtils.bind(this, function () {
  ...
  action = this.addAction(
    ...
    null,
    null,
    Editor.ctrlKey + "+" + Editor.shiftKey + "+O",
  );
  ...
  this.addAction(
    ...
    null,
    null,
    Editor.altKey + "+" + Editor.shiftKey + "+Q",
  ).isEnabled = isGraphEnabled;
};
