...
Toolbar.prototype.init = function () {
  ...
  this.addItems(["zoomIn", "zoomOut"], null, null, [Editor.zoomInImage, Editor.zoomOutImage], 460);
  ...
  this.addItems(["insertFreehand", "generate"], null, null, [Editor.freehandImage, Editor.sparklesImage], 600);
...
Toolbar.prototype.createTextToolbar = function () {
  ...
  this.addItems(["-", "undo", "redo"], null, null, [null, Editor.undoImage, Editor.redoImage], 560);
  this.addItems(["-", "bold", "italic", "underline"], null, null, [null, Editor.boldImage, Editor.italicImage, Editor.underlineImage], 460);
      ...
      mxUtils.bind(this, function (menu) {
        elt = menu.addItem(
          ...
          mxUtils.bind(this, function (evt) {
            ...
            ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_ALIGN], "values", [mxConstants.ALIGN_LEFT], "cells", [graph.cellEditor.getEditingCell()]));
          }),
        );
        ...
        elt = menu.addItem(
          ...
          mxUtils.bind(this, function (evt) {
            ...
            ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_ALIGN], "values", [mxConstants.ALIGN_CENTER], "cells", [graph.cellEditor.getEditingCell()]));
          }),
        );
        ...
        elt = menu.addItem(
          ...
          mxUtils.bind(this, function (evt) {
            ...
            ui.fireEvent(new mxEventObject("styleChanged", "keys", [mxConstants.STYLE_ALIGN], "values", [mxConstants.ALIGN_RIGHT], "cells", [graph.cellEditor.getEditingCell()]));
          }),
        );
  ...
  this.editorUi
    ...
    .setAttribute("data-min-width", 780);
...
Toolbar.prototype.addItems = function (keys, c, ignoreDisabled, icons, minWidth) {
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    if (key == "-") {
      ...
      var elt = this.addItem(icons != null ? icons[i] : null, key, c, ignoreDisabled);
...
Toolbar.prototype.addItem = function (sprite, key, container) {
  ...
  if (action != null) {
    elt = this.editorUi.addButton(sprite, "", action.funct, container != null ? container : this.container);
