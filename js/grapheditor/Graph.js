...
(function () {
  try {
    if (navigator != null && navigator.language != null) {
      ...
      mxGraph.prototype.pageFormat = lang === "en-us" || lang === "en-ca" || lang === "es-mx" ? mxConstants.PAGE_FORMAT_LETTER_PORTRAIT : mxConstants.PAGE_FORMAT_A4_PORTRAIT;
    }
  } catch (e) {
    // ignore
  }
...
mxImageShape.prototype.getImageDataUri = function () {
  ...
  if (src.substring(0, 26) == "data:image/svg+xml;base64," && this.style != null && mxUtils.getValue(this.style, "clipSvg", "0") == "1") {
...
Graph = function (container, model, renderHint, stylesheet, themes, standalone) {
  ...
  if (this.immediateHandling) {
          ...
          if (!mxEvent.isAltDown(me.getEvent()) && state != null) {
            ...
            if (!this.panningHandler.isActive() && !mxEvent.isControlDown(me.getEvent())) {
              ...
              if (handler == null || handler.getHandleForEvent(me) == null) {
                ...
                var tol = mxEvent.isTouchEvent(me.getEvent()) ? mxShape.prototype.svgStrokeTolerance - 1 : (mxShape.prototype.svgStrokeTolerance + 2) / 2;
                var t1 = tol + 2;
                box.grow(tol);
                ...
                if (
                  ...
                  if (!this.isCellSelected(table)) {
                    ...
                    if (
                      (this.model.getChildAt(table, 0) != row && mxUtils.intersects(box, new mxRectangle(state.x, state.y - b, state.width, b2))) ||
                      (this.model.getChildAt(row, 0) != state.cell && mxUtils.intersects(box, new mxRectangle(state.x - b, state.y, b2, state.height))) ||
                ...
                while (!me.isConsumed() && current != null && (this.isTableCell(current.cell) || this.isTableRow(current.cell) || this.isTable(current.cell))) {
                  if (this.isSwimlane(current.cell) && this.isCellMovable(current.cell)) {
                    ...
                    if (
                      ((offset.x > 0 || offset.width > 0) &&
                        mxUtils.intersects(
                          box,
                          new mxRectangle(current.x + (offset.x - offset.width - 1) * s + (offset.x == 0 ? current.width : 0), current.y, 1, current.height),
                        )) ||
                      ((offset.y > 0 || offset.height > 0) &&
                        mxUtils.intersects(
                          box,
                          new mxRectangle(current.x, current.y + (offset.y - offset.height - 1) * s + (offset.y == 0 ? current.height : 0), current.width, 1),
                        ))
                    ) {
    ...
    // Uses this event to process mouseDown to check the selection state before it is changed
    this.addListener(
      mxEvent.CONSUME_MOUSE_EVENT,
      mxUtils.bind(this, function (sender, evt) {
        if (evt.getProperty("eventName") == "mouseDown" && this.isEnabled()) {
          var me = evt.getProperty("event");
          var state = me.getState();

          if (!mxEvent.isAltDown(me.getEvent()) && !mxEvent.isControlDown(evt) && !mxEvent.isShiftDown(evt) && !initialSelected && state != null && this.model.isEdge(state.cell)) {
            start.point = new mxPoint(me.getGraphX(), me.getGraphY());
            start.selected = this.isCellSelected(state.cell);
            start.state = state;
            start.event = me;

            if (state.text != null && state.text.boundingBox != null && mxUtils.contains(state.text.boundingBox, me.getGraphX(), me.getGraphY())) {
      ...
      mouseMove: mxUtils.bind(this, function (sender, me) {
        ...
        if (this.isEnabled() && !this.panningHandler.isActive() && !mxEvent.isAltDown(me.getEvent())) {
          ...
          if (start.point != null && start.state != null && start.event != null) {
            ...
            if (start.handle != null || Math.abs(start.point.x - me.getGraphX()) > tol || Math.abs(start.point.y - me.getGraphY()) > tol) {
              var handler = null;
              ...
              if (handler != null && handler.bends != null && handler.bends.length > 0) {
                ...
                var handle = start.handle != null ? start.handle : handler.getHandleForEvent(start.event);
                ...
                if (handle != mxEvent.LABEL_HANDLE && pts != null) {
                  ...
                  if (handle == null) {
                    ...
                    } else if (pts != null && ((edgeStyle == null && handle == null) || edgeStyle == mxEdgeStyle.SegmentConnector || edgeStyle == mxEdgeStyle.OrthConnector)) {
                ...
                var validEdge = !entity && (state.visibleSourceState != null || state.visibleTargetState != null);
                var validHandle = handle == mxEvent.LABEL_HANDLE || handle == 0 || handle == handler.bends.length - 1;
            ...
            if (state != null && this.isCellEditable(state.cell)) {
              ...
              if (
                ...
                (this.isSwimlane(parent) || this.model.isLayer(parent) || this.getCurrentRoot() == parent)
              ) {
                ...
                if (pts != null) {
                  if (state.text != null && state.text.boundingBox != null && mxUtils.contains(state.text.boundingBox, me.getGraphX(), me.getGraphY())) {
                    ...
                    if (edgeStyle != mxEdgeStyle.EntityRelation && (state.visibleSourceState != null || state.visibleTargetState != null)) {
                      cursor = "crosshair";

                      if (edgeStyle == mxEdgeStyle.SegmentConnector || edgeStyle == mxEdgeStyle.OrthConnector) {
                ...
                if (this.isTableCell(state.cell) && this.isCellMovable(state.cell)) {
                  ...
                  if (!this.isCellSelected(table)) {
                    if (
                      (mxUtils.intersects(box, new mxRectangle(state.x, state.y - 2, state.width, 4)) && this.model.getChildAt(table, 0) != row) ||
                      mxUtils.intersects(box, new mxRectangle(state.x, state.y + state.height - 2, state.width, 4))
                    ) {
                      cursor = "row-resize";
                    } else if (
                      (mxUtils.intersects(box, new mxRectangle(state.x - 2, state.y, 4, state.height)) && this.model.getChildAt(row, 0) != state.cell) ||
                      mxUtils.intersects(box, new mxRectangle(state.x + state.width - 2, state.y, 4, state.height))
                    ) {
                      cursor = "col-resize";
                    }
                  }
                ...
                while (cursor == null && current != null && (this.isTableCell(current.cell) || this.isTableRow(current.cell) || this.isTable(current.cell))) {
                  if (this.isSwimlane(current.cell) && this.isCellMovable(current.cell)) {
                    var offset = this.getActualStartSize(current.cell);
                    var s = this.view.scale;
                    ...
                    if (
                      ...
                      mxUtils.intersects(
                        box,
                        new mxRectangle(current.x + (offset.x - offset.width - 1) * s + (offset.x == 0 ? current.width * s : 0), current.y, 1, current.height),
                      )
                    ) {
                      cursor = "col-resize";
                    } else if (
                      (offset.y > 0 || offset.height > 0) &&
                      mxUtils.intersects(box, new mxRectangle(current.x, current.y + (offset.y - offset.height - 1) * s + (offset.y == 0 ? current.height : 0), current.width, 1))
                    ) {
                      cursor = "row-resize";
                    }
                  }
    ...
    if (state.view.graph.isHtmlLabel(state.cell)) {
      if (mxUtils.getValue(state.style, "html", "0") == "0") {
        ...
        if (state.lastLabelValue != result) {
          ...
          if (Graph.addLightDarkColors(tempDiv, null, state.view.graph.getAdaptiveColors() == "simple")) {
  ...
  if (typeof mxVertexHandler !== "undefined") {
      ...
      for (var i = 0; i < cells.length; i++) {
        ...
        var cell =
          this.graph.isTableCell(initialCell) && this.graph.isTableCell(cells[i]) && this.graph.isCellSelected(cells[i])
            ...
            : this.graph.isTableRow(initialCell) && this.graph.isTableRow(cells[i]) && this.graph.isCellSelected(cells[i])
              ? cells[i]
    ...
    this.connectionHandler.isOutlineConnectEvent = function (me) {
      if (mxEvent.isShiftDown(me.getEvent()) && mxEvent.isAltDown(me.getEvent())) {
        ...
        return (
          ...
          ((this.currentState == null || mxUtils.getValue(this.currentState.style, "outlineConnect", "1") != "0") && connectionHandleIsOutlineConnectEvent.apply(this, arguments))
        );
      }
    };
    ...
    this.click = function (me) {
      var locked = me.state == null && me.sourceState != null && this.isCellLocked(this.getLayerForCell(me.sourceState.cell));
    ...
    this.selectRegion = function (rect, evt) {
      ...
      var cells = this.getCells(rect.x, rect.y, rect.width, rect.height, null, null, isect, null, true);
          ...
          me.state = this.view.getState(
            this.getCellAt(
              ...
              mxUtils.bind(this, function (state, x, y) {
                return me.state == state || (this.isCellLocked(this.getLayerForCell(state.cell)) && this.getLinkForCell(state.cell) == null);
              }),
            ),
          );
        } else {
    ...
    this.isCellSelectable = function (cell) {
      return graphIsCellSelectable.apply(this, arguments) && !this.isCellLocked(this.getLayerForCell(cell));
    };
    ...
    this.connectionHandler.constraintHandler.isStateIgnored = function (state, source) {
      ...
      return source && (graph.isCellSelected(state.cell) || (graph.isTableRow(state.cell) && graph.selectionCellsHandler.isHandled(graph.model.getParent(state.cell))));
    };
 ...
 */
Graph.cellStyles = mxUtils.addItems(
  mxUtils.addItems(
    mxUtils.addItems(
      [
        "rounded",
 ...
 */
Graph.defaultAdaptiveColors = window.mxIsElectron || urlParams["contrast"] == "0" ? "simple" : "auto";

/**
 * Default value for adaptiveColors. Default is 'auto'.
 */
Graph.getDefaultAdaptiveColorsKey = function () {
  return Graph.defaultAdaptiveColors == "auto" ? "automatic" : Graph.defaultAdaptiveColors;
};
  ...
  var tmp = unescape(
    encodeURIComponent(
      Graph.svgDoctype +
        ...
        'version="1.1" style="color-scheme: light dark;">' +
        data +
        "</svg>",
    ),
  );
...
Graph.createSvgNode = function (x, y, w, h, lightDarkColor) {
  ...
  if (lightDarkColor != null) {
    root.setAttribute("style", "background: " + lightDarkColor.light + "; background-color: " + lightDarkColor.cssText + ";");
  }
...
Graph.addLightDarkColors = function (node, attrName, useLightColor, visitor) {
  ...
  function replaceColor(elt, key, value) {
    if (visitor != null) {
      ...
      var cssColor = mxUtils.getLightDarkColor(value, null, null, useLightColor);
  ...
  if (elt.nodeType == mxConstants.NODETYPE_ELEMENT) {
    try {
      ...
      if (temp != null) {
        ...
        if (originalStyles != null && originalStyles[property] != null) {
          if (property == "color" && elt.nodeName == "FONT" && originalStyles[property] == "" && elt.getAttribute("color") != null) {
...
Graph.setTextColor = function (node, color, isForeground) {
  var placeholder = isForeground ? Graph.newColorPlaceholder : Graph.newBackgroundPlaceholder;
  var property = isForeground ? "color" : "background-color";
  ...
  for (var i = 0; i < temp.length; i++) {
    previous.push({ node: temp[i], value: temp[i].style[property] });
  }

  document.execCommand(isForeground ? "forecolor" : "backcolor", false, placeholder);
  ...
  for (var i = 0; i < elts.length; i++) {
    ...
    if (i < previous.length && previous[i].node == elts[i] && previous[i].value != elts[i].style[property] && elts[i].style[property] == "") {
      ...
      try {
        ...
        if (temp != null) {
          ...
          elts[i].setAttribute(Graph.backupStyleAttribute, JSON.stringify(originalStyles));
        }
      } catch (e) {
        // ignore
      }
    ...
    if ((isForeground && elts[i].getAttribute("color") == placeholder) || elts[i].style[property] == placeholder) {
      if (isForeground && elts[i].getAttribute("color") == placeholder) {
        elts[i].removeAttribute("color");
      }

      elts[i].style[property] = color != mxConstants.NONE ? mxUtils.getLightDarkColor(color).cssText : null;
...
Graph.compress = function (data, deflate) {
  if (data == null || data.length == 0 || typeof pako === "undefined") {
    ...
    var tmp = deflate ? pako.deflate(encodeURIComponent(data)) : pako.deflateRaw(encodeURIComponent(data));
...
Graph.exploreFromCell = function (sourceGraph, selectionCell, config) {
  ...
  function exploreFromHere(sourceGraph, selectionCell) {
    ...
    container.style.background =
      sourceGraph.background == mxConstants.NONE || sourceGraph.background == null ? "light-dark(#ffffff," + Editor.darkColor + ")" : sourceGraph.background;
    ...
    function main(container) {
      ...
      graph.click = function (me) {
        var cell = me.getCell();
        var realCell = cell != null ? (cell.referenceCell != null ? cell.referenceCell : cell) : null;

        if (
          cell != null && //graph.rootCell != cell &&
      ...
      if (graph.getModel().isVertex(cell)) {
        ...
        try {
          ...
          for (var key in graph.getModel().cells) {
            ...
            if (tmp != graph.rootCell && !graph.getModel().isAncestor(graph.rootCell, tmp) && graph.getModel().isVertex(tmp)) {
          ...
          for (var key in graph.getModel().cells) {
            ...
            if (tmp != graph.rootCell && graph.getModel().isVertex(tmp) && graph.getModel().getParent(tmp) == graph.getDefaultParent()) {
              vertices.push(tmp);
          ...
          var r = Math.max(minSize, Math.min(graph.container.offsetWidth / 2 - 40, graph.container.offsetHeight / 2 - 80));
    ...
    function rootChanged(graph, cell) {
      pageSize =
        config != null && config.pageSize != null
          ? config.pageSize
          : 8 + Math.max(0, Math.floor(Math.min(graph.container.offsetWidth - 800 / 120, graph.container.offsetHeight - 600) / 30));
      ...
      if (cell.startIndex > 0) {
        var backCell = graph.createVertex(
          null,
          null,
          mxResources.get("previousPage") + " (" + Math.ceil((cell.startIndex || 0) / pageSize) + "/" + Math.ceil(edges.length / pageSize) + ")",
          0,
          0,
          120,
          30,
      ...
      if (edges.length > (cell.startIndex || 0) + pageSize) {
        var moreCell = graph.createVertex(
          null,
          null,
          mxResources.get("nextPage") + " (" + (Math.ceil((cell.startIndex || 0) / pageSize) + 2) + "/" + Math.ceil(edges.length / pageSize) + ")",
          0,
          0,
          120,
          30,
  ...
  while (elt != null) {
    ...
    if (elt.nodeType == mxConstants.NODETYPE_ELEMENT && elt.style != null) {
      ...
      if (elt.nodeName == "P" && elt.className == "p1") {
        ...
        if (next != null && next.nodeName == "P" && next.className == "p1") {
          elt.parentNode.insertBefore(elt.ownerDocument.createElement("br"), elt);
        }
      ...
      // Replaces tabs
      if (!ignoreTabs && elt.innerHTML != null && elt.innerHTML.indexOf("\t") >= 0) {
        var tabNode = Graph.createTabNode(4);
        elt.innerHTML = elt.innerHTML.replace(/\t/g, tabNode.outerHTML);
      }
    }
...
Graph.isStyleAllowed = function (css) {
  ...
  var normalized = css
    .replace(/\\([0-9a-fA-F]{1,6})\s?/g, function (match, hex) {
...
DOMPurify.addHook("afterSanitizeAttributes", function (node) {
  if (
    node.nodeName == "use" &&
    ((node.getAttribute("xlink:href") != null && !node.getAttribute("xlink:href").startsWith("#")) ||
          ...
          try {
            ...
            if (bbox.width > 0 && bbox.height > 0) {
              ...
              for (var i = 0; i < maxStrokeWidths.length; i++) {
                maxStrokeWidth = Math.max(maxStrokeWidth, parseFloat(maxStrokeWidths[i].getAttribute("stroke-width")));
              }
              ...
              if (!isNaN(w) && !isNaN(h) && size.x < 0 && size.y < 0 && size.width > w && size.height > h) {
                div.getElementsByTagName("svg")[0].setAttribute("viewBox", "0 0 " + w + " " + h);
              } else {
 ...
 *
 */
Graph.prototype.defaultPageBackgroundColor = urlParams["embedInline"] == "1" ? "transparent" : "light-dark(#ffffff, " + Editor.darkColor + ")";
 ...
 */
Graph.prototype.shapeBackgroundColor = "light-dark(#ffffff, var(" + Editor.darkColorVar + ", " + Editor.darkColor + "))";
...
Graph.prototype.baseUrl =
  urlParams["base"] != null
    ? mxUtils.removeJavascriptProtocol(decodeURIComponent(urlParams["base"]))
...
Graph.prototype.init = function (container) {
  ...
  this.cellRenderer.initializeLabel = function (state, shape) {
    ...
    var move = mxUtils.bind(this, function (evt) {
      handleClick = handleClick && first != null && Math.abs(first.x - mxEvent.getClientX(evt)) < tol && Math.abs(first.y - mxEvent.getClientY(evt)) < tol;
    });
        ...
        mxEvent.addListener(
          ...
          mxUtils.bind(this, function (evt) {
            ...
            if (source.nodeName == "A") {
              ...
              if (href != null && this.graph.isCustomLink(href) && (mxEvent.isTouchEvent(evt) || !mxEvent.isPopupTrigger(evt)) && this.graph.customLinkClicked(href)) {
                mxEvent.consume(evt);
              }
            }
          }),
...
(function () {
  ...
  Graph.prototype.getTextColor = function (node, isForeground) {
    ...
    var temp = node == this.cellEditor.textarea && isForeground ? "default" : Graph.getGivenColor(node, attr);
    var tempNode = node;

    while (temp == null && tempNode != null && tempNode != this.cellEditor.textarea.parentNode) {
      temp = tempNode == this.cellEditor.textarea && isForeground ? "default" : Graph.getGivenColor(tempNode, attr);
      tempNode = tempNode.parentNode;
    }

    if (temp == "rgba(0, 0, 0, 0)" || temp == "transparent") {
  ...
  Graph.prototype.isSpecialColor = function (color) {
    return mxUtils.indexOf([mxConstants.STYLE_STROKECOLOR, mxConstants.STYLE_FILLCOLOR, "inherit", "swimlane", "indicated"], color) >= 0;
  };
      ...
      try {
        ...
        for (var key in styles) {
          ...
          if (key == "edgeStyle" && styles[key] == "elbowEdgeStyle" && dir != null) {
            this.setCellStyles("elbow", dir == mxConstants.DIRECTION_SOUTH || dir == mxConstants.DIRECTION_NOTH ? "vertical" : "horizontal", edges);
          }
        }
      } finally {
  ...
  Graph.prototype.getStartEditingCell = function (cell, trigger) {
    ...
    if (this.isTable(cell) && (!this.isSwimlane(cell) || size == 0) && this.getLabel(cell) == "" && this.model.getChildCount(cell) > 0) {
    ...
    if (this.isTableRow(cell) && (!this.isSwimlane(cell) || size == 0) && this.getLabel(cell) == "" && this.model.getChildCount(cell) > 0) {
    ...
    try {
      for (var i = 0; i < cells.length; i++) {
        ...
        if (Editor.simpleLabels) {
          cellStyle = mxUtils.setStyle(mxUtils.setStyle(cellStyle, "html", null), "whiteSpace", null);
        }
        ...
        if (this.model.isVertex(cells[i]) || this.model.isEdge(cells[i])) {
          ...
          for (var key in style) {
            ...
            if (cellStyle[key] != value) {
              ...
              if (key == mxConstants.STYLE_SHAPE && cellStyle[key] == "umlLifeline" && value != "umlLifeline") {
  ...
  Graph.prototype.isFastZoomEnabled = function () {
    return urlParams["zoom"] != "nocss" && !mxClient.NO_FO && !mxClient.IS_EDGE && !this.useCssTransforms && (this.isCssTransformsSupported() || mxClient.IS_IOS);
  };
  ...
  Graph.prototype.isPart = function (cell) {
    return mxUtils.getValue(this.getCurrentCellStyle(cell), "part", "0") == "1" || this.isTableCell(cell) || this.isTableRow(cell);
  };
  ...
  Graph.prototype.scrollRectToVisible = function (r) {
    if (this.useCssTransforms) {
      ...
      r = new mxRectangle((r.x + 2 * t.x) * s - t.x, (r.y + 2 * t.y) * s - t.y, r.width * s, r.height * s);
    }
    ...
    if (temp != null) {
      ...
      if (!this.useCssTransforms) {
        ...
        if (prev != g.getAttribute("transform")) {
          this.fireEvent(new mxEventObject("cssTransformChanged"), "transform", g.getAttribute("transform"));
        }
      }
    }
  };
    ...
    if (href != null) {
      ...
      if (target == "_self" && window != window.top) {
        ...
        if (
          ...
          result = window.open(href, target != null ? target : "_blank", !allowOpener ? "noopener,noreferrer" : null);
...
Graph.prototype.isBlankLink = function (href) {
  return (
    ...
    (this.linkPolicy === "blank" || (this.linkPolicy !== "self" && !this.isRelativeUrl(href) && href.substring(0, this.domainUrl.length) !== this.domainUrl))
  );
};
...
Graph.prototype.initLayoutManager = function () {
  ...
  this.layoutManager.getLayout = function (cell, eventName) {
    ...
    if (!this.graph.isCellCollapsed(cell) && (eventName != mxEvent.BEGIN_UPDATE || this.hasLayout(parent, eventName))) {
      ...
      if (style["childLayout"] == "stackLayout") {
        ...
        var flowLayout = new mxHierarchicalLayout(this.graph, mxUtils.getValue(style, "flowOrientation", mxConstants.DIRECTION_EAST));
      ...
      } else if (style["childLayout"] != null && String(style["childLayout"]).charAt(0) == "[") {
        try {
          return new mxCompositeLayout(this.graph, this.graph.createLayouts(JSON.parse(style["childLayout"])));
        } catch (e) {
...
Graph.prototype.createLayouts = function (list) {
  ...
  for (var i = 0; i < list.length; i++) {
    if (mxUtils.indexOf(Graph.layoutNames, list[i].layout) >= 0) {
      ...
      var layout =
        list[i].layout == "mxOrgChartLayout" && list[i].config != null ? new window[list[i].layout](this, list[i].config["branchOptimizer"]) : new window[list[i].layout](this);

      if (list[i].config != null) {
        for (var key in list[i].config) {
          // Ignores branch optimizer in orgchart (handled above)
          if (list[i].layout != "mxOrgChartLayout" || key != "branchOptimizer") {
  ...
  return {
    execute: mxUtils.bind(this, function (step, steps) {
      if (state.shape != null) {
        ...
        for (var i = 1; i < n; i++) {
          if (dist <= segs[i - 1]) {
            pts2.push(new mxPoint(pts[i - 1].x + ((pts[i].x - pts[i - 1].x) * dist) / segs[i - 1], pts[i - 1].y + ((pts[i].y - pts[i - 1].y) * dist) / segs[i - 1]));
...
Graph.prototype.getPageSize = function () {
  return this.pageVisible && this.pageFormat != null ? new mxRectangle(0, 0, this.pageFormat.width * this.pageScale, this.pageFormat.height * this.pageScale) : this.scrollTileSize;
};
...
Graph.prototype.getPageLayout = function (bounds, tr, s) {
  ...
  if (bounds.width == 0 || bounds.height == 0) {
    ...
    var w0 = Math.ceil((Math.floor((bounds.x + bounds.width) / s) - tr.x) / size.width) - x0;
    var h0 = Math.ceil((Math.floor((bounds.y + bounds.height) / s) - tr.y) / size.height) - y0;
...
Graph.prototype.isZoomWheelEvent = function (evt) {
  return (
    (Graph.zoomWheel && !mxEvent.isShiftDown(evt) && !mxEvent.isMetaDown(evt) && !mxEvent.isAltDown(evt) && (!mxEvent.isControlDown(evt) || mxClient.IS_MAC)) ||
...
Graph.prototype.isIgnoreTerminalEvent = function (evt) {
  return mxEvent.isAltDown(evt) && !mxEvent.isShiftDown(evt) && !mxEvent.isControlDown(evt) && !mxEvent.isMetaDown(evt);
};
...
Graph.prototype.isLabelMovable = function (cell) {
  ...
  return (
    ...
    ((this.model.isEdge(cell) && this.edgeLabelsMovable) || (this.model.isVertex(cell) && (this.vertexLabelsMovable || mxUtils.getValue(style, "labelMovable", "0") == "1")))
  );
};
...
Graph.prototype.createLayersDialog = function (onchange, inverted) {
  ...
  for (var i = 0; i < childCount; i++) {
    mxUtils.bind(this, function (layer) {
      ...
      span.setAttribute("title", mxResources.get(model.isVisible(layer) ? "hideIt" : "show", [title]));
    ...
    while ((match = this.placeholderPattern.exec(str))) {
      ...
      if (val.length > 2 && val != "%label%" && val != "%tooltip%") {
        ...
        if (match.index > last && str.charAt(match.index - 1) == "%") {
          ...
          var units = { mm: mxConstants.MILLIMETERS, in: mxConstants.INCHES, m: mxConstants.METERS, current: this.view.unit };
          ...
          if (name == "id") {
            ...
            while (tmp == null && current != null) {
              if (current.value != null && typeof current.value == "object") {
                ...
                if (tmp == null) {
                  tmp = current.hasAttribute(name) ? (current.getAttribute(name) != null ? current.getAttribute(name) : "") : null;
                }
              }
          ...
          if (tmp == null) {
            if ((name.substring(0, 9) == "pagecount" && name.length > 9) || (name.substring(0, 10) == "pagenumber" && name.length > 10)) {
...
Graph.prototype.selectCellForEvent = function (cell, evt) {
  if (!mxEvent.isShiftDown(evt) || this.isSelectionEmpty() || !this.selectTableRange(this.getSelectionCell(), cell)) {
...
Graph.prototype.selectTableRange = function (startCell, endCell) {
  ...
  if (this.isTableCell(startCell) && this.isTableCell(endCell)) {
    ...
    if (table == this.model.getParent(endRow)) {
      ...
      if (cells.length > 0 && (cells.length > 1 || this.getSelectionCount() > 1 || !this.isCellSelected(cells[0]))) {
  ...
  try {
    ...
    if (style != null && style[mxConstants.STYLE_SHAPE] == null) {
      if (this.model.isVertex(source)) {
        style[mxConstants.STYLE_SHAPE] = this.stylesheet.getDefaultVertexStyle()[mxConstants.STYLE_SHAPE];
      } else if (this.model.isEdge(source)) {
        style[mxConstants.STYLE_SHAPE] = this.stylesheet.getDefaultEdgeStyle()[mxConstants.STYLE_SHAPE];
      }
    }

    // Replaces target styles and removes composite childs
    for (var i = 0; i < targets.length; i++) {
      if ((this.model.isVertex(source) && this.model.isVertex(targets[i])) || (this.model.isEdge(source) && this.model.isEdge(targets[i]))) {
        if (replaceStyles) {
      ...
      if (mxUtils.getValue(this.getCellStyle(targets[i], false), "composite", "0") == "1") {
  ...
  if (tempCells != null) {
    ...
    for (var i = 0; i < tempCells.length; i++) {
      if (!this.isCellLocked(tempCells[i]) && !this.model.isEdge(tempCells[i]) && tempCells[i] != source) {
        ...
        if (!this.model.isAncestor(source, tempCells[i]) && this.isContainer(tempCells[i]) && (container == null || tempCells[i] == this.model.getParent(source))) {
          container = tempCells[i];
        }
        // Containers are used as target cells but swimlanes are used as parents
        else if (target == null && this.isCellConnectable(tempCells[i]) && !this.model.isAncestor(tempCells[i], source) && !this.isSwimlane(tempCells[i])) {
  ...
  var execute = mxUtils.bind(this, function (targetCell) {
    if (createTarget == null || targetCell != null || (target == null && cloneSource)) {
      ...
      try {
        ...
        if (target == null && realTarget != null && source.parent != null && cloneSource && direction == mxConstants.DIRECTION_WEST) {
...
Graph.prototype.getIndexableText = function (cells) {
  cells = cells != null ? cells : this.model.getDescendants(this.model.root);
...
Graph.prototype.postProcessCellStyle = function (cell, style) {
  return this.updateHorizontalStyle(cell, this.replaceDefaultColors(cell, mxGraph.prototype.postProcessCellStyle.apply(this, arguments)));
};
...
Graph.prototype.replaceDefaultColors = function (cell, style) {
  if (style != null && this.shapeBackgroundColor != null && this.shapeForegroundColor != null) {
...
Graph.prototype.replaceDefaultColor = function (style, key, value) {
  if (style != null && value != null && value != "none" && value != "" && style[key] == "default") {
    ...
    try {
      ...
      for (var i = 0; i < cells.length; i++) {
        ...
        if (state != null && geo != null) {
          ...
          if (mxUtils.getValue(state.style, "expandToFront", "0") == "1" && !this.isCellCollapsed(cells[i])) {
...
Graph.prototype.resizeParentStacks = function (parent, layout, dx, dy) {
  if (this.layoutManager != null && layout != null && layout.constructor == mxStackLayout && !layout.resizeLast) {
    ...
    try {
      ...
      while (parent != null && layout != null && layout.constructor == mxStackLayout && layout.horizontal == dir && !layout.resizeLast) {
...
Graph.prototype.isCellConnectable = function (cell) {
  ...
  return (
    !this.isCellLocked(this.getLayerForCell(cell)) && (style["connectable"] != null ? style["connectable"] != "0" : mxGraph.prototype.isCellConnectable.apply(this, arguments))
  );
};
...
Graph.prototype.isLabelMovable = function (cell) {
  ...
  return style["movableLabel"] != null ? style["movableLabel"] != "0" : mxGraph.prototype.isLabelMovable.apply(this, arguments);
};
...
Graph.prototype.isCellFoldable = function (cell) {
  ...
  return (
    ...
    (style["treeFolding"] == "1" ||
      (!this.isCellLocked(cell) && ((this.isContainer(cell) && style["collapsible"] != "0") || (!this.isContainer(cell) && style["collapsible"] == "1"))))
  );
};
...
Graph.prototype.fitPages = function (pageCount, ignoreHeight) {
  ...
  var scale = Math.floor(20 * (ignoreHeight ? sx : Math.min(sx, ch / (vcount * fmt.height) / ps))) / 20;
  ...
  if (mxUtils.hasScrollbars(this.container)) {
    ...
    if (!ignoreHeight) {
      this.container.scrollTop = Math.min(pad.y * this.view.scale, (this.container.scrollHeight - this.container.clientHeight) / 2);
    }
  }
};
...
Graph.prototype.fitWindow = function (bounds, border) {
  ...
  if (mxUtils.hasScrollbars(this.container)) {
    ...
    window.setTimeout(
      mxUtils.bind(this, function () {
        var t = this.view.translate;
        this.container.scrollLeft = (bounds.x + t.x) * this.view.scale - Math.max((cw - bounds.width * this.view.scale) / 2 + border / 2, 0);
        this.container.scrollTop = (bounds.y + t.y) * this.view.scale - Math.max((ch - bounds.height * this.view.scale) / 2 + border / 2, 0);
      }),
      0,
    );
  }
  ...
  if (mxUtils.isNode(cell.value)) {
    ...
    if (tip == null) {
      ...
      for (var i = 0; i < attrs.length; i++) {
        if (((Graph.translateDiagram && attrs[i].nodeName == "label") || mxUtils.indexOf(ignored, attrs[i].nodeName) < 0) && attrs[i].nodeValue.length > 0) {
      ...
      for (var i = 0; i < temp.length; i++) {
        if (temp[i].name != "link" || !this.isCustomLink(temp[i].value)) {
          tip += (temp[i].name != "link" ? "<b>" + mxUtils.htmlEntities(temp[i].name) + ":</b> " : "") + mxUtils.htmlEntities(temp[i].value) + "\n";
        }
      }
      ...
      if (tip.length > 0) {
        ...
        if (mxClient.IS_SVG) {
          tip = '<div style="max-width:360px;text-overflow:ellipsis;overflow:hidden;">' + tip + "</div>";
        }
      }
    }
  }
...
Graph.prototype.addFlowAnimationToNode = function (node, style, scale, id) {
  if (node != null && id != null) {
    ...
    if (dashArray == "" || dashArray == null) {
      ...
      var sw = mxUtils.getValue(style, mxConstants.STYLE_FIX_DASH, false) == 1 || style["dashPattern"] == null ? 1 : mxUtils.getNumber(style, mxConstants.STYLE_STROKEWIDTH, 1);
    ...
    if (tokens.length > 0) {
      ...
      var d = Math.round((sum / scale / 16) * parseInt(mxUtils.getValue(style, "flowAnimationDuration", 500)));
...
HoverIcons.prototype.triangleUp = Graph.createSvgImage(
  18,
  28,
  '<path d="m 6 26 L 12 26 L 12 12 L 18 12 L 9 1 L 1 12 L 6 12 z" ' + 'stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/>',
);
...
HoverIcons.prototype.triangleRight = Graph.createSvgImage(
  26,
  18,
  '<path d="m 1 6 L 14 6 L 14 1 L 26 9 L 14 18 L 14 12 L 1 12 z" ' + 'stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/>',
);
...
HoverIcons.prototype.triangleDown = Graph.createSvgImage(
  18,
  26,
  '<path d="m 6 1 L 6 14 L 1 14 L 9 26 L 18 14 L 12 14 L 12 1 z" ' + 'stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/>',
);
...
HoverIcons.prototype.triangleLeft = Graph.createSvgImage(
  28,
  18,
  '<path d="m 1 9 L 12 1 L 12 6 L 26 6 L 26 12 L 12 12 L 12 18 z" ' + 'stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/>',
);
...
HoverIcons.prototype.init = function () {
  ...
  this.graph.click = mxUtils.bind(this, function (me) {
    ...
    if (this.currentState != null && !this.graph.isCellSelected(this.currentState.cell) && mxEvent.isTouchEvent(me.getEvent()) && !this.graph.model.isVertex(me.getCell())) {
      this.reset();
    }
  });
...
HoverIcons.prototype.isResetEvent = function (evt, allowShift) {
  return mxEvent.isAltDown(evt) || (this.activeArrow == null && mxEvent.isShiftDown(evt)) || (mxEvent.isPopupTrigger(evt) && !this.graph.isCloneEvent(evt));
};
...
HoverIcons.prototype.createArrow = function (img, tooltip, direction) {
  ...
  mxEvent.addListener(
    ...
    mxUtils.bind(this, function (evt) {
      ...
      if (mxEvent.isMouseEvent(evt)) {
        ...
        this.fireEvent(new mxEventObject("focus", "arrow", arrow, "direction", direction, "event", evt));
      }
    }),
  );
  ...
  mxEvent.addListener(
    ...
    mxUtils.bind(this, function (evt) {
      if (mxEvent.isMouseEvent(evt)) {
        this.fireEvent(new mxEventObject("blur", "arrow", arrow, "direction", direction, "event", evt));
      }
...
HoverIcons.prototype.drag = function (evt, x, y) {
  ...
  if (this.currentState != null) {
    ...
    if (evt != null && mxEvent.isShiftDown(evt) && mxEvent.isControlDown(evt) && es != null && mxUtils.getValue(es.style, mxConstants.STYLE_EDGE, null) === "orthogonalEdgeStyle") {
...
HoverIcons.prototype.execute = function (state, dir, me) {
  ...
  this.graph.selectCellsForConnectVertex(
    this.graph.connectVertex(state.cell, dir, this.graph.defaultEdgeLength, evt, this.graph.isCloneEvent(evt), this.graph.isCloneEvent(evt)),
    evt,
    this,
  );
};
      ...
      if (this.checkCollisions) {
        ...
        var checkCollision = mxUtils.bind(this, function (cell, arrow) {
          ...
          if (
            ...
            (geo == null || currentGeo == null || (geo.height < 3 * currentGeo.height && geo.width < 3 * currentGeo.width))
          ) {
...
HoverIcons.prototype.update = function (state, x, y) {
  if (
    ...
    if (state != null && state.cell.geometry != null && state.cell.geometry.relative && this.graph.model.isEdge(state.cell.parent)) {
      state = null;
    }
    ...
    if (this.currentState != null && this.currentState != state && timeOnTarget < this.activationDelay && this.bbox != null && !mxUtils.contains(this.bbox, x, y)) {
      this.reset(false);
...
Graph.prototype.createTable = function (rowCount, colCount, w, h, title, startSize, tableStyle, rowStyle, cellStyle) {
  ...
  tableStyle = tableStyle != null ? tableStyle : "shape=table;startSize=" + (title != null ? startSize : "0") + ";container=1;collapsible=0;childLayout=tableLayout;";
  rowStyle =
    rowStyle != null
      ? rowStyle
  ...
  return this.createParent(
    this.createVertex(null, null, title != null ? title : "", 0, 0, colCount * w, rowCount * h + (title != null ? startSize : 0), tableStyle),
    this.createParent(this.createVertex(null, null, "", 0, 0, colCount * w, h, rowStyle), this.createVertex(null, null, "", 0, 0, w, h, cellStyle), colCount, w, 0),
    rowCount,
    0,
    h,
  );
...
Graph.prototype.createCrossFunctionalSwimlane = function (rowCount, colCount, w, h, title, tableStyle, rowStyle, firstCellStyle, cellStyle) {
  ...
  tableStyle = tableStyle != null ? tableStyle : "shape=table;childLayout=tableLayout;" + (title == null ? "startSize=0;fillColor=none;" : "startSize=40;") + s;
  rowStyle =
    rowStyle != null
      ? rowStyle
      : "shape=tableRow;horizontal=0;swimlaneHead=0;swimlaneBody=0;top=0;left=0;strokeColor=inherit;" +
        "bottom=0;right=0;dropTarget=0;fontStyle=0;fillColor=none;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;startSize=40;" +
        s;
  firstCellStyle =
    firstCellStyle != null ? firstCellStyle : "swimlane;swimlaneHead=0;swimlaneBody=0;fontStyle=0;strokeColor=inherit;" + "connectable=0;fillColor=none;startSize=40;" + s;
  cellStyle = cellStyle != null ? cellStyle : "swimlane;swimlaneHead=0;swimlaneBody=0;fontStyle=0;connectable=0;strokeColor=inherit;" + "fillColor=none;startSize=0;" + s;

  var table = this.createVertex(null, null, title != null ? title : "", 0, 0, colCount * w, rowCount * h, tableStyle);
  ...
  if (rowCount > 1) {
    ...
    return this.createParent(table, this.createParent(row, this.createVertex(null, null, "", t, 0, w, h, cellStyle), colCount, w, 0), rowCount - 1, 0, h);
  } else {
    return table;
  }
};
...
Graph.prototype.visitTableCells = function (cell, visitor) {
  ...
  for (var i = 0; i < rows.length; i++) {
    ...
    for (var j = 0; j < cols.length; j++) {
      ...
      col.point = new mxPoint(
        geo.width + (lastCol != null ? lastCol.point.x : start.x + rowStart.x),
      ...
      var head =
        mxUtils.getValue(rowStyle, mxConstants.STYLE_SWIMLANE_HEAD, 1) == 1 && mxUtils.getValue(rowStyle, mxConstants.STYLE_STROKECOLOR, mxConstants.NONE) != mxConstants.NONE;

      visitor(col, cols.length, rows.length, start.x + (head ? rowStart.x : 0), start.y + (head ? rowStart.y : 0));
      row.push(col);
      lastCol = col;
    }
...
Graph.prototype.getTableLines = function (cell, horizontal, vertical) {
  ...
  if (horizontal || vertical) {
    this.visitTableCells(
      cell,
      mxUtils.bind(this, function (iter, colCount, rowCount, x0, y0) {
...
TableLayout.prototype.getRowLayout = function (row, width) {
  ...
  for (var i = 0; i < cells.length; i++) {
    ...
    if (geo != null) {
      x += ((geo.alternateBounds != null ? geo.alternateBounds.width : geo.width) * rw) / sw;
...
(function () {
  ...
  mxGraphView.prototype.validateCellState = function (cell, recurse) {
    ...
    if (state != null && recurse && this.graph.model.isEdge(state.cell) && state.style != null && state.style[mxConstants.STYLE_CURVED] != 1) {
  ...
  mxShape.prototype.getFlowAnimationPath = function (index) {
    var paths = this.node != null ? this.node.getElementsByTagName("path") : null;
    ...
    if (paths != null) {
      ...
      for (var i = 0; i < paths.length; i++) {
        if (paths[i].getAttribute("visibility") != "hidden") {
          if ((d == null || d == paths[i].getAttribute("d")) && (index == null || --index == 0)) {
            return paths[i];
          }
        } else if (d == null) {
  ...
  mxShape.prototype.addFlowAnimationToShape = function () {
    if (this.state != null) {
      this.state.view.graph.addFlowAnimationToNode(this.getFlowAnimationPath(), this.state.style, this.state.view.scale, this.state.view.graph.addFlowAnimationStyle());
    }
  };
            ...
            if (pts2 != null && mxUtils.intersects(state, state2) && state2.style["noJump"] != "1") {
              ...
              for (var j = 0; j < pts2.length - 1; j++) {
                ...
                if (
                  ...
                  (pl == null || mxUtils.ptLineDist(p0.x, p0.y, p1.x, p1.y, pl.x, pl.y) > thresh || mxUtils.ptLineDist(p0.x, p0.y, p1.x, p1.y, p2.x, p2.y) > thresh) &&
                  // Removes jumps on overlapping outgoing segments
                  (pn == null || mxUtils.ptLineDist(p0.x, p0.y, p1.x, p1.y, pn.x, pn.y) > thresh || mxUtils.ptLineDist(p0.x, p0.y, p1.x, p1.y, p3.x, p3.y) > thresh)
                ) {
                  var dx = pt.x - p0.x;
                  var dy = pt.y - p0.y;
                  ...
                  if (temp != null && (list.length == 0 || list[list.length - 1].x !== temp.x || list[list.length - 1].y !== temp.y)) {
                    list.push(temp);
                  }
                }
...
if (typeof mxVertexHandler !== "undefined") {
  (function () {
    ...
    mxGraphLayout.prototype.isEdgeIgnored = function (edge) {
      return graphLayoutIsEdgeIgnored.apply(this, arguments) || this.graph.isEdgeIgnored(edge);
    };
     ...
     */
    Graph.prototype.defaultEdgeStyle = { edgeStyle: "orthogonalEdgeStyle", rounded: "0", jettySize: "auto", orthogonalLoop: "1" };
    ...
    Graph.prototype.isSwimlane = function (cell, ignoreState) {
      ...
      if (cell != null && !this.model.isEdge(cell) && this.model.getParent(cell) != this.model.getRoot()) {
        var style = this.getCurrentCellStyle(cell, ignoreState);
        shape = style[mxConstants.STYLE_SHAPE];
      }

      return shape == mxConstants.SHAPE_SWIMLANE || shape == "table" || shape == "tableRow";
    };
    ...
    Graph.prototype.splitEdge = function (edge, cells, newEdge, dx, dy, x, y, parent) {
      ...
      try {
        ...
        if (geo != null && geo.points != null && geo.points.length > 0 && cells.length == 1 && this.model.isVertex(cells[0])) {
          var temp = this.getCellGeometry(cells[0]);

          if (temp != null && !temp.relative) {
            var bbox = new mxRectangle(temp.x + dx, temp.y + dy, temp.width, temp.height);
      ...
      if (isParent || isChild) {
        ...
        var flatten = mxUtils.bind(this, function (temp) {
          if (this.view.getState(temp) != null && (this.model.isVertex(temp) || this.model.isEdge(temp))) {
            ...
            } else if ((isNext && cell == null && cells.length > 0) || (index != null && isNext && cells.length > index) || (!isNext && index > 0)) {
              return;
            }
          }
    ...
    Graph.prototype.swapShapes = function (source, target) {
      if (this.model.isVertex(source) && this.model.isVertex(target) && this.getMovableCells([source, target]).length == 2) {
      ...
      try {
        ...
        for (var i = 0; i < cells.length; i++) {
          if (target != null && this.isTableRow(cells[i])) {
            ...
            if (parent != null && row != null && this.isTable(parent) && this.isTable(target) && (clone || parent != target)) {
              if (!clone) {
    ...
    Graph.prototype.updateCustomLinksForCell = function (mapping, cell) {
      ...
      for (var i = 0; i < childCount; i++) {
        this.updateCustomLinksForCell(mapping, this.model.getChildAt(cell, i));
      }
    };
        ...
        if (constraints != null) {
          ...
          try {
            ...
            for (var i = 0; i < c.length; i++) {
              var tmp = c[i];
              result.push(
                new mxConnectionConstraint(new mxPoint(tmp[0], tmp[1]), tmp.length > 2 ? tmp[2] != "0" : true, null, tmp.length > 3 ? tmp[3] : 0, tmp.length > 4 ? tmp[4] : 0),
              );
            }
          } catch (e) {
            // ignore
          ...
          if (model.isEdge(cell)) {
            ...
            if (geo != null) {
              ...
              if (edgeState != null) {
                ...
                this.setCellStyles(mxConstants.STYLE_SOURCE_PERIMETER_SPACING, mxUtils.getValue(edgeState.style, mxConstants.STYLE_TARGET_PERIMETER_SPACING), [cell]);
            ...
            if (geo != null) {
              ...
              if (state != null) {
                ...
                this.setCellStyles(mxConstants.STYLE_DIRECTION, dirs[mxUtils.mod(mxUtils.indexOf(dirs, dir) + (backwards ? -1 : 1), dirs.length)], [cell]);
              }
    ...
    Graph.prototype.processChange = function (change) {
      if (
        ...
        ((change.previous == null && change.geometry != null) || (change.previous != null && !change.previous.equals(change.geometry)))
      ) {
      ...
      try {
        if (cell.value != null && typeof cell.value == "object") {
          if (this.isReplacePlaceholders(cell) && cell.getAttribute("placeholder") != null) {
            ...
            while (current != null) {
              if (current == this.model.getRoot() || (current.value != null && typeof current.value == "object" && current.hasAttribute(name))) {
          ...
          if (Graph.translateDiagram && Graph.diagramLanguage != null && tmp.hasAttribute("label_" + Graph.diagramLanguage)) {
    ...
    Graph.prototype.cellsRemoved = function (cells) {
      if (cells != null) {
        ...
        for (var i = 0; i < parents.length; i++) {
          ...
          if (state != null && (this.model.isEdge(state.cell) || this.model.isVertex(state.cell)) && this.isCellDeletable(state.cell) && this.isTransparentState(state)) {
    ...
    Graph.prototype.setTooltipForCell = function (cell, link) {
      ...
      if (Graph.translateDiagram && Graph.diagramLanguage != null && mxUtils.isNode(cell.value) && cell.value.hasAttribute("tooltip_" + Graph.diagramLanguage)) {
    ...
    Graph.prototype.isTargetShape = function (target, cells, evt) {
      var shape = mxUtils.getValue(this.getCurrentCellStyle(target), mxConstants.STYLE_SHAPE, "");

      for (var i = 0; i < cells.length; i++) {
        var shapes = mxUtils.getValue(this.getCurrentCellStyle(cells[i]), "targetShapes", "").split(",");
      ...
      if (evt != null && !this.model.isVertex(cell)) {
        ...
        if (
          ...
          (state == null ||
            ...
            (!mxUtils.contains(state.text.boundingBox, pt.x, pt.y) && !mxUtils.isAncestorNode(state.text.node, mxEvent.getSource(evt)))) &&
          ((state == null && !this.isCellLocked(this.getDefaultParent())) || (state != null && !this.isCellLocked(state.cell))) &&
    ...
    Graph.prototype.getCenterInsertPoint = function (bbox) {
      ...
      if (mxUtils.hasScrollbars(this.container)) {
        return new mxPoint(
          this.snap(Math.round((this.container.scrollLeft + this.container.clientWidth / 2) / this.view.scale - this.view.translate.x - bbox.width / 2)),
          this.snap(Math.round((this.container.scrollTop + this.container.clientHeight / 2) / this.view.scale - this.view.translate.y - bbox.height / 2)),
        );
      } else {
        return new mxPoint(
          this.snap(Math.round(this.container.clientWidth / 2 / this.view.scale - this.view.translate.x - bbox.width / 2)),
          this.snap(Math.round(this.container.clientHeight / 2 / this.view.scale - this.view.translate.y - bbox.height / 2)),
        );
      }
    };
    ...
    Graph.prototype.addClickHandler = function (highlight, beforeClick, onClick) {
      ...
      var mouseListener = {
        ...
        currentLink: null,
        currentTarget: null,
        highlight: highlight != null && highlight != "" && highlight != mxConstants.NONE ? new mxCellHighlight(graph, highlight, 4) : null,
        startX: 0,
        startY: 0,
        scrollLeft: 0,
        scrollTop: 0,
        ...
        mouseUp: function (sender, me) {
          ...
          if (
            ...
            (((mxEvent.isLeftMouseButton(evt) || mxEvent.isMiddleMouseButton(evt)) && !mxEvent.isPopupTrigger(evt)) || mxEvent.isTouchEvent(evt))
          ) {
            if (this.currentLink != null) {
              var blank = graph.isBlankLink(this.currentLink);

              if ((this.currentLink.substring(0, 5) === "data:" || !blank) && beforeClick != null) {
                beforeClick(evt, this.currentLink, this.currentState != null ? this.currentState.cell : null);
              }

              if (!mxEvent.isConsumed(evt)) {
                var target = this.currentTarget != null ? this.currentTarget : mxEvent.isMiddleMouseButton(evt) ? "_blank" : blank ? graph.linkTarget : "_top";
    ...
    Graph.prototype.isCellResizable = function (cell) {
      ...
      return (
        ...
        !this.isTableRow(cell) &&
        (result || (mxUtils.getValue(style, mxConstants.STYLE_RESIZABLE, "1") != "0" && style[mxConstants.STYLE_WHITE_SPACE] == "wrap"))
      );
    };
    ...
    Graph.prototype.distributeCells = function (horizontal, cells, spacing) {
      ...
      if (cells != null && cells.length > 1) {
        ...
        if (vertices.length > 2) {
          ...
          if (spacing) {
            cellsSize -= horizontal ? vertices[0].width / 2 + vertices[vertices.length - 1].width / 2 : vertices[0].height / 2 + vertices[vertices.length - 1].height / 2;
          }
      ...
      try {
        ...
        var bounds =
          exportType == "page"
            ...
            : (ignoreSelection && lookup == null) || nocrop || exportType == "diagram"
              ? this.getGraphBounds()
        ...
        if (exportType == "diagram" && bgImg != null && bgImg.width != null && bgImg.height != null) {
          bounds = mxRectangle.fromRectangle(bounds);
          bounds.add(new mxRectangle((tr.x + bgImg.x) * vs, (tr.y + bgImg.y) * vs, bgImg.width * vs, bgImg.height * vs));
        }
        ...
        var s = scale / vs;
        var w = Math.max(1, Math.ceil(bounds.width * s) + 2 * border) + (hasShadow && border == 0 ? 5 : 0);
        var h = Math.max(1, Math.ceil(bounds.height * s) + 2 * border) + (hasShadow && border == 0 ? 5 : 0);
        ...
        if (background != null) {
          var rect = mxUtils.createElementNs(svgDoc, mxConstants.NS_SVG, "rect");
        ...
        var group = mxUtils.createElementNs(svgDoc, mxConstants.NS_SVG, "g");
        ...
        if (bgImg != null && bgImg.width != null && bgImg.height != null) {
          var s2 = vs / scale;
          var tmp = new mxRectangle((bgImg.x + tr.x) * s2, (bgImg.y + tr.y) * s2, bgImg.width * s2, bgImg.height * s2);

          // Checks if visible
          if (mxUtils.intersects(bounds, tmp)) {
            svgCanvas.image(bgImg.x + tr.x, bgImg.y + tr.y, bgImg.width, bgImg.height, bgImg.src, true);
          }
        }
        ...
        var addFlowAnimationStyle = mxUtils.bind(this, function () {
          if (flowAnimationId == null) {
            ...
            var style = svgDoc.createElementNS != null ? svgDoc.createElementNS(mxConstants.NS_SVG, "style") : svgDoc.createElement("style");
        ...
        imgExport.drawCellState = function (state, canvas) {
          var graph = state.view.graph;
          var selected = lookup != null ? lookup.get(state.cell) : graph.isCellSelected(state.cell);
          var parent = graph.model.getParent(state.cell);

          // Checks if parent cell is selected
          while ((!ignoreSelection || lookup != null) && !selected && parent != null) {
            selected = lookup != null ? lookup.get(parent) : graph.isCellSelected(parent);
          ...
          if (state.shape != null) {
            try {
              ...
              state.shape.isFlowAnimationEnabled = function () {
                return origEnabledFlowAnimation && graph.model.isEdge(state.cell) && mxUtils.getValue(state.style, "flowAnimation", "0") == "1";
              };

              state.shape.addFlowAnimationToShape = function () {
                graph.addFlowAnimationToNode(this.getFlowAnimationPath(), state.style, scale, addFlowAnimationStyle());
              };
        ...
        var viewRoot = this.view.currentRoot != null ? this.view.currentRoot : this.model.root;
    ...
    Graph.prototype.flipCells = function (cells, horizontal) {
      ...
      try {
          ...
          if (this.model.isEdge(cells[i])) {
            ...
            if (state != null) {
              this.flipEdgePoints(
                cells[i],
                horizontal,
                (horizontal ? state.getCenterX() : state.getCenterY()) / this.view.scale -
                  (horizontal ? state.origin.x : state.origin.y) -
                  (horizontal ? this.view.translate.x : this.view.translate.y),
              );
            }
          } else {
            var geo = this.getCellGeometry(cells[i]);
            ...
            if (geo != null) {
              this.flipChildren(cells[i], horizontal, horizontal ? geo.getCenterX() - geo.x : geo.getCenterY() - geo.y);
            }
        ...
        this.toggleCellStyles(horizontal ? mxConstants.STYLE_FLIPH : mxConstants.STYLE_FLIPV, false, vertices);
    ...
    Graph.prototype.insertTableColumn = function (cell, before) {
      ...
      try {
        ...
        for (var i = 0; i < rows.length; i++) {
          ...
          clone.value = null;
          clone.style = mxUtils.setStyle(mxUtils.setStyle(clone.style, "rowspan", null), "colspan", null);
      ...
      try {
        ...
        if (rowGeo != null) {
          for (var i = 0; i < cells.length; i++) {
            ...
            // Removes value, col/rowspan and alternate bounds
            cell.value = null;
            cell.style = mxUtils.setStyle(mxUtils.setStyle(cell.style, "rowspan", null), "colspan", null);
      ...
      this.popupMenuHandler.mouseUp = mxUtils.bind(this, function (sender, me) {
        if (this.freehand != null && !this.freehand.isDrawing()) {
          ...
          this.popupMenuHandler.popupTrigger =
            ...
            (this.popupMenuHandler.popupTrigger ||
              (!menuShowing && !isMouseEvent && ((selectionEmpty && me.getCell() == null && this.isSelectionEmpty()) || (cellSelected && this.isCellSelected(me.getCell())))));

          // Delays popup menu to allow for double tap to start editing
          var popup =
            !cellSelected || isMouseEvent
              ? null
      ...
      if (state != null) {
        ...
        if (shiftPressed || (window.getSelection != null && window.getSelection().containsNode != null)) {
          ...
          this.graph.processElements(this.textarea, function (node) {
            if (shiftPressed || vertical || window.getSelection().containsNode(node, true)) {
    ...
    mxCellEditor.prototype.startEditing = function (cell, trigger) {
      ...
      this.textarea.style.colorScheme = this.graph.getAdaptiveColors() == "none" ? "light" : "";
    ...
    mxCellEditor.prototype.toggleViewMode = function () {
      ...
      if (state != null) {
        ...
        if (!this.codeViewMode) {
          ...
          Graph.addLightDarkColors(this.textarea, Graph.backupStyleAttribute, this.graph.getAdaptiveColors() == "simple");
          this.codeViewMode = false;
        }
    ...
    mxCellEditor.prototype.getCurrentValue = function (state) {
      if (mxUtils.getValue(state.style, "html", "0") == "0") {
        ...
        if (mxUtils.getValue(state.style, "nl2Br", "1") == "1") {
          ...
          if (result.length > 0 && (result.substring(result.length - 5) == "<br/>" || result.substring(result.length - 4) == "<br>")) {
    ...
    mxCellEditor.prototype.applyValue = function (state, value) {
      ...
      try {
        ...
        if (value == "" && this.graph.isCellDeletable(state.cell) && this.graph.model.getChildCount(state.cell) == 0 && this.graph.isTransparentState(state)) {
    ...
    mxConnectionHandler.prototype.isStartEvent = function (me) {
      return connectionHandlerIsStartEvent.apply(this, arguments) && !mxEvent.isControlDown(me.getEvent()) && !mxEvent.isShiftDown(me.getEvent());
    };
    ...
    mxVertexHandler.prototype.isGhostPreview = function () {
      return (
        vertexHandlerIsGhostPreview.apply(this, arguments) &&
    ...
    mxVertexHandler.prototype.isCustomHandleVisible = function (handle) {
      return (
        handle.tableHandle || (vertexHandlerIsCustomHandleVisible.apply(this, arguments) && (!this.graph.isTable(this.state.cell) || this.graph.isCellSelected(this.state.cell)))
      );
    };
      ...
      if (this.graph.isTable(this.state.cell) && this.graph.isCellMovable(this.state.cell)) {
        ...
        function moveLine(line, dx, dy) {
          ...
          for (var i = 0; i < line.length; i++) {
            var pt = line[i];
            result.push(pt == null ? null : new mxPoint((x0 + pt.x + dx) * s, (y0 + pt.y + dy) * s));
          }
        ...
        if (rows.length > 0) {
          ...
          for (var i = 0; i < rows.length; i++) {
            mxUtils.bind(this, function (index) {
              ...
              if (graph.isCellMovable(rowState.cell)) {
                ...
                var shape = rowLines[index] != null ? new TableLineShape(rowLines[index], mxConstants.NONE, 1) : new mxLine(new mxRectangle(), mxConstants.NONE, 1, false);
                ...
                handle.execute = function (me) {
                  if (dy != 0) {
                    graph.setTableRowHeight(this.state.cell, dy, !shiftPressed);
          ...
          for (var i = 0; i < cols.length; i++) {
            mxUtils.bind(this, function (index) {
              ...
              if (colState == null) {
                colState = new mxCellState(graph.view, cols[index], graph.getCellStyle(cols[index]));
              ...
              var shape = colLines[index] != null ? new TableLineShape(colLines[index], mxConstants.NONE, 1) : new mxLine(new mxRectangle(), mxConstants.NONE, 1, true);
              shape.isDashed = sel.isDashed;
              ...
              handle.setPosition = function (bounds, pt, me) {
                dx = Math.max(Graph.minTableColumnWidth - g.width, pt.x - bounds.x - g.width);
                shiftPressed = mxEvent.isShiftDown(me.getEvent());
    ...
    mxVertexHandler.prototype.isMoveHandlesVisible = function () {
      return this.graph.isTable(this.state.cell) && this.graph.isCellMovable(this.state.cell);
    };
    ...
    mxVertexHandler.prototype.createMoveHandles = function () {
      ...
      for (var i = 0; i < model.getChildCount(this.state.cell); i++) {
        mxUtils.bind(this, function (rowState) {
          if (rowState != null && model.isVertex(rowState.cell) && graph.isCellMovable(rowState.cell)) {
            ...
            mxEvent.addGestureListeners(
              ...
              mxUtils.bind(this, function (evt) {
                ...
                if (!mxEvent.isPopupTrigger(evt)) {
                  this.graph.graphHandler.start(this.state.cell, mxEvent.getClientX(evt), mxEvent.getClientY(evt), this.graph.getSelectionCells());
              ...
              mxUtils.bind(this, function (evt) {
                if (mxEvent.isPopupTrigger(evt)) {
                  this.graph.popupMenuHandler.popup(mxEvent.getClientX(evt), mxEvent.getClientY(evt), rowState.cell, evt);
                  mxEvent.consume(evt);
                }
              }),
            );
      ...
      if (!handlePadding) {
        if (this.customHandles != null) {
          for (var i = 0; i < this.customHandles.length; i++) {
            if (this.customHandles[i] != null && this.customHandles[i].shape != null && this.customHandles[i].shape.bounds != null) {
    ...
    mxEdgeHandler.prototype.mouseUp = function (sender, me) {
      ...
      if (this.linkHint != null && this.linkHint.style.display == "none" && this.graph.getSelectionCount() == 1) {
        this.linkHint.style.display = "";
      }
    };
    ...
    mxEdgeHandler.prototype.updateHint = function (me, point, edge) {
      ...
      if (edge != null) {
        ...
        this.hint.innerHTML += " (" + (unit == mxConstants.POINTS ? Math.round(edge.length / s) : formatHintText(edge.length / s, unit)) + ")";
      }

      if (this.isSource || this.isTarget) {
        if (this.constraintHandler != null && this.constraintHandler.currentConstraint != null && this.constraintHandler.currentFocus != null) {
    ...
    Graph.prototype.expandedImage = Graph.createSvgImage(
      9,
      9,
      '<defs><linearGradient id="grad1" x1="50%" y1="0%" x2="50%" y2="100%">' +
    ...
    HoverIcons.prototype.terminalHandle = Graph.createSvgImage(
      22,
      22,
      '<circle cx="11" cy="11" r="6" stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/><circle cx="11" cy="11" r="3" stroke="#fff" fill="transparent"/>',
    );
    HoverIcons.prototype.endTerminalHandle = Graph.createSvgImage(
      22,
      22,
      '<circle cx="11" cy="11" r="7" stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/><circle cx="11" cy="11" r="3" stroke="#fff" fill="transparent"/>',
    );
    ...
    mxVertexHandler.prototype.rowHandleImage = Graph.createSvgImage(
      14,
      12,
      '<rect x="2" y="2" width="10" height="3" stroke-width="1" stroke="#ffffff" fill="' +
        HoverIcons.prototype.arrowFill +
        '"/>' +
        '<rect x="2" y="7" width="10" height="3" stroke-width="1" stroke="#ffffff" fill="' +
        HoverIcons.prototype.arrowFill +
        '"/>',
    );
    ...
    if (Graph.touchStyle) {
      ...
      mxPanningHandler.prototype.isPanningTrigger = function (me) {
        ...
        return (
          (mxEvent.isLeftMouseButton(evt) && ((this.useLeftButtonForPanning && me.getState() == null) || (mxEvent.isControlDown(evt) && !mxEvent.isShiftDown(evt)))) ||
    ...
    mxEdgeHandler.prototype.createHandleShape = function (index, virtual, target) {
      ...
      var c =
        index != null &&
        this.state.absolutePoints != null &&
        (index == 0 || index >= this.state.absolutePoints.length - 1 || (this.constructor == mxElbowEdgeHandler && index == 2))
    ...
    mxVertexHandler.prototype.createSizerShape = function (bounds, index, fillColor, image) {
      image = index == mxEvent.ROTATION_HANDLE ? HoverIcons.prototype.rotationHandle : index == mxEvent.LABEL_HANDLE ? this.secondaryHandleImage : image;
    ...
    mxVertexHandler.prototype.mouseDown = function (sender, me) {
      ...
      if (handle == mxEvent.ROTATION_HANDLE || !model.isEdge(parent) || geo == null || !geo.relative || this.state == null || this.state.width >= 2 || this.state.height >= 2) {
    ...
    mxVertexHandler.prototype.updateLinkHint = function (link, links) {
      try {
        if (link == null && (links == null || links.length == 0)) {
          ...
          trash.setAttribute("title", mxResources.get("removeIt", [mxResources.get("link")]));
          ...
          if (link != null) {
            ...
            if (this.graph.isEnabled() && typeof this.graph.editLink === "function" && !this.graph.isCellLocked(this.state.cell)) {
          ...
          if (links != null) {
            for (var i = 0; i < links.length; i++) {
              mxUtils.bind(this, function (currentLink, index) {
                ...
                div.appendChild(this.graph.createLinkForHint(currentLink.getAttribute("href"), mxUtils.getTextContent(currentLink), this.state.cell));
                ...
                mxEvent.addListener(
                  ...
                  "click",
                  mxUtils.bind(this, function (evt) {
                    this.graph.showLinkDialog(currentLink.getAttribute("href") || "", mxResources.get("ok"), updateLink);
                    mxEvent.consume(evt);
                  }),
                );
    ...
    mxVertexHandler.prototype.redrawHandles = function () {
      if (this.moveHandles != null) {
        for (var i = 0; i < this.moveHandles.length; i++) {
          if (this.moveHandles[i] != null) {
            this.moveHandles[i].bounds.x = Math.round(this.moveHandles[i].rowState.x + this.moveHandles[i].rowState.width - this.moveHandles[i].bounds.width / 2);
            this.moveHandles[i].bounds.y = Math.round(this.moveHandles[i].rowState.y + (this.moveHandles[i].rowState.height - this.moveHandles[i].bounds.height) / 2);
      ...
      if (this.rotationShape != null && this.rotationShape.node != null) {
        ...
        this.rotationShape.node.style.display =
          this.moveHandles == null && this.graph.getSelectionCount() == 1 && (this.index == null || this.index == mxEvent.ROTATION_HANDLE) ? "" : "none";
      }
