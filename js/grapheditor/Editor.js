 ...
 */
export const Editor = (window.Editor = function (chromeless, themes, model, graph, editable) {
...
Editor.menuImage =
  "data:image/svg+xml;base64,";
Editor.moveImage =
...
Editor.minusImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iNDgiIHdpZHRoPSI0OCI+PHBhdGggZD0iTTEwIDI1LjV2LTNoMjh2M1oiLz48L3N2Zz4=";
Editor.plusImage =
...
Editor.expandMoreImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iMjQiIHdpZHRoPSIyNCI+PHBhdGggZD0ibTEyIDE1LjM3NS02LTYgMS40LTEuNCA0LjYgNC42IDQuNi00LjYgMS40IDEuNFoiLz48L3N2Zz4=";
Editor.expandLessImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iMjQiIHdpZHRoPSIyNCI+PHBhdGggZD0ibTcuNCAxNS4zNzUtMS40LTEuNCA2LTYgNiA2LTEuNCAxLjQtNC42LTQuNloiLz48L3N2Zz4=";
Editor.gearImage =
...
Editor.sendImage =
  "data:image/svg+xml;base64,";
Editor.sparklesImage =
...
Editor.arrowDownImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iMjRweCIgdmlld0JveD0iMCAtOTYwIDk2MCA5NjAiIHdpZHRoPSIyNHB4IiBmaWxsPSIjMDAwMDAwIj48cGF0aCBkPSJNNDgwLTM2MCAyODAtNTYwaDQwMEw0ODAtMzYwWiIvPjwvc3ZnPg==";
Editor.arrowUpImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iMjRweCIgdmlld0JveD0iMCAtOTYwIDk2MCA5NjAiIHdpZHRoPSIyNHB4IiBmaWxsPSIjMDAwMDAwIj48cGF0aCBkPSJtMjgwLTQwMCAyMDAtMjAwIDIwMCAyMDBIMjgwWiIvPjwvc3ZnPg==";
Editor.refreshImage =
...
Editor.checkImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iMjRweCIgdmlld0JveD0iMCAtOTYwIDk2MCA5NjAiIHdpZHRoPSIyNHB4IiBmaWxsPSIjMDAwMDAwIj48cGF0aCBkPSJNMzgyLTI0MCAxNTQtNDY4bDU3LTU3IDE3MSAxNzEgMzY3LTM2NyA1NyA1Ny00MjQgNDI0WiIvPjwvc3ZnPg==";
Editor.dockRightImage =
...
Editor.italicImage =
  "data:image/svg+xml;base64,";
Editor.underlineImage =
...
Editor.alignHorizontalLeftImage =
  "data:image/svg+xml;base64,";
...
Editor.alignHorizontalRightImage =
  "data:image/svg+xml;base64,";
Editor.alignVerticalTopImage =
  "data:image/svg+xml;base64,";
...
Editor.alignVerticalBottomImage =
  "data:image/svg+xml;base64,";
...
Editor.horizontalRuleImage =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIGhlaWdodD0iMjRweCIgdmlld0JveD0iMCAtOTYwIDk2MCA5NjAiIHdpZHRoPSIyNHB4IiBmaWxsPSIjMDAwMDAwIj48cGF0aCBkPSJNMTYwLTQ0MHYtODBoNjQwdjgwSDE2MFoiLz48L3N2Zz4=";
Editor.tableImage =
 ...
 */
Editor.enableNativeClipboard = window == window.top && navigator.clipboard != null && navigator.clipboard.read != null;
...
Editor.isJpgDataUrl = function (url) {
  return url != null && (url.substring(0, 15) == "data:image/jpg;" || url.substring(0, 16) == "data:image/jpeg;");
};
...
Editor.isPngData = function (data) {
  return (
    data.length > 8 &&
    data.charCodeAt(0) == 137 &&
    data.charCodeAt(1) == 80 &&
    data.charCodeAt(2) == 78 &&
    data.charCodeAt(3) == 71 &&
    data.charCodeAt(4) == 13 &&
    data.charCodeAt(5) == 10 &&
    data.charCodeAt(6) == 26 &&
    data.charCodeAt(7) == 10
  );
};
...
Editor.stripImageMetadata = function (dataUri, enabled) {
  if (dataUri != null && enabled && (Editor.isJpgDataUrl(dataUri) || Editor.isPngDataUrl(dataUri))) {
...
Editor.extractGraphModelFromText = function (text) {
  ...
  if (start >= 0 && end > start) {
    return [mxUtils.trim(trimStart(text.substring(0, start))), text.substring(start, end + 15), mxUtils.trim(trimEnd(text.substring(end + 15)))];
  } else {
    return [text, "", ""];
  }
};
...
Editor.prototype.editAsNew = function (xml, title, lightbox, pageId) {
  ...
  if (!navigator.standalone && typeof window.postMessage !== "undefined") {
    var wnd = null;
    ...
    wnd = this.graph.openLink(this.getEditBlankUrl("") + "#P" + encodeURIComponent(JSON.stringify(json)), null, true);
  } else {
 ...
 */
export const OpenFile = (window.OpenFile = function (done) {
  this.producer = null;
  this.consumer = null;
  this.done = done;
  this.args = null;
 ...
 */
export const Dialog = (window.Dialog = function Dialog(editorUi, elt, w, h, modal, closable, onClose, noScroll, transparent, minSize, ignoreBgClick) {
  ...
  if (urlParams["embedInline"] == "1" && !Editor.inlineFullscreen && editorUi.embedViewport != null) {
 ...
 *
 */
export const ErrorDialog = (window.ErrorDialog = function (editorUi, title, message, buttonText, fn, retry, buttonText2, fn2, hide, buttonText3, fn3) {
 ...
 */
export const PrintDialog = (window.PrintDialog = function (editorUi, title, fn, btnTitle) {
 ...
 */
export const PageSetupDialog = (window.PageSetupDialog = function (editorUi) {
  var graph = editorUi.editor.graph;
  var row, td;
  ...
  var changeImage = function (evt) {
    editorUi.showBackgroundImageDialog(
      function (image, failed, color, shadowVisible) {
        if (!failed) {
...
PageSetupDialog.addPageFormatPanel = function (div, namePostfix, pageFormat, pageFormatListener) {
  ...
  var units = [
    { label: mxResources.get("points"), unit: mxConstants.POINTS },
 ...
 */
export const FilenameDialog = (window.FilenameDialog = function (editorUi, filename, buttonText, fn, label, validateFn, content, helpLink, closeOnBtn, cancelFn, hints) {
...
FilenameDialog.createFileTypes = function (editorUi, nameInput, types) {
  ...
  var nameInputChanged = function (evt) {
    ...
    for (var i = 0; i < types.length; i++) {
      ...
      if (name.substring(name.length - ext.length - 1) == "." + ext || (subExt != null && name.substring(name.length - subExt.length - 1) == "." + subExt)) {
        active = i;
        break;
      }
    }
...
(function () {
  ...
  mxGraphView.prototype.validateBackgroundStyles = function (factor, cx, cy) {
    ...
    var color = mxUtils.getLightDarkColor(graph.background == null || graph.background == mxConstants.NONE ? graph.defaultPageBackgroundColor : graph.background).cssText;
    var pageBorder = mxUtils.getLightDarkColor(graph.defaultPageBorderColor).cssText;
    ...
    if (graph.getAdaptiveColors() == "simple" && graph.background != mxConstants.NONE && graph.background != null) {
    ...
    if (graph.view.backgroundPageShape != null) {
      ...
      graph.view.backgroundPageShape.node.style.colorScheme = graph.getAdaptiveColors() == "none" ? "light" : "";
      ...
      } else if (useDiagramBackground && (graph.background == null || graph.background == mxConstants.NONE)) {
  ...
  mxGraphView.prototype.createSvgGrid = function (color, factor) {
    ...
    if (mxClient.IS_SF) {
      scheme = "color-scheme: " + (this.graph.getAdaptiveColors() != "none" && Editor.isDarkMode() ? "dark" : "light");
    }
    ...
    var svg =
      ...
      mxUtils.htmlEntities(cssColor.cssText) +
      ';" stroke="' +
      cssColor.light +
  ...
  mxGraphHandler.prototype.isPropagateSelectionCell = function (cell, immediate, me) {
    ...
    if (immediate) {
      ...
      result =
        !this.graph.model.isEdge(parent) && !this.graph.isSiblingSelected(cell) && ((geo != null && geo.relative) || !this.graph.isContainer(parent) || this.graph.isPart(cell));
    } else {
