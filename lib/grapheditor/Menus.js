...
import {mxConstants, mxEventObject, mxEventSource, mxResources, mxUtils} from "../mxgraph/src/index.js";
...
Menus.prototype.init = function () {
    ...
    this.put('view', new Menu(mxUtils.bind(this, function (menu, parent) {
        this.addMenuItems(menu, ((this.editorUi.format != null) ? ['format'] : []).concat(['outline', 'layers', '-', 'pageView', 'pageScale', '-', 'tooltips',
 ...
 */
export function Menubar(editorUi, container) {
    this.editorUi = editorUi;
 ...
 */
export function Menu(funct, enabled) {
