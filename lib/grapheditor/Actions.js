import {
    ...
    mxConstants,
    mxEventObject,
    mxEventSource, mxRectangle,
    mxResources,
    mxUtils
} from "../mxgraph/src/index.js";
import {EditDiagramDialog, ExportDialog, OpenDialog} from "./Dialogs.js";
...
Actions.prototype.init = function () {
    ...
    this.addAction('saveAs...', function () {
        ui.saveFile(true);
    }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+S');
    ...
    this.addAction('undo', function () {
        ui.undo();
    }, null, '', Editor.ctrlKey + '+Z');
    this.addAction('redo', function () {
        ui.redo();
    }, null, '', (!mxClient.IS_WIN) ? Editor.ctrlKey + '+' + Editor.shiftKey + '+Z' : Editor.ctrlKey + '+Y');
    ...
    }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+I');
    this.addAction('selectEdges', function () {
        graph.selectEdges();
    }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+E');
    ...
    }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+A');
    ...
    this.addAction('exitGroup', function () {
        graph.exitGroup();
    }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+Home');
    this.addAction('enterGroup', function () {
        graph.enterGroup();
    }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+End');
 ...
 */
export function Action(label, funct, enabled, iconCls, shortcut, visible) {
