 ...
 */
export function Dialog(editorUi, elt, w, h, modal, closable, onClose, noScroll, transparent, minSize, ignoreBgClick) {
 ...
 *
 */
export function ErrorDialog(editorUi, title, message, buttonText, fn, retry, buttonText2, fn2, hide, buttonText3, fn3) {
 ...
 */
export function PrintDialog(editorUi, title, fn, btnTitle) {
 ...
 */
export function FilenameDialog(editorUi, filename, buttonText, fn, label,
 ...
 *
 */
export function WrapperWindow(editorUi, title, x, y, w, h, fn, div) {
