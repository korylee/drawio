import {
    ...
    mxClient,
    mxCodec,
    mxCompositeLayout, mxConnectionHandler,
    mxConnector,
    mxConstants, mxConstraintHandler, mxDictionary, mxDragSource,
    mxEdgeHandler,
    mxEvent, mxEventObject,
    mxEventSource,
    mxFastOrganicLayout, mxGeometryChange,
    mxGraph,
    mxGraphHandler,
    mxGraphLayout,
    mxGraphModel,
    ...
    mxImage,
    mxImageShape,
    mxLayoutManager, mxOutline, mxPanningHandler,
    mxPoint,
    mxPopupMenu,
    mxRectangle,
    mxResources, mxRubberband, mxSelectionCellsHandler,
    mxShape,
    mxStackLayout,
    mxStencil,
    mxStencilRegistry,
 ...
 * Defines graph class.
 */
export function Graph(container, model, renderHint, stylesheet, themes, standalone) {
 ...
 */
export function TableLayout(graph) {
 ...
 */
mxUtils.extend(TableLayout, mxStackLayout);
        ...
        Graph.prototype.isValidDropTarget = function (cell, cells, evt) {
            ...
            return !this.isCellLocked(cell) && (this.isTargetShape(cell, cells, evt) ||
                ((mxUtils.getValue(style, 'part', '0') != '1' || this.isContainer(cell)) &&
                    mxUtils.getValue(style, 'dropTarget', '1') != '0' && (mxGraph.prototype.isValidDropTarget.apply(this, arguments) || this.isContainer(cell)) &&
