 ...
 */
import { Action } from "../grapheditor/Actions.js";
import { ChangePageSetup, EditorUi } from "../grapheditor/EditorUi.js";
import {
  mxClient,
  mxConstants,
  mxEvent,
...
import { Menu, Menus } from "../grapheditor/Menus.js";
import { Graph } from "../grapheditor/Graph.js";
import { DrawioFile } from "./DrawioFile.js";
...
(function () {
  ...
  Menus.prototype.init = function () {
    ...
    rulerAction.setEnabled(
      Editor.canvasSupported && document.documentMode != 9,
    );
      ...
      function () {
        if (urlParams["embedInline"] == "1") {
          ...
          var node = mxUtils.isAncestorNode(document.body, editorUi.container)
            ? editorUi.container
            : editorUi.editor.graph.container;
    ...
    if (window.mxFreehand) {
      ...
      freehandAction.setSelectedCallback(function () {
        return (
          editorUi.freehandWindow != null &&
          editorUi.freehandWindow.window.isVisible()
        );
      });
    }
                ...
                var pageRange =
                  ...
                  (args.pagesFrom != currentPage || args.pagesTo != currentPage)
                    ? {
                        ...
                        to: Math.max(
                          0,
                          Math.min(pageCount - 1, args.pagesTo - 1),
                        ),
                      }
                    : null;
    ...
    editorUi.actions.addAction("close", function () {
      ...
      function fn() {
        ...
        editorUi.fileLoaded(
          new LocalFile(editorUi, editorUi.emptyDiagramXml, null, true),
        );
      }
    ...
    action.visible =
      Editor.enableNativeClipboard && editorUi.editor.isExportToCanvas();
    ...
    action = editorUi.actions.addAction(
      ...
      mxUtils.bind(this, function () {
        if (this.tagsWindow == null) {
          ...
          this.tagsWindow.window.setVisible(
            !this.tagsWindow.window.isVisible(),
          );
        }
      }),
      null,
    ...
    if (
      ...
      var generateAction = editorUi.actions.put(
        ...
        new Action("generate", function () {
          if (editorUi.chatWindow != null) {
            editorUi.chatWindow.window.setVisible(
              !editorUi.chatWindow.window.isVisible(),
            );
          } else {
      ...
      generateAction.setSelectedCallback(function () {
        return (
          editorUi.chatWindow != null && editorUi.chatWindow.window.isVisible()
        );
      });
    }
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (
            !mxClient.IS_CHROMEAPP &&
            (editorUi.isOffline() || navigator.standalone)
          ) {
            this.addMenuItems(
              menu,
          ...
          if (editorUi.pages != null) {
            var buttons = [
              [
                "Snapshot",
                function (evt, input) {
                  snapshot = editorUi.getPagesForXml(
        ...
        mxUtils.bind(this, function () {
          ...
          if (file != null && file.isRealtime() && file.shadowPages != null) {
            console.log(
              ...
              file.patch([
                editorUi.diffPages(file.shadowPages, editorUi.pages),
              ]),
            );
    ...
    action.setSelectedCallback(function () {
      return (
        editorUi.sidebar != null && editorUi.sidebar.isEntryVisible("search")
      );
    });
        ...
        mxUtils.bind(this, function (menu, parent) {
            ...
            if (item != null) {
              item.setAttribute(
                ...
                mxResources.get("automatic") +
                  " (" +
                  mxResources.get(Editor.isDarkMode() ? "dark" : "light") +
                  ")",
              );
            }
          }
          ...
          if (
            ...
            editorUi.menus.addLinkToItem(
              item,
              "https://github.com/jgraph/drawio/issues/4296",
            );
          }
        }),
      ),
    ...
    this.put(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          var theme =
            urlParams["sketch"] == "1" ? "sketch" : mxSettings.getUi();
    ...
    if (
      ...
      editorUi.actions.put(
        ...
        new Action("presentationMode" + "...", function () {
          var title =
            editorUi.getCurrentFile() != null
              ? editorUi.getCurrentFile().getTitle()
              : null;
        ...
        new Menu(function (menu, parent) {
          ...
          if (urlParams["confLib"] == "1") {
            ...
            menu.addItem(
              ...
              null,
              function () {
                editorUi.showRemotelyStoredLibrary(
                  mxResources.get("libraries"),
                );
              },
              parent,
            );
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (Editor.currentTheme == "simple") {
            ...
            editorUi.menus.addMenuItems(
              menu,
              ["-", "findReplace", "layers", "tags", "outline", "-"],
              parent,
            );
            ...
            this.addMenuItems(
              menu,
              ["format", "outline", "layers", "tags"].concat(
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (
            ...
            if (
              langMenu != null &&
              (urlParams["embed"] != "1" || urlParams["lang"] == null)
            ) {
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (mxClient.IS_CHROMEAPP || EditorUi.isElectronApp) {
            ...
            editorUi.menus.addMenuItems(
              menu,
              ["-", "synchronize", "properties", "-", "save", "saveAs", "-"],
              parent,
            );
          ...
          if (Editor.currentTheme != "simple" && Editor.currentTheme != "min") {
            ...
            editorUi.menus.addMenuItems(
              menu,
              ["toggleShapes", "format", "layers", "tags", "-"],
              parent,
            );
          ...
          if (
            urlParams["embed"] != "1" &&
            file != null &&
            typeof AtlasFile == "undefined"
          ) // Exclude Atlasian plugin
          {
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (
            ...
            this.addMenuItems(
              menu,
              [editorUi.isOfflineApp() ? "upload" : "makeCopy"],
              parent,
            );
          }
