import {mxEvent, mxEventObject, mxEventSource, mxResources, mxUtils} from "../mxgraph/src/index.js";
 ...
 */
export function DrawioFile(ui, data) {
...
DrawioFile.prototype.synchronizeFile = function (success, error, latestFile) {
    ...
    if (this.savingFile) {
        ...
        var timeoutThread = window.setTimeout(mxUtils.bind(this, function () {
            ...
            if (error != null) {
                error({
                    code: App.ERROR_TIMEOUT, message: mxResources.get('timeout'),
