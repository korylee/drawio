 ...
 */
import { Editor, PrintDialog } from "../grapheditor/Editor.js";
...
import { StyleFormatPanel } from "../grapheditor/Format.js";
...
(function () {
   ...
   * Specifies if XML files should be compressed. Default is true.
   */
  Editor.oneDriveInlinePicker =
    window.urlParams != null && window.urlParams["inlinePicker"] == "0"
      ? false
      : true;
   ...
   */
  Editor.enableAi =
    /test\.draw\.io$/.test(window.location.hostname) ||
   ...
   */
  Editor.gptApiKey =
    urlParams["gpt-api-key"] != null
      ? decodeURIComponent(urlParams["gpt-api-key"])
      : null;
   ...
   */
  Editor.geminiApiKey =
    urlParams["gemini-api-key"] != null
      ? decodeURIComponent(urlParams["gemini-api-key"])
      : null;
   ...
   */
  Editor.claudeApiKey =
    urlParams["claude-api-key"] != null
      ? decodeURIComponent(urlParams["claude-api-key"])
      : null;
  ...
  Editor.commonProperties = [
    ...
    },
    {
      ...
      isVisible: function (state, format) {
        return (
          mxUtils.getValue(state.style, "comic", "0") == "1" ||
          mxUtils.getValue(
            state.style,
            "sketch",
            urlParams["rough"] == "1" ? "1" : "0",
          ) == "1"
        );
      },
    },
    ...
    },
    {
      ...
      isVisible: function (state, format) {
        return (
          mxUtils.getValue(state.style, mxConstants.STYLE_SHADOW, "0") == "1" ||
          mxUtils.getValue(state.style, mxConstants.STYLE_TEXT_SHADOW, "0") ==
            "1"
        );
      },
    },
  ...
  Editor.commonVertexProperties = [
    {
      ...
      isVisible: function (state, format) {
        ...
        return (
          ...
          graph.isTableCell(state.vertices[0])
        );
      },
    },
    {
    ...
    { type: "separator" },
    {
      ...
      getDefaultValue: function (state, format) {
        var cell =
          state.vertices.length == 1 && state.edges.length == 0
            ? state.vertices[0]
            : null;
        var graph = format.editorUi.editor.graph;
    ...
    },
    {
      ...
      getDefaultValue: function (state, format) {
        ...
        return (
          cell != null &&
          (graph.isSwimlane(cell) || graph.model.getChildCount(cell) > 0)
        );
      },
      isVisible: function (state, format) {
    ...
    },
    {
      ...
      getDefaultValue: function (state, format) {
        ...
        return (
          cell != null &&
          ((graph.isContainer(cell) && state.style["collapsible"] != "0") ||
    ...
    { name: "expand", dispName: "Expand", type: "bool", defVal: true },
    {
      ...
      isVisible: function (state, format) {
        ...
        return state.vertices.length > 0
          ? model.isVertex(model.getParent(state.vertices[0]))
          : false;
      },
    },
    { name: "editable", dispName: "Editable", type: "bool", defVal: true },
      ...
      isVisible: function (state, format) {
        var geo =
          state.vertices.length > 0
            ? format.editorUi.editor.graph.getCellGeometry(state.vertices[0])
            : null;
    ...
    { name: "autosize", dispName: "Autosize", type: "bool", defVal: false },
    {
      ...
      isVisible: function (state, format) {
        return (
          state.vertices.length > 0 &&
          format.editorUi.editor.graph.isAutoSizeCell(state.vertices[0])
        );
      },
    },
    {
    ...
    },
    {
      ...
      isVisible: function (state, format) {
        ...
        return (
          ...
          mxUtils.getValue(state.style, mxConstants.STYLE_FILL_OPACITY, 100) ==
            0 ||
    ...
    },
    {
      ...
      isVisible: function (state, format) {
        return (
          state.vertices.length > 0 &&
          format.editorUi.editor.graph.isContainer(state.vertices[0])
        );
      },
    },
    {
  ...
  Editor.loadCompatibleCss = function (cssFile) {
    if (!mxUtils.lightDarkColorSupported) {
      ...
      function replaceLightDarkFunctions(cssString) {
        var compatCss = cssString.replace(
          /light-dark\(\s*(var\([^\)]+\)|[^,]+)\s*,\s*(var\([^\)]+\)|[^)]+)\s*\)/g,
          "$1",
        );
      ...
      mxUtils.get(
        ...
        mxUtils.bind(this, function (req) {
          if (req.getStatus() >= 200 && req.getStatus() <= 299) {
            ...
            style.type = "text/css";
            style.appendChild(
              document.createTextNode(replaceLightDarkFunctions(req.getText())),
            );
  ...
  (function () {
    ...
    function RoughCanvas(canvas, rc, shape) {
      ...
      this.canvas.roundrect = mxUtils.bind(
        this,
        RoughCanvas.prototype.roundrect,
      );
      ...
      this.canvas.fillAndStroke = mxUtils.bind(
        this,
        RoughCanvas.prototype.fillAndStroke,
      );
    ...
    RoughCanvas.prototype.getStyle = function (stroke, fill) {
      ...
      if (stroke) {
        style.stroke =
          this.canvas.state.strokeColor === mxConstants.NONE
            ? "transparent"
            : this.canvas.state.strokeColor;
      } else {
      ...
      if (fill) {
        style.fill =
          this.canvas.state.fillColor === mxConstants.NONE
            ? ""
            : this.canvas.state.fillColor;
        gradient =
          this.canvas.state.gradientColor === mxConstants.NONE
            ? null
            : this.canvas.state.gradientColor;
      } else {
        style.fill = "";
      }
      ...
      if (fillStyle == "auto") {
        ...
        if (this.shape.state != null) {
          bg.push(
            mxUtils.hex2rgb(this.shape.state.view.graph.shapeBackgroundColor),
          );
        }
        ...
        fillStyle =
          style.fill != null &&
          (gradient != null ||
            mxUtils.indexOf(bg, mxUtils.hex2rgb(style.fill)) >= 0)
            ? "solid"
            : defs["fillStyle"];
      }
    ...
    RoughCanvas.prototype.arcTo = function (
      rx,
      ry,
      angle,
      largeArcFlag,
    ...
    RoughCanvas.prototype.rect = function (x, y, w, h) {
      if (this.passThrough) {
        ...
        this.path = [];
        this.nextShape = this.rc.generator.rectangle(
          x,
          y,
          w,
          h,
    ...
    RoughCanvas.prototype.ellipse = function (x, y, w, h) {
      if (this.passThrough) {
        ...
        this.path = [];
        this.nextShape = this.rc.generator.ellipse(
          x + w / 2,
          y + h / 2,
          w,
          h,
    ...
    mxShape.prototype.paint = function (c) {
      ...
      if (
        c.handJiggle != null &&
        c.handJiggle.constructor == RoughCanvas &&
        !this.outline
      ) {
   ...
   */
  Editor.extractGraphModel = function (m, y, F) {
    if (null != m && "undefined" !== typeof pako) {
      var J = m.ownerDocument.getElementsByTagName("div"),
        K = [];
      if (null != J && 0 < J.length)
        for (var N = 0; N < J.length; N++)
          if ("mxgraph" == J[N].getAttribute("class")) {
            K.push(J[N]);
            break;
          }
      0 < K.length &&
        ((J = K[0].getAttribute("data-mxgraph")),
        null != J
          ? ((K = JSON.parse(J)),
            null != K &&
              null != K.xml &&
              ((m = mxUtils.parseXml(K.xml)), (m = m.documentElement)))
          : ((K = K[0].getElementsByTagName("div")),
            0 < K.length &&
              ((J = mxUtils.getTextContent(K[0])),
              (J = Graph.decompress(J, null, F)),
              0 < J.length &&
                ((m = mxUtils.parseXml(J)), (m = m.documentElement)))));
    }
    if (null != m && "svg" == m.nodeName)
      if (
        ((J = m.getAttribute("content")),
        null != J &&
          "<" != J.charAt(0) &&
          "%" != J.charAt(0) &&
          (J = unescape(window.atob ? atob(J) : Base64.decode(cont, J))),
        null != J && "%" == J.charAt(0) && (J = decodeURIComponent(J)),
        null != J && 0 < J.length)
      )
        m = mxUtils.parseXml(J).documentElement;
      else
        throw {
    ...
    null == m ||
      ...
      "diagram" == m.nodeName
        ? (K = m)
        : "mxfile" == m.nodeName &&
          ((J = m.getElementsByTagName("diagram")),
          0 < J.length &&
            (K = J[Math.max(0, Math.min(J.length - 1, urlParams.page || 0))])),
      null != K && (m = Editor.parseDiagramNode(K, F)));
    null == m ||
      "mxGraphModel" == m.nodeName ||
      (y && "mxfile" == m.nodeName) ||
      (m = null);
    return m;
  };
      ...
      if (blockStart > -1) {
        ...
        if (fileInfo.indexOf("application#2Fvnd.jgraph.mxfile") > 0) {
          ...
          return pako.inflateRaw(
            Graph.stringToArrayBuffer(f.substring(streamStart, streamEnd)),
            { to: "string" },
          );
        }
      }
      ...
      while (pos < f.length) {
        ...
        if (b == 10) {
          if (curline == "endobj") {
            ...
            curline.substring(curline.length - 3, curline.length) == "obj" ||
            curline == "xref" ||
            curline == "trailer"
          ) {
            buf = [];
  ...
  Editor.configure = function (config) {
    if (config != null) {
      ...
      Graph.prototype.shapeBackgroundColor =
        "light-dark(#ffffff, var(" +
        Editor.darkColorVar +
        ", " +
        Editor.darkColor +
        "))";
      ...
      if (config.customFonts != null) {
        Menus.prototype.defaultFonts = config.customFonts.concat(
          Menus.prototype.defaultFonts,
        );
      }

      if (config.customPresetColors != null) {
        ColorDialog.prototype.presetColors = config.customPresetColors.concat(
      ...
      if (config.customColorSchemes != null) {
        StyleFormatPanel.prototype.defaultColorSchemes =
          config.customColorSchemes.concat(
            StyleFormatPanel.prototype.defaultColorSchemes,
          );
      }
      ...
      if (config.enabledLibraries != null) {
        if (Array.isArray(config.enabledLibraries)) {
          ...
          EditorUi.debug(
            "Configuration Error: Array expected for enabledLibraries",
          );
        }
      }
      ...
      if (config.zoomFactor != null) {
        ...
        if (!isNaN(val) && val > 1) {
          ...
          EditorUi.debug(
            "Configuration Error: Float > 1 expected for zoomFactor",
          );
        }
      }
      ...
      if (config.defaultGridSize != null) {
        ...
        if (!isNaN(val) && val > 0) {
          ...
          EditorUi.debug(
            "Configuration Error: Int > 0 expected for defaultGridSize",
          );
        }
      }
      ...
      if (config.pageFormat != null) {
        ...
        if (!isNaN(w) && w > 0 && !isNaN(h) && h > 0) {
          ...
          EditorUi.debug(
            "Configuration Error: {width: int, height: int} expected for pageFormat",
          );
        }
      }
      ...
      if (config.sidebarTitleSize != null) {
        ...
        if (!isNaN(val) && val > 0) {
          ...
          EditorUi.debug(
            "Configuration Error: Int > 0 expected for sidebarTitleSize",
          );
        }
      }
      ...
      if (config.autosaveDelay != null) {
        ...
        if (!isNaN(val) && val > 0) {
          ...
          EditorUi.debug(
            "Configuration Error: Int > 0 expected for autosaveDelay",
          );
        }
      }
  ...
  Editor.isSettingsEnabled = function () {
    return (
      typeof window.mxSettings !== "undefined" &&
  ...
  Editor.guid = function (length) {
    ...
    for (var i = 0; i < len; i++) {
      rtn.push(
        Editor.GUID_ALPHABET.charAt(
          Math.floor(Math.random() * Editor.GUID_ALPHABET.length),
        ),
      );
    }
   ...
   */
  Editor.prototype.editButtonLink =
    urlParams["edit"] != null ? decodeURIComponent(urlParams["edit"]) : null;
  ...
  Editor.prototype.setGraphXml = function (node) {
    node =
      node != null && node.nodeName != "mxlibrary"
        ? this.extractGraphModel(node)
        : null;
    ...
    if (node != null) {
      ...
      if (cause) {
        EditorUi.debug(
          "Editor.setGraphXml ParserError",
          [this],
          "node",
          [node],
          "cause",
        ...
        throw new Error(
          mxResources.get("notADiagramFile") + " (" + cause + ")",
        );
        ...
        if (urlParams["embed"] != "1" && (style == null || style == "")) {
          var node2 =
            this.graph.themes != null
              ? this.graph.themes["default-old"]
              : mxUtils
                  .load(STYLE_PATH + "/default-old.xml")
                  .getDocumentElement();
        ...
        this.graph.mathEnabled =
          urlParams["math"] == "1" || node.getAttribute("math") == "1";
        ...
        if (extFonts) {
          ...
          this.graph.extFonts != null &&
          this.graph.extFonts.length > 0
        ) {
          this.graph.extFonts = [];
        }
      }
  ...
  Editor.prototype.getGraphXml = function (ignoreSelection, resolveReferences) {
    ...
    if (
      this.graph.currentStyle != null &&
      this.graph.currentStyle != "default-style2"
    ) {
            ...
            e.retry
              .then(function () {
                MathJax.typesetPromise([container])
                  ...
                  ["catch"](function (e) {
                    console.log(
                      "Error in MathJax.typesetPromise: " + e.toString(),
                    );
                    mathJaxDone();
                  });
              })
  ...
  Editor.prototype.createImageUrlConverter = function () {
    ...
    converter.convert = function (src) {
      if (src != null && navigator.onLine) {
        var remote =
          src.substring(0, 7) == "http://" || src.substring(0, 8) == "https://";
   ...
   *
   */
  Editor.prototype.convertImageToDataUri = function (
    url,
    callback,
    error,
    convertScale,
      ...
      if (/(\.svg)$/i.test(url) && !forceConvert) {
        ...
        img.onload = function () {
          ...
          if (acceptResponse) {
            try {
              convertScale =
                convertScale != null && forceConvert ? convertScale : 1;
   ...
   */
  Editor.prototype.loadUrl = function (
    url,
    success,
    error,
    forceBinary,
  ...
  Editor.prototype.embedCssFonts = function (fontCss, then) {
    ...
    var finish = mxUtils.bind(this, function () {
      if (waiting == 0) {
        ...
        for (var j = 1; j < parts.length; j++) {
          ...
          result.push('url("');
          result.push(
            this.cachedFonts[Editor.trimCssUrl(parts[j].substring(0, idx))],
          );
    ...
    if (parts.length > 0) {
      for (var i = 1; i < parts.length; i++) {
        ...
        if (fmtIdx > 0) {
          format = Editor.trimCssUrl(
            parts[i].substring(fmtIdx + 7, parts[i].indexOf(")", fmtIdx)),
          );
        }
  ...
  Editor.prototype.addMathCss = function (svgRoot) {
    ...
    if (defs != null && defs.length > 0) {
      ...
      for (var i = 0; i < styles.length; i++) {
        ...
        if (
          content.indexOf("mxPageSelector") < 0 &&
            ...
            img.onload = mxUtils.bind(this, function () {
              try {
                ...
                if (bg != null) {
                  ...
                  ctx.rect(0, 0, w, h);
                  ctx.fillStyle =
                    theme == "dark" && graph.getAdaptiveColors() != "none"
                      ? cssBg.dark
                      : cssBg.light;
                  ctx.fill();
                }
  ...
  Editor.writeGraphModelToPng = function (data, type, key, value, error) {
    ...
    do {
      ...
      if (chunk == "IDAT") {
        ...
        if (type == "pHYs" && key == "dpi") {
          ...
          var chunkData =
            writeInt(dpm) + writeInt(dpm) + String.fromCharCode(1);
        } else {
          var chunkData =
            key +
    ...
    return (
      "data:image/png;base64," +
      (window.btoa ? btoa(result) : Base64.encode(result, true))
    );
  };
  ...
  var AddCustomPropertyDialog = function (editorUi, callback) {
    ...
    mxUtils.write(
      td,
      mxResources.get("enumList", null, "Enum List") + " (csv):",
    );
  ...
  if (window.StyleFormatPanel != null) {
    ...
    Format.prototype.refresh = function () {
      if (
        this.editorUi.getCurrentFile() != null ||
        urlParams["embed"] == "1" ||
    ...
    mxCellRenderer.defaultShapes["table"].prototype.customProperties = [
      ...
      .concat(
        mxCellRenderer.defaultShapes["partialRectangle"].prototype
          .customProperties,
      );
    ...
    mxCellRenderer.defaultShapes["tableRow"].prototype.customProperties =
      mxCellRenderer.defaultShapes[
        "swimlane"
      ].prototype.customProperties.concat(
        mxCellRenderer.defaultShapes["partialRectangle"].prototype
          .customProperties,
      );
    ...
    StyleFormatPanel.prototype.init = function () {
      ...
      if (
        this.defaultColorSchemes != null &&
        this.defaultColorSchemes.length > 0 &&
        sstate.style.shape != "image" &&
        !sstate.containsLabel &&
     ...
     */
    BaseFormatPanel.prototype.addProperties = function (
      div,
      properties,
      state,
      hideId,
        ...
        if (prop.valueChanged != null) {
          ...
          try {
            ...
            if (prop.index != null) {
              ...
              if (
                prop.size != null &&
                allVals.length > prop.size
              ) //trim the array to the specifies size
              {
          ...
          if (color == null || color == mxConstants.NONE) {
            ...
            if (
              ...
              clrDiv.style.background =
                ...
                cssColor.cssText +
                " 50%, " +
                mxUtils.invertLightDarkColor(cssColor).cssText +
                " 50.3%)";
            } else {
      ...
      function createStaticArrList(
        ...
        if (size > 0) {
          ...
          for (var i = 0; i < size; i++) {
            vals[i] =
              curVals[i] != null ? curVals[i] : defVal != null ? defVal : "";
          }
      ...
      function createPropertyRow(pName, pValue, prop, isOdd, flipBkg) {
        ...
        if (prop.index != null) {
          ...
          pDiplayName =
            (pDiplayName != null ? pDiplayName : "") + "[" + prop.index + "]";
          rightAlig = true;
        }
        ...
        td.setAttribute(
          "title",
          pValue != null ? decodeURIComponent(pValue) : mxResources.get("none"),
        );
        ...
        if (pType == "color") {
          ...
          for (var i = 0; i < pEnumList.length; i++) {
            ...
            if (op.val == pValue) {
              mxUtils.write(
                valueDiv,
                mxResources.get(op.dispName, null, op.dispName),
              );
              break;
            }
          }
          ...
          mxEvent.addListener(
            ...
            mxUtils.bind(that, function (e) {
              ...
              select.value =
                pValue == null && nullOption != null ? nullValue : pValue;
              ...
              mxEvent.addListener(select, "change", function () {
                ...
                if (
                  select[select.selectedIndex] == nullOption ||
            ...
            mxUtils.bind(that, function (e) {
              ...
              function setInputVal() {
                ...
                if (prop.allowAuto) {
                  if (
                    inputVal.trim != null &&
                    inputVal.trim().toLowerCase() == "auto"
                  ) {
                    inputVal = "auto";
                    pType = "string";
                  } else {
                ...
                try {
                  newVal =
                    pType == "numbers"
                      ? inputVal.match(/\d+/g).map(Number).join(" ")
                      : encodeURIComponent(
                          (pType == "int" ? parseInt(inputVal) : inputVal) + "",
                        );
                } catch (e) {
      ...
      if (cellId != null && !hideId) {
        grid.appendChild(
          createPropertyRow(
            "id",
            mxUtils.htmlEntities(cellId),
            { dispName: "id", type: "readOnly" },
            true,
            false,
          ),
        );
        ...
        if (state.style != null && state.style.shape != null) {
          grid.appendChild(
            createPropertyRow(
              "shape",
              mxUtils.htmlEntities(state.style.shape),
              { dispName: "shape", type: "readOnly" },
              true,
              false,
            ),
          );
      ...
      for (var key in properties) {
        ...
        if (!prop.primary) {
          ...
          if (prop.type == "separator") {
            ...
            prop.type == "staticArr"
          ) //if dynamic values are needed, a more elegant technique is needed to replace such values
          {
            prop.size =
              parseInt(
                state.style[prop.sizeProperty] ||
                  properties[prop.sizeProperty].defVal,
              ) || 0;
            ...
            for (var i = 0; i < dependentProps.length; i++) {
              if (properties[dependentProps[i]] != null) {
                ...
                dependentPropsDefVal.push(
                  properties[dependentProps[i]].subDefVal,
                );
                dependentPropsVals.push(
                  propVal != null ? propVal.split(",") : [],
                );
              }
            }
          ...
          grid.appendChild(
            createPropertyRow(key, pValue, prop, isOdd, flipBkg),
          );
    ...
    StyleFormatPanel.prototype.addStyles = function (div) {
      if (this.defaultColorSchemes != null) {
        ...
        var setScheme = mxUtils.bind(this, function (index) {
          if (dots[index] != null) {
            if (
              this.format.currentScheme != null &&
              dots[this.format.currentScheme] != null
            ) {
        ...
        var updateScheme = mxUtils.bind(this, function (colorsets) {
          ...
          defaults[mxConstants.STYLE_STROKECOLOR] =
            defaults[mxConstants.STYLE_STROKECOLOR] != null
              ? defaults[mxConstants.STYLE_STROKECOLOR]
              : "default";
          defaults[mxConstants.STYLE_FILLCOLOR] =
            defaults[mxConstants.STYLE_FILLCOLOR] != null
              ? defaults[mxConstants.STYLE_FILLCOLOR]
              : "default";
          defaults[mxConstants.STYLE_FONTCOLOR] =
            defaults[mxConstants.STYLE_FONTCOLOR] != null
              ? defaults[mxConstants.STYLE_FONTCOLOR]
              : "default";
          ...
          var addButton = mxUtils.bind(this, function (colorset) {
            ...
            btn.style.height =
              this.defaultColorSchemes.length <= maxEntries ? "24px" : "30px";
            ...
            if (colorset != null) {
              ...
              if (colorset["gradient"] != null) {
                btn.style.backgroundImage =
                  "linear-gradient(" +
                  mxUtils.getLightDarkColor(colorset["fill"]).cssText +
                  " 0px," +
                  mxUtils.getLightDarkColor(colorset["gradient"]).cssText +
                  " 100%)";
              ...
              if (
                colorset["stroke"] == null ||
                colorset["stroke"] == mxConstants.NONE
              ) {
                btn.style.border = b + " transparent";
              } else if (colorset["stroke"] == "") {
                btn.style.border =
                  "1px solid " +
                  mxUtils.getLightDarkColor(
                    mxUtils.getValue(
                      defaults,
                      mxConstants.STYLE_STROKECOLOR,
                      "#000000",
        ...
        if (this.format.currentScheme == null) {
          setScheme(
            Math.min(
              dots.length - 1,
              Editor.isDarkMode() ? 1 : urlParams["sketch"] == "1" ? 5 : 0,
            ),
          );
        } else {
        ...
        mxEvent.addListener(
          ...
          mxUtils.bind(this, function () {
            setScheme(
              mxUtils.mod(
                this.format.currentScheme - 1,
                this.defaultColorSchemes.length,
              ),
            );
          }),
        );
        ...
        right.style.cssText =
          "position:absolute;left:186px;bottom:" +
          bottom +
          "px;width:20px;" +
          "background-image:url(" +
          Editor.chevronRightImage +
  ...
  Graph.fontMapping = {
    "https://fonts.googleapis.com/css?family=Architects+Daughter":
      ...
      "src: url(" +
      STYLE_PATH +
      '/fonts/ArchitectsDaughter-Regular.ttf) format("truetype"); }',
  };
  ...
  Graph.isGoogleFontUrl = function (url) {
    return (
      url.substring(0, Editor.GOOGLE_FONTS.length) == Editor.GOOGLE_FONTS ||
      url.substring(0, Editor.GOOGLE_FONTS_CSS2.length) ==
  ...
  Graph.rewriteGoogleFontUrl = function (url) {
    if (
      ...
      url =
        Editor.GOOGLE_FONTS_CSS2 +
        url.substring(Editor.GOOGLE_FONTS.length) +
        ":wght@400;500";
    }
  ...
  Graph.addFont = function (name, url, callback, elementLookup) {
    if (name != null && name.length > 0 && url != null && url.length > 0) {
      elementLookup =
        elementLookup != null ? elementLookup : Graph.customFontElements;
      ...
      if (style != null) {
        if (style["childLayout"] == "rack") {
          ...
          if (style["rackUnitSize"] != null) {
            ...
            rackLayout.gridSize =
              typeof mxRackContainer !== "undefined"
                ? mxRackContainer.unitSize
                : unitSize;
          }
          ...
          rackLayout.horizontal =
            mxUtils.getValue(style, "horizontalRack", "0") == "1";
  ...
  Graph.prototype.postProcessCellStyle = function (cell, style) {
    return Graph.processFontStyle(
      graphPostProcessCellStyle.apply(this, arguments),
    );
  };
   ...
   */
  Graph.prototype.createTagsDialog = function (
    isEnabled,
    invert,
    addFn,
    helpButton,
        ...
        if (tags != null && tags.length > 0) {
          for (var i = 0; i < tags.length; i++) {
            (function (tag) {
              ...
              img.setAttribute(
                "title",
                mxResources.get(visible ? "hideIt" : "show", [tag]),
              );
              ...
              if (graph.isEnabled()) {
                ...
                if (selected == null) {
                  ...
                  cb2.defaultChecked =
                    selected != null && mxUtils.indexOf(selected, tag) >= 0;
                  cb2.checked = cb2.defaultChecked;
                  cb2.style.background = "transparent";
                  cb2.setAttribute(
                    "title",
                    mxResources.get(cb2.defaultChecked ? "removeIt" : "add", [
                      tag,
                    ]),
                  );
                  ...
                  mxEvent.addListener(cb2, "change", function (evt) {
                    if (cb2.checked) {
                      ...
                      graph.removeTagsForCells(graph.getSelectionCells(), [
                        tag,
                      ]);
                    }
    ...
    var refreshUi = mxUtils.bind(this, function (sender, evt) {
      if (isEnabled()) {
        ...
        if (graph.isSelectionEmpty()) {
          ...
          refreshTags(
            allTags,
            graph.getCommonTagsForCells(graph.getSelectionCells()),
          );
        }
      }
    });
  ...
  Graph.prototype.isFastZoomEnabled = function () {
    return (
      graphIsFastZoomEnabled.apply(this, arguments) &&
      (!this.shadowVisible || !mxClient.IS_SF)
    );
  };
  ...
  Graph.prototype.updateGlobalUrlVariables = function () {
    ...
    if (urlParams["vars"] != null) {
      try {
        this.globalVars =
          this.globalVars != null ? mxUtils.clone(this.globalVars) : {};
  ...
  Graph.prototype.getSvg = function (
    ...
    if (theme != null) {
      ...
      var theme =
        theme == "auto" || this.getAdaptiveColors() == "none"
    ...
    if (incExtFonts && extFonts.length > 0) {
      ...
      var style =
        svgDoc.createElementNS != null
          ? svgDoc.createElementNS(mxConstants.NS_SVG, "style")
          : svgDoc.createElement("style");
      svgDoc.setAttributeNS != null
        ? style.setAttributeNS("type", "text/css")
        : style.setAttribute("type", "text/css");
      ...
      for (var i = 0; i < extFonts.length; i++) {
        ...
        if (Graph.isCssFontUrl(fontUrl)) {
          prefix +=
            "@import url(" + Graph.rewriteGoogleFontUrl(fontUrl) + ");\n";
        } else {
          postfix +=
            "@font-face {\n" +
            'font-family: "' +
   ...
   */
  var graphViewResetValidationState =
  ...
  mxGraphView.prototype.createEnumerationValue = function (state) {
    var value = decodeURIComponent(
      mxUtils.getValue(state.style, "enumerateValue", ""),
    );
    ...
    return (
      '<div style="padding:2px;border:1px solid gray;background:yellow;border-radius:2px;">' +
      ...
      var executeNextAction = mxUtils.bind(this, function () {
        if (index < actions.length) {
          ...
          if (action.wait != null && !stop) {
            ...
            waitCounter++;
            this.pendingWaitThread = window.setTimeout(
          ...
          if (action.fadeOut != null) {
            ...
            Graph.fadeNodes(
              ...
              0,
              waitAndExecute,
              stop ? 0 : action.fadeOut.delay,
            );
          }

          if (action.wipeIn != null) {
            animations = animations.concat(
              this.createWipeAnimations(
                this.getCellsForAction(action.wipeIn, true),
                true,
              ),
            );
          }
          ...
          if (action.wipeOut != null) {
            animations = animations.concat(
              this.createWipeAnimations(
                this.getCellsForAction(action.wipeOut, true),
                false,
              ),
            );
          }
          ...
          if (action.toggleStyle != null && action.toggleStyle.key != null) {
            ...
            this.toggleCellStyles(
              ...
              action.toggleStyle.defaultValue != null
                ? action.toggleStyle.defaultValue
                : "0",
          ...
          if (action.tags != null) {
            ...
            if (action.tags.visible != null) {
              ...
              for (var i = 0; i < all.length; i++) {
                if (
                  mxUtils.indexOf(action.tags.visible, all[i]) < 0 &&
   ...
   * given tags in their tags property.
   */
  Graph.prototype.getCellsForTags = function (
    tagList,
    cells,
    includeLayers,
    checkVisible,
    ...
    if (tagList != null) {
      cells =
        cells != null ? cells : this.model.getDescendants(this.model.getRoot());
      ...
      for (var i = 0; i < cells.length; i++) {
        if (
          (includeLayers &&
            this.model.getParent(cells[i]) == this.model.root) ||
  ...
  Graph.prototype.getAllTags = function () {
    return this.getTagsForCells(
      this.model.getDescendants(this.model.getRoot()),
    );
  };
   ...
   * Highlights the given cell.
   */
  Graph.prototype.highlightCell = function (
    cell,
    color,
    duration,
    opacity,
    ...
    if (state != null) {
      ...
      var sw = Math.max(
        strokeWidth + 1,
        mxUtils.getValue(state.style, mxConstants.STYLE_STROKEWIDTH, 1) +
          strokeWidth,
      );
      ...
      if (group != null) {
        ...
        if (!isNaN(parseInt(svgRoot.getAttribute("width"))) && extend) {
          svgRoot.setAttribute(
            "width",
            parseInt(svgRoot.getAttribute("width")) + size,
          );
          svgRoot.setAttribute(
            "height",
            parseInt(svgRoot.getAttribute("height")) + size,
          );
  ...
  Graph.prototype.selectUnlockedLayer = function () {
    if (this.defaultParent == null) {
      ...
      do {
        ...
        index++ < childCount &&
        mxUtils.getValue(this.getCellStyle(cell), "locked", "0") == "1"
      );
  ...
  mxStencilRegistry.libraries["mockup"] = [
    SHAPES_PATH + "/mockup/mxMockupButtons.js",
  ];
  ...
  mxStencilRegistry.libraries["infographic"] = [
    SHAPES_PATH + "/mxInfographic.js",
  ];
  mxStencilRegistry.libraries["mockup/buttons"] = [
    SHAPES_PATH + "/mockup/mxMockupButtons.js",
  ];
  mxStencilRegistry.libraries["mockup/containers"] = [
    SHAPES_PATH + "/mockup/mxMockupContainers.js",
  ];
  ...
  mxStencilRegistry.libraries["mockup/markup"] = [
    SHAPES_PATH + "/mockup/mxMockupMarkup.js",
  ];
  ...
  mxStencilRegistry.libraries["mockup/text"] = [
    SHAPES_PATH + "/mockup/mxMockupText.js",
  ];
  ...
  mxStencilRegistry.libraries["archimate3"] = [
    SHAPES_PATH + "/mxArchiMate3.js",
  ];
  ...
  mxStencilRegistry.libraries["networks2"] = [
    SHAPES_PATH + "/mxNetworks2.js",
    STENCIL_PATH + "/networks2.xml",
  ];
  ...
  mxStencilRegistry.libraries["pid2inst"] = [
    SHAPES_PATH + "/pid2/mxPidInstruments.js",
  ];
  mxStencilRegistry.libraries["pid2misc"] = [
    SHAPES_PATH + "/pid2/mxPidMisc.js",
    STENCIL_PATH + "/pid/misc.xml",
  ];
  mxStencilRegistry.libraries["pid2valves"] = [
    SHAPES_PATH + "/pid2/mxPidValves.js",
  ];
  mxStencilRegistry.libraries["pidFlowSensors"] = [
    STENCIL_PATH + "/pid/flow_sensors.xml",
  ];
  mxStencilRegistry.libraries["salesforce"] = [
    STENCIL_PATH + "/salesforce.xml",
  ];
  mxStencilRegistry.libraries["sap"] = [
    SHAPES_PATH + "/mxSAP.js",
    STENCIL_PATH + "/sap.xml",
  ];
  ...
  mxMarker.createMarker = function (
    canvas,
    shape,
    type,
    pe,
  ...
  PrintDialog.prototype.create = function (editorUi, titleText, fn, btnTitle) {
    ...
    function validatePageRange() {
      pagesToInput.value = Math.max(
        1,
        Math.min(
          pageCount,
          Math.max(
            parseInt(pagesToInput.value),
            parseInt(pagesFromInput.value),
          ),
        ),
      );
      pagesFromInput.value = Math.max(
        1,
        Math.min(
          pageCount,
          Math.min(
    ...
    if (
      ...
      pagesFromInput.value = Math.min(
        pageCount,
        Math.max(1, editorUi.lastPrintPagesFromInput),
      );
      pagesToInput.value = Math.min(
        pageCount,
    ...
    var currPage = mxUtils.button(
      mxResources.get("currentPage"),
      function (evt) {
        pagesFromInput.value = currentPage;
        pagesToInput.value = currentPage;
        pagesRadio.checked = true;
    ...
    selectionOnlyRadio.setAttribute(
      "type",
      pageCount == 1 ? "checkbox" : "radio",
    );
    ...
    if (!editorUi.isPagesEnabled() || editorUi.lastPrintPagesRadioChecked) {
      ...
      editorUi.lastPrintSelectionOnlyChecked
    ) {
    ...
    sheetsAcrossInput.setAttribute(
      "value",
      editorUi.lastPrintSheetsAcross || "1",
    );
    ...
    borderInput.value =
      editorUi.lastPrintBorder != null
        ? editorUi.lastPrintBorder
        : mxPrintPreview.prototype.pageMargin;
    ...
    zoomInput.value =
      editorUi.lastPrintZoom != null ? editorUi.lastPrintZoom : "100%";
    ...
    gridInput.checked =
      editorUi.lastPrintGrid != null ? editorUi.lastPrintGrid : false;
    ...
    shadowsInput.checked =
      editorUi.lastPrintShadow != null ? editorUi.lastPrintShadow : false;
    ...
    transparentInput.checked =
      editorUi.lastPrintTransparent != null
        ? editorUi.lastPrintTransparent
        : false;
    ...
    includeInput.checked =
      editorUi.lastPrintInclude != null
        ? editorUi.lastPrintInclude
    ...
    function preview(print) {
      ...
      zoomInput.value =
        Math.max(1, Math.min(1600, parseInt(zoomInput.value))) + "%";
    ...
    if ((!editorUi.isOffline() || mxClient.IS_CHROMEAPP) && fn == null) {
      buttons.appendChild(
        editorUi.createHelpIcon("https://www.drawio.com/doc/faq/print-diagram"),
      );
    }
  ...
  ChangePageSetup.prototype.execute = function () {
    ...
    if (this.page != this.ui.currentPage) {
      ...
      if (
        this.mathEnabled != null &&
        this.mathEnabled != this.ui.isMathEnabled()
      ) {
      ...
      if (
        ...
        this.adaptiveColors != this.ui.editor.graph.adaptiveColors
      ) {
      ...
      if (
        this.shadowVisible != null &&
        this.shadowVisible != this.ui.editor.graph.shadowVisible
      ) {
