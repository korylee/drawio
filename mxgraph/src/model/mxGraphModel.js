 ...
 */
export const mxGraphModel = (window.mxGraphModel = function mxGraphModel(root) {
...
mxGraphModel.prototype.cloneCellImpl = function (cell, mapping, includeChildren, identical) {
  ...
  if (clone == null) {
    ...
    if (includeChildren) {
      ...
      for (var i = 0; i < childCount; i++) {
        var cloneChild = this.cloneCellImpl(this.getChildAt(cell, i), mapping, true, identical);
 ...
 * specified model.
 */
export const mxRootChange = (window.mxRootChange = function mxRootChange(model, root) {
  this.model = model;
  this.root = root;
  this.previous = root;
});
 ...
 * specified model.
 */
export const mxChildChange = (window.mxChildChange = function mxChildChange(model, parent, child, index) {
  this.model = model;
  this.parent = parent;
 ...
 * specified model.
 */
export const mxTerminalChange = (window.mxTerminalChange = function mxTerminalChange(model, cell, terminal, source) {
  this.model = model;
  this.cell = cell;
 ...
 * specified model.
 */
export const mxValueChange = window.mxValueChange = function mxValueChange(model, cell, value) {
  this.model = model;
  this.cell = cell;
  this.value = value;
  this.previous = value;
 ...
 * specified model.
 */
export const mxStyleChange = window.mxStyleChange = function mxStyleChange(model, cell, style) {
  this.model = model;
  this.cell = cell;
  this.style = style;
  this.previous = style;
 ...
 * specified model.
 */
export const mxGeometryChange = (window.mxGeometryChange = function mxGeometryChange(model, cell, geometry) {
  this.model = model;
  this.cell = cell;
 ...
 * specified model.
 */
export const mxCollapseChange = (window.mxCollapseChange = function mxCollapseChange(model, cell, collapsed) {
  this.model = model;
  this.cell = cell;
 ...
 * specified model.
 */
export const mxVisibleChange = (window.mxVisibleChange = function mxVisibleChange(model, cell, visible) {
  this.model = model;
  this.cell = cell;
 ...
 */
export const mxCellAttributeChange = (window.mxCellAttributeChange = function mxCellAttributeChange(cell, attribute, value) {
  this.cell = cell;
