 ...
 */
export const mxOutline = (window.mxOutline = function mxOutline(source, container) {
  this.source = source;
...
mxOutline.prototype.updateSvg = function () {
  ...
  var color = mxUtils.getLightDarkColor(
    this.source.background == null || this.source.background == mxConstants.NONE ? this.source.defaultPageBackgroundColor : this.source.background,
  ).cssText;
