 ...
 */
export const mxTooltipHandler = window.mxTooltipHandler = function mxTooltipHandler(graph, delay) {
  if (graph != null) {
    this.graph = graph;
...
mxTooltipHandler.prototype.mouseMove = function (sender, me) {
  if (me.getX() != this.lastX || me.getY() != this.lastY) {
    ...
    if (
      this.isHideOnHover() ||
      state != this.state ||
      (me.getSource() != this.node && (!this.stateSource || (state != null && this.stateSource == (me.isSource(state.shape) || !me.isSource(state.text)))))
    ) {
      this.hideTooltip();
    }
  }
