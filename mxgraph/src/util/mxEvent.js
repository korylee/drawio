...
var mxEvent = {
  ...
  isTouchEvent: function (evt) {
    return evt.pointerType != null ? evt.pointerType == "touch" || evt.pointerType === evt.MSPOINTER_TYPE_TOUCH : evt.type != null && evt.type.indexOf("touch") == 0;
  },
  ...
  isPenEvent: function (evt) {
    return evt.pointerType != null ? evt.pointerType == "pen" || evt.pointerType === evt.MSPOINTER_TYPE_PEN : evt.type != null && evt.type.indexOf("pen") == 0;
  },
  ...
  isMouseEvent: function (evt) {
    ...
    if (!mxClient.IS_ANDROID && mxClient.IS_LINUX && mxClient.IS_GC) {
      ...
      return evt.pointerType != null ? evt.pointerType == "mouse" || evt.pointerType === evt.MSPOINTER_TYPE_MOUSE : evt.type != null && evt.type.indexOf("mouse") == 0;
    }
  },
